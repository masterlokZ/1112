package com.greensock.plugins
{
   ...
   public class RoundPropsPlugin extends TweenPlugin
   {
      ...
      protected function _initAllProps() : void
      {
         ...
         var _loc5_:Array = _tween.vars.roundProps;
         var _loc1_:int = int(_loc5_.length);
         while(--_loc1_ > -1)
         {
            ...
            while(_loc4_)
            {
               if(_loc4_.name == _loc3_)
               {
                  ...
                  {
                     add(_loc4_.target,_loc3_,_loc4_.start,_loc4_.change);
                     _removePropTween(_loc4_);
                     _tween.propTweenLookup[_loc3_] = _tween.propTweenLookup.roundProps;
                  }
               }
