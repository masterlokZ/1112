package com.taomee.seer2.app.dialog
{
   ...
   public class NpcDialog extends Sprite
   {
      ...
      public static function showDialogsByText(param1:String, param2:Function, param3:Function = null) : void
      {
         ...
         QueueLoader.load(URLUtil.getRes(url),"text",function(param1:ContentInfo):void
         {
            ...
            NpcDialog.showDialogs(dialogs,fun,fun1);
         });
      }
      ...
      {
         return param1.replace("$nick$",ActorManager.actorInfo.nick);
      }
      ...
      private function createBtnState(param1:String, param2:uint) : Sprite
      {
         ...
         _loc3_.htmlText = replacePlayerName(param1);
      ...
      private function addFunctionUnit(param1:String, param2:String, param3:String, param4:Function) : void
      {
         ...
         {
            _loc6_ = FunctionalityUnitFactory.createUnit(param1,param2,param3);
            if(_loc6_ is CustomUnit)
            {
               (_loc6_ as CustomUnit).customHandler = param4;
            }
            this._functionUnitSp.addChild(_loc6_);
            this._functionUnitSp.getChildAt(0).y = 30;
            _loc5_ = 1;
            while(_loc5_ < this._functionUnitSp.numChildren)
            {
               this._functionUnitSp.getChildAt(_loc5_).x = 150 * (int(_loc5_ % 2));
               this._functionUnitSp.getChildAt(_loc5_).y = 30 + 30 * (int(_loc5_ / 2));
               _loc5_++;
            }
         }
      }
      ...
      private function layIcons() : void
      {
         if(this)
         {
            this.x = 118 - (1200 - LayerManager.stage.stageWidth) + 59 * (LayerManager.stage.stageWidth / 1200);
      ...
      private function tweenDialog() : void
      {
         ...
         var _loc3_:int = MathUtil.randomRegion(1,4);
         if(_loc3_ == 1)
         {
            this.x = -this.width;
            this.alpha = 0.3;
      ...
      private function updateContent() : void
      {
         ...
         var _loc1_:* = replacePlayerName(String(this._nodeArr[this._nodeIndex][1]));
      ...
      public function checkFaces(param1:TextField) : void
      {
         ...
         while(_loc13_ < _loc3_.length)
         {
            if(_loc4_[_loc13_] != null)
            {
               ...
               _loc11_.x = _loc4_[_loc13_].x + 355;
               _loc11_.y = _loc4_[_loc13_].y + 444;
      ...
      private function showLabelBtn() : void
      {
         ...
         var _loc2_:int = int(this._closeArr.length);
         var _loc1_:int = 0;
         while(_loc1_ < _loc2_)
         {
            _loc4_ = String(this._closeArr[_loc1_]);
      ...
      {
         this.hideInstance();
         var _loc2_:int = int(this._labelBtnVec.indexOf(param1.currentTarget as SimpleButton));
