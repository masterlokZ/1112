package com.taomee.seer2.app.starMagic
{
   ...
   public class StarMagicManager
   {
      ...
      public static var bagStarInfo:Vector.<StarInfo>;
      
      public static var depotStarInfo:Vector.<StarInfo>;
      
      public static var temporaryStarInfo:Vector.<StarInfo>;
      
      public static var curPet:Vector.<StarInfo>;
      ...
      private static function initialize() : void
      {
         ...
         if(!bagStarInfo)
         {
            bagStarInfo = new Vector.<StarInfo>();
         }
         if(!depotStarInfo)
         {
            depotStarInfo = new Vector.<StarInfo>();
         }
         if(!temporaryStarInfo)
         {
            temporaryStarInfo = new Vector.<StarInfo>();
         }
         if(!curPet)
         {
            curPet = new Vector.<StarInfo>();
         }
      }
      ...
      {
         var _loc5_:Object;
         _obj = _loc5_ = _buyWaitList.shift();
      ...
      {
         var _loc6_:Object;
         _obj = _loc6_ = _buyWaitList.shift();
      ...
      private static function onLevelUpStar(param1:MessageEvent) : void
      {
         ...
         {
            _loc4_ = 0;
            while(_loc4_ < bagStarInfo.length)
            {
               if(_loc2_.starInfo[_loc3_].id == bagStarInfo[_loc3_].id)
               {
                  bagStarInfo[_loc4_] = _loc2_.starInfo[_loc3_];
                  break;
               }
               _loc4_++;
            }
            _loc4_ = 0;
            while(_loc4_ < depotStarInfo.length)
            {
               if(_loc2_.starInfo[_loc3_].id == depotStarInfo[_loc4_].id)
               {
                  depotStarInfo[_loc4_] = _loc2_.starInfo[_loc3_];
                  break;
               }
               _loc4_++;
            }
      ...
      public static function movePetStar(param1:int, param2:int, param3:StarInfo, param4:Function, param5:Function = null, param6:int = 0, param7:int = 0, param8:int = 0) : void
      {
         var _loc9_:LittleEndianByteArray = null;
         _successCallBack = param4;
         _sellerrorCallBack = param5;
         _loc9_ = new LittleEndianByteArray();
         _loc9_.writeUnsignedInt(param1);
      ...
      public static function moveStar(param1:int, param2:int, param3:StarInfo, param4:Function, param5:Function = null, param6:int = 0, param7:int = 0) : void
      {
         var _loc9_:LittleEndianByteArray = null;
         _successCallBack = param4;
         _sellerrorCallBack = param5;
         ...
         while(_loc8_ < param2)
         {
            ...
            _loc9_.writeUnsignedInt(param3.level_cof);
            _loc9_.writeUnsignedInt(param3.pos);
            _loc9_.writeUnsignedInt(param3.petCatchTime);
            _loc9_.writeUnsignedInt(param3.sell_exp);
            _loc9_.writeUnsignedInt(param3.type);
            _loc9_.writeUnsignedInt(param3.buffSwf);
            _loc9_.writeUnsignedInt(param7);
      ...
      {
         var _loc4_:Object;
         _obj = _loc4_ = _buyWaitList.shift();
      ...
      public static function clearTempStar(param1:StarInfo) : void
      {
         var _loc2_:int = 0;
         if(temporaryStarInfo)
         {
      ...
      public static function addTempStar(param1:StarInfo) : void
      {
         if(temporaryStarInfo)
         {
      ...
      public static function resetTempStar(param1:Vector.<StarInfo>) : void
      {
         var _loc2_:int = 0;
      ...
      public static function clearBagStar(param1:StarInfo) : void
      {
         var _loc2_:int = 0;
         if(bagStarInfo)
         {
      ...
      public static function addBagStar(param1:StarInfo) : void
      {
         if(bagStarInfo)
         {
      ...
      public static function resetBagStar(param1:Vector.<StarInfo>) : void
      {
         var _loc2_:int = 0;
         while(_loc2_ < param1.length)
         {
      ...
      public static function clearDepotStar(param1:StarInfo) : void
      {
         var _loc2_:int = 0;
         if(depotStarInfo)
         {
      ...
      public static function addDepotStar(param1:StarInfo) : void
      {
         if(depotStarInfo)
         {
      ...
      public static function addCurPetStar(param1:StarInfo) : void
      {
         if(curPet)
         {
            curPet.push(param1);
      ...
      public static function resetCurPetStar(param1:Vector.<StarInfo>) : void
      {
         var _loc2_:int = 0;
         while(_loc2_ < param1.length)
         {
      ...
      public static function resetDepotStar(param1:Vector.<StarInfo>) : void
      {
         var _loc2_:int = 0;
         while(_loc2_ < param1.length)
         {
