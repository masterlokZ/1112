   ...
   public class MiniGameManager
   {
      ...
      public static function getGameStatus(param1:Function = null) : void
      {
         ...
         if(_gameStatusVec == null)
         {
            ...
            ServerBufferManager.getServerBuffer(3,onGetStatus);
            return;
         }
      ...
      private static function updataStatusToServer() : void
      {
         ...
         {
            ServerBufferManager.updateServerBuffer(3,_position,_value);
      ...
      private static function updataGamePlayed() : void
      {
         var _loc1_:* = 0;
         var _loc2_:int = 0;
         while(_loc2_ < _gamePlayedVec.length)
         {
            if(_gamePlayedVec[_loc2_] == _gameId)
            {
               if(_loc2_ == 0)
               {
                  return;
               ...
               while(_loc1_ > 0)
               {
                  _gamePlayedVec[_loc1_] = _gamePlayedVec[_loc1_ - 1];
                  _loc1_--;
               }
      ...
      private static function updataPlayedToServer() : void
      {
         ...
         var _loc2_:Vector.<ServerBufferData> = new Vector.<ServerBufferData>();
         var _loc1_:int = 0;
         while(_loc1_ < GAME_PLAYED)
         {
            _loc3_ = new ServerBufferData(_loc1_,_gamePlayedVec[_loc1_]);
            _loc2_.push(_loc3_);
            _loc1_++;
         }
         ServerBufferManager.updateServerBufferGroup(4,_loc2_);
      }
      ...
      public static function getGamePlayed(param1:Function = null) : void
      {
         ...
         if(_gamePlayedVec == null)
         {
            ...
            ServerBufferManager.getServerBuffer(4,onGetPlayed);
            return;
         }
