package com.taomee.seer2.app.utils
{
   ...
   public class PetUtil
   {
      ...
      public static function getMinStatusPet(param1:uint) : PetDefinition
      {
         ...
         var _loc6_:Array = PetConfig.petDefinitionMap.getValues();
         var _loc5_:uint = _loc6_.length;
         var _loc3_:uint = 0;
         while(_loc3_ < _loc5_)
         {
            _loc2_ = PetDefinition(_loc6_[_loc3_]);
            if(_loc2_.bunchId == param1)
            {
               if(_loc4_ == null)
               {
                  _loc4_ = _loc2_;
               }
               else if(_loc2_.resId < _loc4_.resId)
               {
                  _loc4_ = _loc2_;
               }
            }
      ...
      public static function getMaxPetSkillList(param1:PetInfo) : Array
      {
         ...
         var _loc2_:PetDefinition = null;
         var _loc9_:Array = PetConfig.petDefinitionMap.getValues();
         var _loc8_:uint = _loc9_.length;
         var _loc4_:Array = [];
         var _loc3_:uint = param1.bunchId;
         var _loc6_:uint = 0;
         while(_loc6_ < _loc8_)
         {
            _loc2_ = PetDefinition(_loc9_[_loc6_]);
            if(_loc2_.bunchId == _loc3_)
            {
               _loc4_.push(_loc2_.resId);
            }
            _loc6_++;
         }
         _loc4_.sort();
         if(_loc4_.length == 4)
         {
            ...
            if(_loc5_[0] == param1.resourceId || _loc5_[1] == param1.resourceId)
            {
               return _loc5_;
            }
            return null;
         }
         if(_loc4_.length <= 3 && _loc4_.length >= 1)
         {
            _loc5_ = [_loc4_[0]];
            if(_loc5_[0] == param1.resourceId)
            {
               return _loc5_;
            }
            return null;
      ...
      public static function isPetInBag(param1:uint) : Boolean
      {
         ...
         {
            if(_loc2_[_loc4_].resourceId == param1)
            {
               _loc3_ = true;
               break;
            }
      ...
      public static function isPetHaveSkill(param1:uint, param2:uint) : Boolean
      {
         ...
         var _loc3_:SkillInfo = new SkillInfo(param2);
         _loc5_ = 0;
         while(_loc5_ < _loc6_.length)
         {
            if(_loc6_[_loc5_].resourceId == param1 && (_loc6_[_loc5_].skillInfo.hasSkillInfo(_loc3_) || _loc6_[_loc5_].skillInfo.hasCandidateSkillInfo(_loc3_)))
            {
               _loc4_ = true;
               break;
            }
      ...
      public static function putinAndGetoutOfStorage(param1:PetInfo, param2:Function = null) : void
      {
         ...
         {
            var putinStorageSuccess:Function;
            return putinStorageSuccess = function(param1:MessageEvent):void
            {
               ...
               Connection.addCommandListener(CommandSet.PET_SET_STORAGE_STATUS_1020,(function():*
               {
                  var takeOutOfStorageSuccess:Function;
                  return takeOutOfStorageSuccess = function(param1:MessageEvent):void
                  {
      ...
      public static function get maxBagPetStarLevel() : int
      {
         ...
         while(_loc4_ < _loc2_.length)
         {
            ...
            if(_loc3_.getPetDefinition().starLevel > _loc1_)
            {
               _loc1_ = int(_loc3_.getPetDefinition().starLevel);
            }
            _loc4_++;
         }
         return _loc1_;
      ...
      public static function putPetTobag(param1:PetInfo) : void
      {
         ...
         if(_loc2_ == 0)
         {
            for each(_loc3_ in PetInfoManager.getAllBagPetStorageInfo())
            {
