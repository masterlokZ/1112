package com.taomee.seer2.app.utils
{
   ...
   public class MovieClipUtil
   {
      ...
      public static function getChildList(param1:MovieClip, param2:*, param3:Array, param4:Function) : void
      {
         ...
         mc.addEventListener("frameConstructed",function(param1:Event):void
         {
            ...
            if(frame is int)
            {
               _loc6_ = frame == mc.currentFrame;
            }
            else if(frame is String)
            {
               _loc6_ = frame == mc.currentLabel;
            }
            if(_loc6_)
            {
               mc.removeEventListener("frameConstructed",arguments.callee);
               _loc5_ = new Vector.<DisplayObject>();
               _loc4_ = 0;
               while(_loc4_ < childArr.length)
               {
                  if(childArr[_loc4_] is int)
                  {
                     _loc5_.push(mc.getChildAt(int(childArr[_loc4_])));
                  }
                  else if(childArr[_loc4_] is String)
                  {
                     _loc5_.push(mc.getChildByName(String(childArr[_loc4_])));
                  }
                  _loc4_++;
               }
               callBack(_loc5_);
      ...
      public static function getChild(param1:MovieClip, param2:*, param3:*, param4:Function) : void
      {
         ...
         mc.addEventListener("frameConstructed",function(param1:Event):void
         {
            ...
            if(frame is int)
            {
               _loc3_ = frame == mc.currentFrame;
            }
            else if(frame is String)
            {
               _loc3_ = frame == mc.currentLabel;
            }
            if(_loc3_)
            {
               mc.removeEventListener("frameConstructed",arguments.callee);
               if(child is int)
               {
                  callBack(mc.getChildAt(child));
               }
               else if(child is String)
               {
                  callBack(mc.getChildByName(child));
               }
            }
         });
         mc.gotoAndStop(frame);
      ...
      public static function playMc(param1:MovieClip, param2:*, param3:*, param4:Function = null, param5:Boolean = false) : void
      {
         ...
         mc.addEventListener("enterFrame",function(param1:Event):void
         {
            ...
            {
               _loc3_ = endFrame == mc.currentLabel;
            }
            if(_loc3_)
            {
               mc.removeEventListener("enterFrame",arguments.callee);
      ...
      public static function playFullScreen(param1:String, param2:Function = null, param3:Boolean = true, param4:Boolean = false, param5:uint = 1, param6:Boolean = true) : void
      {
         ...
         getSwfContent(url,function(param1:MovieClip):void
         {
            ...
            _fullScreenMc.addEventListener("enterFrame",onFullScreenEnter);
         },"加载全屏动画...");
      }
      ...
      private static function clearFullScreen() : void
      {
         ...
         {
            _fullScreenMc.stop();
            _fullScreenMc.removeEventListener("enterFrame",onFullScreenEnter);
         }
      ...
      private static function addFullScreenSkipBtn() : void
      {
         if(_fullScreenSkipBtn == null)
         {
            ...
            _fullScreenSkipBtn.addEventListener("click",onFullScreenSkillBtnClick);
         }
      ...
      public static function playNpcTalk(param1:String, param2:Function) : void
      {
         ...
         QueueLoader.load(param1,"swf",onNpcTalkLoadComplete);
      }
      ...
      private static function playNpcTalkContent(param1:*, param2:Function) : void
      {
         ...
         MovieClipUtil.getChild(_npcTalkAnimation,frame,0,function(param1:DisplayObject):void
         {
            ...
            _npcTalkContent.addEventListener("enterFrame",onNpcTalkEnterFrame);
         });
      }
      ...
      private static function onNpcTalkShowBtn(param1:Event) : void
      {
         ...
         _npcTalkBtn.addEventListener("click",onNpcTalkBtnClick);
      }
      ...
      public static function getFrameMc(param1:MovieClip, param2:Object, param3:String = "", param4:Function = null) : void
      {
         ...
         {
            parentMC.addEventListener("enterFrame",function():void
            {
               if(name == "")
               {
                  child = parentMC.getChildAt(0) as MovieClip;
               ...
               if(child)
               {
                  parentMC.removeEventListener("enterFrame",arguments.callee);
                  if(func != null)
                  {
                     func(child);
                  }
      ...
      private static function onNpcTalkBtnClick(param1:MouseEvent) : void
      {
         ...
         _npcTalkBtn.removeEventListener("enterFrame",onNpcTalkBtnClick);
      }
      ...
      private static function onNpcTalkEnterFrame(param1:Event) : void
      {
         if(_npcTalkContent.currentFrame == _npcTalkContent.totalFrames)
         {
            ...
            _npcTalkContent.removeEventListener("enterFrame",onNpcTalkEnterFrame);
      ...
      private static function playNpcTalk1() : void
      {
         ...
         MovieClipUtil.playMc(_talkContent,startFrame,endFrame,function():void
         {
            ...
            else
            {
               ...
               _talkContent.addEventListener("click",onTalkBtnClick);
               if(_hasClickArea)
               {
                  DisplayObjectUtil.enableButtonMode(_clickArea);
                  _clickArea.addEventListener("click",onTalkBtnClick);
               }
      ...
      private static function onTalkBtnClick(param1:MouseEvent) : void
      {
         if(_hasClickArea)
         {
            ...
            _clickArea.removeEventListener("click",onTalkBtnClick);
         }
         _talkBtn.removeEventListener("click",onTalkBtnClick);
         DisplayObjectUtil.removeFromParent(_talkBtn);
         _talkContent.buttonMode = false;
         _talkContent.removeEventListener("click",onTalkBtnClick);
         ++_talkIndex;
         playNpcTalk1();
      }
      ...
      {
         var _loc2_:int = _talkIndex + 1;
         var _loc1_:int = 0;
         while(_loc1_ < _talkArr.length)
         {
            if(_talkArr[_loc1_][0] > _loc2_)
            {
               break;
            }
            _loc1_++;
         }
         return NPC_TALK_BTN_ARR[_talkArr[_loc1_ - 1][1]];
      }
      ...
      public static function playHahaTalk(param1:String, param2:int, param3:Array, param4:Function = null) : void
      {
         ...
         _hahaBtn.x = 871;
         _hahaBtn.y = 533;
         QueueLoader.load(param1,"swf",onLoadHaha);
      }
      ...
      private static function playHahaContent() : void
      {
         ...
         {
            _hahaBtn.addEventListener("click",onHahBtnClick);
      ...
      private static function onHahBtnClick(param1:MouseEvent) : void
      {
         ...
         _hahaBtn.removeEventListener("click",onHahBtnClick);
      ...
      public static function playEndAndRemove(param1:MovieClip, param2:Object = 1) : void
      {
         ...
         mc.addEventListener("enterFrame",(function():*
         {
            ...
            return onEnter = function(param1:Event):void
            {
               var _loc3_:MovieClip = param1.currentTarget as MovieClip;
               if(_loc3_.currentFrame == _loc3_.totalFrames)
               {
                  _loc3_.removeEventListener("enterFrame",arguments.callee);
      ...
      private static function selectNpcEvent() : void
      {
         ...
         for each(_loc1_ in _allSelectList)
         {
            _loc1_.addEventListener("click",onSelectTalkClick);
         }
         _clearBtn.addEventListener("click",onClear);
      }
      ...
      private static function onSelectTalkClick(param1:MouseEvent) : void
      {
         ...
         var index:int = int(_selectList.indexOf(event.currentTarget as SimpleButton));
         if(index + 1 == _currBaseInfo.yesIndex)
         {
            if(_selectTalkIndex + 2 >= _selectTalkInfo.list.length)
            {
               ...
               {
                  btn.removeEventListener("click",onSelectTalkClick);
               }
               _clearBtn.removeEventListener("click",onClear);
      ...
      public static function playClickMc(param1:MovieClip, param2:int, param3:int, param4:Function = null, param5:Boolean = false) : void
      {
         ...
         mc.addEventListener("click",function(param1:MouseEvent):void
         {
         ...
         mc.addEventListener("enterFrame",function(param1:Event):void
         {
            ...
            {
               mc.removeEventListener("enterFrame",arguments.callee);
               mc.removeEventListener("click",arguments.callee);
               mc.gotoAndStop(endFrame);
               if(focusLayer)
               {
                  LayerManager.resetOperation();
      ...
      public static function playCartoon(param1:String, param2:uint, param3:Function = null) : void
      {
         ...
         getSwfContent(url,function(param1:MovieClip):void
         {
            ...
            LayerManager.stage.addEventListener("click",clickCartoon);
            playNextCartoon();
         },"加载对话资源...");
      }
      ...
      private static function playNextCartoon() : void
      {
         ...
         {
            cartoonMc.stop();
            LayerManager.stage.removeEventListener("click",clickCartoon);
...
class MovieClipUtilLoader
{
   ...
   public function MovieClipUtilLoader(param1:String, param2:Function, param3:String)
   {
      ...
      UILoader.load(this._url,"swf",this.onSwfLoadComplete,this.onError,param3);
   }
