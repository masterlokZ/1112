   ...
   public class ActsHelperUtil
   {
      ...
      public static function bubbleSort(param1:Array) : Array
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            while(_loc3_ > _loc5_)
            {
               if(_loc4_[_loc3_] < _loc4_[_loc3_ - 1])
               {
                  _loc2_ = Number(_loc4_[_loc3_]);
                  _loc4_[_loc3_] = _loc4_[_loc3_ - 1];
      ...
      public static function buyHandle(param1:uint, param2:MovieClip, param3:Boolean = false, param4:Boolean = false, param5:Function = null) : void
      {
         ...
         ModuleManager.addEventListener("BuyPropPanel","dispose",(function():*
         {
            var onBuyPanelHide:Function;
            return onBuyPanelHide = function(param1:ModuleEvent):void
            {
               ModuleManager.removeEventListener("BuyPropPanel","dispose",onBuyPanelHide);
      ...
      public static function addDesktopUrl(param1:String, param2:String, param3:Function = null, param4:Function = null, param5:String = "http://img1.v.tmcdn.net/img/h000/h66/img20140418102521c26260.png") : void
      {
         ...
         try
         {
            ...
            _loc7_ = "[InternetShortcut]\n";
            _loc7_ = _loc7_ + ("URL=" + param2 + "\n");
            _loc7_ = _loc7_ + "Modified=70BF4B88E372CC0124\n";
            _loc7_ = _loc7_ + ("IconFile=" + param5 + "\n");
            _loc7_ = _loc7_ + "IconIndex=1\n";
            if(param3 != null)
            {
               _loc6_.addEventListener("complete",param3);
            }
            if(param4 != null)
            {
               _loc6_.addEventListener("ioError",param4);
            }
