package com.taomee.seer2.app.pet
{
   ...
   public class PetPowerUpdate
   {
      ...
      {
         allPowerCount();
         EventManager.addEventListener("PetReCount",onPetReCount);
         EventManager.addEventListener("PetUpdate",onPetUpdate);
      }
      ...
      private static function onPetUpdate(param1:Event) : void
      {
         ...
         if(curAllPower > _allPower)
         {
            ...
            TweenNano.to(tipSp,0.5,{
               ...
               {
                  Tick.instance.addRender((function():*
                  {
                     var onTipShow:Function;
                     return onTipShow = function(param1:int):void
                     {
                        var val:int = param1;
      ...
      public static function allPowerCount() : void
      {
         ...
         {
            _allPower += PetInfoManager.getPowerByPetInfo(_loc1_);
         }
      }
   }
}
