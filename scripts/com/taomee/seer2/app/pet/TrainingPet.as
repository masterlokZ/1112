package com.taomee.seer2.app.pet
{
   ...
   public class TrainingPet extends PathMobile implements IBubbleHost
   {
      ...
      private function initEventListener() : void
      {
         ...
         addEventListener("click",this.onPetClick);
      }
      ...
      public function showBubble() : void
      {
         ...
         if(this._sloganVec)
         {
            ...
            this._bubble.addEventListener("close",this.onBubbleDisappear);
      ...
      {
         this._maxIdelInterval = (250 >> 1) + (250 >> 1) * Math.random();
         this._idelInterval = 0;
      }
      ...
      private function actorMoveClose() : void
      {
         ...
         else
         {
            ...
            _loc1_.addEventListener("finished",this.onActorReached);
