   ...
   public class PetInfoManager
   {
      ...
      private static function initPetHandle(param1:IDataInput) : void
      {
         ...
         while(_loc2_ < _loc5_)
         {
            ...
            _loc3_ = getPetInfoFromMap(_loc4_);
            PetInfo.readBaseSimpleInfo2(param1,_loc3_);
            _loc3_.flag = param1.readUnsignedInt();
            _loc3_.isInitialPet = true;
            addPetInfo(_loc3_);
            _loc2_++;
         }
         testPetBag();
      ...
      private static function testPetBag() : void
      {
         ...
         {
            if(_loc1_.isInBag && !_loc1_.isInStorageBag && _loc1_.isSetBirth == false && _loc1_.isBirthIng == false)
            {
            }
         }
      }
      ...
      public static function addPetInfo1(param1:PetInfo) : void
      {
         ...
         dispatchEvent("petStorageAdd",param1);
      }
      ...
      public static function removePetInfoFromBagById(param1:uint) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            dispatchEvent("petRemove",_loc2_);
         }
      }
      ...
      public static function removePetInfoFromBagStorageById(param1:uint) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            dispatchEvent("petStorageRemove",_loc2_);
         }
      }
      ...
      public static function getTotalBagPetInfo() : Vector.<PetInfo>
      {
         ...
         {
            if(_loc5_.isInBag && !_loc5_.isInStorageBag && _loc5_.isSetBirth == false && _loc5_.isBirthIng == false)
            {
               _loc3_.push(_loc5_);
            }
         }
         ...
         {
            if(_loc1_.isInStorageBag && _loc1_.isSetBirth == false && _loc1_.isBirthIng == false)
            {
               _loc3_.push(_loc1_);
            }
         }
      ...
      public static function getAllBagPetStorageInfo() : Vector.<PetInfo>
      {
         var _loc3_:PetInfo = null;
         var _loc2_:Vector.<PetInfo> = new Vector.<PetInfo>();
         var _loc1_:Array = _petStorageInfoMap.getValues();
         for each(_loc3_ in _loc1_)
         {
      ...
      public static function getRidingPetInfo() : PetInfo
      {
         ...
         {
            if(_loc2_[_loc1_].isPetRiding == true)
            {
      ...
      public static function setSubPetInfo(param1:uint) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            dispatchEvent("petChangeSub",_loc3_);
         }
      }
      ...
      public static function setFirst(param1:uint) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            dispatchEvent("petChangeStart",_loc3_);
         }
      }
      ...
      public static function updateStarPetInfo(param1:int, param2:Vector.<StarInfo>) : void
      {
         ...
         var _loc4_:Array = null;
         var _loc3_:PetInfo = null;
         var _loc6_:Array = _petInfoMap.getValues();
         for each(_loc5_ in _loc6_)
         {
            if(_loc5_.catchTime == param1)
            {
               if(param2.length > 0)
               {
                  _loc5_.petFightStarInfo.clear();
                  _loc5_.petFightStarInfo.addAll(param2);
               }
               else
               {
                  _loc5_.petFightStarInfo.clear();
      ...
      public static function getStoragePetInfos(param1:Function, param2:Boolean) : void
      {
         ...
         onGetStorageList = function(param1:MessageEvent):void
         {
            ...
            while(_loc5_ < _loc6_)
            {
               _loc3_ = uint(_loc4_.readUnsignedInt());
               _loc2_ = getPetInfoFromMap(_loc3_);
               PetInfo.readBaseSimpleInfo2(_loc4_,_loc2_);
               _loc2_.treasureTime = _loc4_.readUnsignedInt();
               _loc2_.evolveLevel = _loc4_.readUnsignedInt();
               _loc2_.isInBag = false;
               _loc2_.isInStorageBag = false;
               _loc2_.isInFreeStorage = false;
               _loc2_.isTraining = false;
               _petInfoMap.add(_loc2_.catchTime,_loc2_);
               _loc5_++;
            }
            if(count1016 == 0)
            {
      ...
      public static function getInitialPetInfo() : PetInfo
      {
         ...
         var _loc1_:int = 0;
         var _loc3_:int = 0;
         var _loc4_:Vector.<PetInfo> = getInitialPetInfoVec();
         if(_loc4_.length == 0)
         {
            _loc2_ = null;
         }
         ...
         {
            _loc1_ = int(_loc4_[0].catchTime);
            _loc3_ = 1;
            while(_loc3_ < _loc4_.length)
            {
               if(_loc1_ > _loc4_[_loc3_].catchTime)
               {
                  _loc1_ = int(_loc4_[_loc3_].catchTime);
               }
               _loc3_++;
            }
            _loc2_ = _petInfoMap.getValue(_loc1_);
         }
         return _loc2_;
      }
      ...
      public static function requestAddToBagFromStorage(param1:uint, param2:int) : void
      {
         ...
         checkIsBeFull();
         dispatchEvent("serverGetPet",null,param2);
         if(isBagFull() == true || param2 == 301 || param2 == 302 || param2 == 303)
         {
            _loc3_ = PetConfig.getPetDefinition(param2).name;
         ...
         _loc4_.writeByte(1);
         Connection.send(CommandSet.PET_SET_STORAGE_STATUS_1020,_loc4_);
      ...
      private static function onGetPetHaveInfo(param1:MessageEvent) : void
      {
         ...
         _loc3_.push(_loc5_.readUnsignedInt());
         var _loc4_:int = int(_loc5_.readUnsignedInt());
         var _loc2_:int = 0;
         while(_loc2_ < _loc4_)
         {
            _loc3_.push(_loc5_.readUnsignedInt());
      ...
      {
         var _loc10_:PetDefinition = null;
         var _loc12_:int = 0;
         var _loc14_:int = 0;
         var _loc7_:int = 1;
         var _loc9_:int = param1.emblemId == 0 ? 0 : 200;
         var _loc8_:int = 0;
         if(param1.decorationId != 0)
         {
            _loc14_ = (param1.decorationId - 1) % 5 + 1;
            _loc8_ = int([120,140,160,180,200][_loc14_ - 1]);
         }
         var _loc4_:int = 0;
         var _loc3_:Array = [[30,40,50,60,70,80],[60,80,100,120,140,160],[120,160,200,240,280,320],[240,320,400,480,560,640]];
         var _loc6_:Array = param1.petFightStarInfo.type;
         var _loc5_:Array = param1.petFightStarInfo.level;
         var _loc2_:int = 0;
         while(_loc2_ < _loc6_.length)
         {
            _loc4_ += int(_loc3_[_loc6_[_loc2_] - 1][_loc5_[_loc2_] - 1]);
            _loc2_++;
         }
         var _loc13_:Number = createCurPropVal(param1.getPetDefinition().maxHp + (int(PetEvolveConfig.getStarInfo(param1.evolveLevel) != null ? PetEvolveConfig.getStarInfo(param1.evolveLevel).Hp : 0)),param1.learningInfo.pointHp,5,param1) * 17 + createCurPropVal(param1.getPetDefinition().atk + (int(PetEvolveConfig.getStarInfo(param1.evolveLevel) != null ? PetEvolveConfig.getStarInfo(param1.evolveLevel).Atk : 0)),param1.learningInfo.pointAtk,0,param1) * 16 + createCurPropVal(param1.getPetDefinition().specialAtk + (int(PetEvolveConfig.getStarInfo(param1.evolveLevel) != null ? PetEvolveConfig.getStarInfo(param1.evolveLevel).SpAtk : 0)),param1.learningInfo.pointSpecialAtk,2,param1) * 16 + createCurPropVal(param1.getPetDefinition().defence + (int(PetEvolveConfig.getStarInfo(param1.evolveLevel) != null ? PetEvolveConfig.getStarInfo(param1.evolveLevel).Def : 0)),param1.learningInfo.pointDefence,1,param1) * 14 + createCurPropVal(param1.getPetDefinition().specialDefence + (int(PetEvolveConfig.getStarInfo(param1
         .evolveLevel) != null ? PetEvolveConfig.getStarInfo(param1.evolveLevel).SpDef : 0)),param1.learningInfo.pointSpecialDefence,3,param1) * 14 + createCurPropVal(param1.getPetDefinition().speed + (int(PetEvolveConfig.getStarInfo(param1.evolveLevel) != null ? PetEvolveConfig.getStarInfo(param1.evolveLevel).Spd : 0)),param1.learningInfo.pointSpeed,4,param1) * 30;
         _loc10_ = PetUtil.getMaxStatusPet(param1.bunchId);
         var _loc11_:int = _loc10_.atk + _loc10_.specialAtk + _loc10_.defence + _loc10_.specialDefence + _loc10_.speed + _loc10_.maxHp - 650;
         return int(_loc13_ * _loc11_ / 130 * _loc7_ + _loc9_ + _loc8_ + _loc4_ + 0.5);
      }
      ...
      public static function getAllPetBagPower() : int
      {
         ...
         {
            _loc2_ += getPowerByPetInfo(_loc1_);
         }
         return _loc2_;
      }
      ...
      private static function createCurPropVal(param1:int, param2:int, param3:int, param4:PetInfo) : Number
      {
         ...
         var _loc5_:Vector.<int> = Vector.<int>([param4.potentialAtk,param4.potentialDef,param4.potentialSpAtk,param4.potentialSpDef,param4.potentialSpeed,param4.potentialHp]);
         if(param3 != 5)
         {
            _loc6_ = ((param1 * 2 + _loc5_[param3]) * (param4.level / 100) + param4.level + 10 + param2 / 4) * param4.characterArr[param3];
         }
         else
         {
            _loc6_ = (param1 * 2 + _loc5_[param3]) * (param4.level / 100) + param4.level + 10 + param2 / 4;
         }
         return _loc6_;
      }
