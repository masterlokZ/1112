package com.taomee.seer2.app.pet.data
{
   ...
   public class PetInfo
   {
      ...
      public var itemList:Vector.<PetItemInfo> = Vector.<PetItemInfo>([]);
      ...
      {
         var _loc4_:uint = 0;
         var _loc6_:Vector.<SkillInfo> = new Vector.<SkillInfo>();
         var _loc5_:int = int(param2.readUnsignedInt());
         ...
         while(_loc3_ < _loc5_)
         {
            ...
            _loc6_.push(new SkillInfo(_loc4_));
            if(param1.resourceId == 703)
            {
            }
            _loc3_++;
         }
         param1.skillInfo.skillInfoVec = _loc6_;
      }
      ...
      public static function readStarInfo(param1:PetInfo, param2:IDataInput) : void
      {
         ...
         var _loc6_:uint = uint(param2.readUnsignedInt());
         var _loc3_:int = 0;
         while(_loc3_ < _loc6_)
         {
            _loc5_ = uint(param2.readUnsignedInt());
            _loc4_ = uint(param2.readUnsignedInt());
            param1._petFightStarInfo.add(_loc4_,_loc5_);
            _loc3_++;
         }
      }
      ...
      public static function readCandidateSkillInfo(param1:PetInfo, param2:IDataInput) : void
      {
         ...
         param1.skillInfo.candidateSkillInfoVec = _loc6_;
      }
      ...
      public static function readGainedSkillInfo(param1:PetInfo, param2:IDataInput) : void
      {
         ...
         var _loc7_:Vector.<SkillInfo> = new Vector.<SkillInfo>();
         var _loc6_:uint = uint(param2.readUnsignedInt());
         var _loc4_:int = 0;
         while(_loc4_ < _loc6_)
         {
            _loc3_ = uint(param2.readUnsignedInt());
            _loc5_ = new SkillInfo(_loc3_);
            _loc7_.push(_loc5_);
            _loc4_++;
         }
         param1.skillInfo.gainedSkillInfoVec = _loc7_;
      }
      ...
      private function updateFlag() : void
      {
         ...
         this._flag = _loc1_;
         PetInfoManager.dispatchEvent("petFlagChange",this);
      }
      ...
      public function set flag(param1:int) : void
      {
         ...
         this._isTraining = (param1 & 0x10) == 16;
         this._isAggraisal = (param1 & 0x20) == 32;
         this._isDevilTraining = (param1 & 0x40) == 64;
         this._isSubFighter = (param1 & 0x80) == 128;
         this._isSetBirth = (param1 & 0x0100) == 256;
         this._isBirthIng = (param1 & 0x0400) == 1024;
         this._isTwoPet = (param1 & 0x0800) == 2048;
         this.isPetRiding = (param1 & 0x2000) == 8192;
