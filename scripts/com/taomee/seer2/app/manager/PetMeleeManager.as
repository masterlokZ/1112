   ...
   public class PetMeleeManager
   {
      ...
      public static function startPetMeleeFight(param1:PVPInfo = null) : void
      {
         ...
         PVPManager.requestPVP(_pvpInfo,function():void
         {
            ...
            _loc2_.writeUnsignedInt(204);
            _loc2_.writeUnsignedInt(_pvpInfo.petList.length);
            var _loc1_:int = 0;
            while(_loc1_ < _pvpInfo.petList.length)
            {
               _loc2_.writeUnsignedInt(_pvpInfo.petList[_loc1_]);
               _loc1_++;
            }
            Connection.addCommandListener(CommandSet.CLI_FIGHT_MON_SELECT_MON_1251,on1251);
            Connection.send(CommandSet.CLI_FIGHT_MON_SELECT_MON_1251,_loc2_);
         });
      }
      ...
      public static function startPvPFight(param1:PVPInfo) : void
      {
         ...
         {
            var _loc2_:LittleEndianByteArray = new LittleEndianByteArray();
            _loc2_.writeUnsignedInt(_pvpInfo.mode);
            _loc2_.writeUnsignedInt(_pvpInfo.petList.length);
            var _loc1_:int = 0;
            while(_loc1_ < _pvpInfo.petList.length)
            {
      ...
      private static function matchSuccess(param1:MessageEvent) : void
      {
         ...
         {
            _loc17_ = uint(_loc8_.readUnsignedInt());
            _loc19_ = uint(_loc8_.readUnsignedInt());
            _loc13_ = uint(_loc8_.readUnsignedInt());
            ...
            {
               _loc11_ = uint(_loc8_.readUnsignedInt());
               _loc12_ = uint(_loc8_.readUnsignedInt());
            ...
            if(_loc17_ == ActorManager.actorInfo.id)
            {
               ...
               _loc18_ = uint(_loc8_.readUnsignedInt());
               _loc20_ = 0;
            ...
            else
            {
               ...
               _loc14_ = uint(_loc8_.readUnsignedInt());
               _loc16_ = 0;
            ...
            _loc21_ = uint(_loc8_.readUnsignedInt());
            _loc22_ = 0;
            while(_loc22_ < _loc21_)
            {
               _loc23_ = new PetInfo();
               _loc23_.resourceId = _loc8_.readUnsignedInt();
               if(_loc17_ == ActorManager.actorInfo.id)
               {
                  _loc9_.push(_loc23_);
               }
      ...
      private static function entryFight() : void
      {
         ...
         MovieClipUtil.getSwfContent(URLUtil.getActivityFullScreen("PetMelee"),function(param1:MovieClip):void
         {
            ...
            _mc.gotoAndPlay(2);
            _mc.addEventListener("enterFrame",onFullScreenEnter);
         });
      }
      ...
      private static function clearMC() : void
      {
         ...
         {
            _mc.stop();
            _mc.removeEventListener("enterFrame",onFullScreenEnter);
      ...
      {
         var _loc2_:LittleEndianByteArray = new LittleEndianByteArray();
         _loc2_.writeUnsignedInt(_pvpInfo.type);
         var _loc1_:Array = [];
