package com.taomee.seer2.app.manager
{
   ...
   public class CommonUseManager
   {
      ...
      public static function showSwapInfo(param1:int, param2:int) : void
      {
         ...
         {
            if(ItemConfig.getItemCategory(param1) == 5)
            {
            ...
            else if(ItemConfig.getItemCategory(param1) == 8)
            {
      ...
      public static function shareContentToQzone(param1:uint) : void
      {
         ...
         ShareToConfig.Instance.getShareToInfo(function():void
         {
            ...
            var _loc2_:shareToInfo = ShareToConfig.Instance.getallShare(shareID);
            if(_loc2_)
            {
               _loc1_ = "http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url=" + _loc2_.url + "&desc=" + _loc2_.desc + "&showcount=1&summary=" + _loc2_.summary + "&title=" + _loc2_.title + "&site=" + _loc2_.site + "&pics=" + _loc2_.pics;
      ...
      public static function shareContentToQQFriend(param1:uint) : void
      {
         ...
         ShareToConfig.Instance.getShareToInfo(function():void
         {
            ...
            if(_loc2_)
            {
               _loc1_ = "http://connect.qq.com/widget/shareqq/index.html?url=" + _loc2_.url + "&desc=" + _loc2_.desc + "&summary=" + _loc2_.summary + "&title=" + _loc2_.title + "&site=" + _loc2_.site + "&width=" + _loc2_.width + "&height=" + _loc2_.height + "&style=" + _loc2_.style + "&pics=" + _loc2_.pics + "&flash=" + _loc2_.flash;
               navigateToURL(new URLRequest(_loc1_),"_blank");
            }
            else
            {
