package com.taomee.seer2.app.manager
{
   ...
   public class FireDragonManager
   {
      ...
      {
         var _loc2_:Boolean = QuestManager.isFreshQuestComplete();
         var _loc1_:* = !(SceneManager.currentSceneType == 2 || SceneManager.active.mapID >= 400 && SceneManager.active.mapID <= 450);
         var _loc4_:* = TimeManager.getServerTime() < endTime;
         var _loc3_:* = SceneManager.active.type != 3;
         return _loc2_ && _loc1_ && _loc4_ && _loc3_ && DreamManager.isDreamMap() == false;
      }
      ...
      private static function showFireDragonBtn() : void
      {
         if(_fireDragonBtn == null)
         {
            ...
            _fireDragonBtn.addEventListener("click",onFireDragonClick);
         }
