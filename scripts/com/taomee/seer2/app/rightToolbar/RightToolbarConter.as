package com.taomee.seer2.app.rightToolbar
{
   ...
   public class RightToolbarConter implements IRightToolbarConter
   {
      ...
      private var _toolbarVec:Vector.<RightToolbar> = new Vector.<RightToolbar>();
      
      private var _upToolbarVec:Vector.<RightToolbar> = new Vector.<RightToolbar>();
      
      private var _leftToolbarVec:Vector.<RightToolbar> = new Vector.<RightToolbar>();
      
      private var _rightRollToolbarVec:Vector.<RightToolbar> = new Vector.<RightToolbar>();
      
      private var _leftRollToolbarVec:Vector.<RightToolbar> = new Vector.<RightToolbar>();
      
      private var _isFirstLogin:Boolean;
      
      private var hideState:Boolean;
      
      private var _mcPanel:Sprite = new Sprite();
      ...
      public function RightToolbarConter()
      {
         ...
         this._rightRoll["btn"].addEventListener("click",this.onRollRightHide);
         this._leftRoll = UIManager.getMovieClip("leftRoll");
         this._leftRoll["btn"].addEventListener("click",this.onRollLeftHide);
         this._rightBtn = UIManager.getButton("rightBtn");
         LayerManager.uiLayer.addChild(this._rightBtn);
         this._rightBtn.addEventListener("click",this.onRollRightShow);
         this._leftBtn = UIManager.getButton("leftBtn");
         LayerManager.uiLayer.addChild(this._leftBtn);
         this._leftBtn.addEventListener("click",this.onRollLeftShow);
      }
      ...
      private function isCanShow() : Boolean
      {
         ...
         if(SceneManager.active.type == 2 || SceneManager.active.type == 4 || SceneManager.active.type == 6 || SceneManager.active.type == 8 || SceneManager.active.type == 10 || SceneManager.active.type == 11 || SceneManager.active.type == 13 || SceneManager.active.type == 12 || SceneManager.active.type == 14 || SceneManager.active.type == 15 || SceneManager.active.type == 16)
         {
            return false;
         }
      ...
      {
         var _loc2_:int = int(this._rightRollToolbarVec.indexOf(param1));
         if(_loc2_ == -1)
         {
      ...
      {
         var _loc2_:int = int(this._leftRollToolbarVec.indexOf(param1));
         if(_loc2_ == -1)
         {
      ...
      {
         var _loc2_:int = int(this._toolbarVec.indexOf(param1));
         if(_loc2_ == -1)
         {
      ...
      {
         var _loc3_:int = int(this._leftToolbarVec.indexOf(param1));
         if(_loc3_ == -1)
         {
      ...
      {
         var _loc2_:int = int(this._leftToolbarVec.indexOf(param1));
         if(_loc2_ != -1)
         {
      ...
      {
         var _loc2_:int = int(this._upToolbarVec.indexOf(param1));
         if(_loc2_ == -1)
         {
      ...
      public function hide() : void
      {
         ...
         this.hideState = true;
         var _loc3_:uint = 0;
         while(_loc3_ < this._toolbarVec.length)
         {
            this._toolbarVec[_loc3_].visible = false;
            _loc3_++;
         }
         ...
         for each(_loc5_ in this._leftToolbarVec)
         {
         ...
         for each(_loc1_ in this._leftRollToolbarVec)
         {
      ...
      public function show() : void
      {
         ...
         while(_loc3_ < this._toolbarVec.length)
         {
            this._toolbarVec[_loc3_].visible = true;
            _loc3_++;
         }
         for each(_loc2_ in this._upToolbarVec)
         {
      ...
      private function layIconsLeft() : void
      {
         var _loc2_:RightToolbar = null;
         var _loc1_:int = 0;
         while(_loc1_ < this._leftToolbarVec.length)
         {
            _loc2_ = this._leftToolbarVec[_loc1_];
            _loc2_.x = 30 + 52 * _loc1_;
            _loc2_.y = 120;
            _loc1_++;
         }
      }
      ...
      private function layIconsRight() : void
      {
         ...
         {
            _loc2_ = this._toolbarVec[_loc1_];
            _loc2_.x = LayerManager.stage.stageWidth - 65;
            _loc2_.y = 370 + 52 * _loc1_;
            _loc1_++;
         }
      }
      ...
      {
         var _loc4_:RightToolbar = null;
         this._currentWidth = Math.min(860 + LayerManager.stage.stageWidth - 1150,960);
         this._mcPanel.x = LayerManager.stage.stageWidth;
         ...
         var _loc3_:* = 1;
         var _loc2_:int = 0;
         var _loc6_:int = int(this._upToolbarVec.length);
         var _loc1_:Vector.<RightToolbar> = this.getDefinedToolbarVec(this._upToolbarVec);
         var _loc5_:int = 0;
         while(_loc5_ < _loc1_.length)
         {
            ...
            {
               _loc10_[_loc5_] = -64;
               _loc8_ = Math.abs(_loc10_[_loc5_]);
               _loc9_[_loc5_] = 0;
               _loc2_++;
            }
            else if(_loc8_ + 5 + _loc4_.width <= this._currentWidth && _loc2_ < 11)
            {
               _loc10_[_loc5_] = 0 - (_loc8_ + 5 + 64);
               _loc8_ = Math.abs(_loc10_[_loc5_]);
               _loc9_[_loc5_] = 64 * (_loc3_ - 1);
               _loc3_ = _loc3_;
               _loc2_++;
            }
            else
         ...
         while(_loc5_ < _loc1_.length)
         {
            ...
            _loc4_.x = _loc10_[_loc5_];
            _loc4_.y = _loc9_[_loc5_] + 38;
            this._mcPanel.addChild(_loc4_);
            _loc5_++;
         }
      ...
      public function addRoll() : void
      {
         ...
         for each(_loc2_ in this._rightRollToolbarVec)
         {
            _loc2_.update();
            _loc2_.visible = true;
         }
