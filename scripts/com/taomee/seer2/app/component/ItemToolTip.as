   ...
   public class ItemToolTip extends Sprite
   {
      ...
      private function setData(param1:Item) : void
      {
         ...
         if(this._item != null)
         {
            ...
            LayerManager.stage.addEventListener("mouseMove",this.onStageMouseMove);
         }
         else
         {
            DisplayObjectUtil.removeFromParent(this);
            LayerManager.stage.removeEventListener("mouseMove",this.onStageMouseMove);
         }
      }
      ...
      private function updateElement(param1:EquipItem) : void
      {
         ...
         if(param1.elementInfo != null)
         {
            ...
            {
               switch(int(param1.strengLevel) - 1)
               {
                  case 0:
      ...
      private function getElementType(param1:Array, param2:Array, param3:uint) : String
      {
         ...
         var _loc4_:Array = param2[param3 - 1];
         var _loc6_:int = 0;
         while(_loc6_ < _loc5_.length)
         {
            switch(_loc5_[_loc6_])
            {
               case 1:
                  _loc7_ += "物攻值";
                  break;
