package com.taomee.seer2.app.component.tree
{
   ...
   public class TreeItem extends Sprite
   {
      ...
      private var _parentItem:TreeItem;
      
      private var _children:Vector.<TreeItem>;
      ...
      public function TreeItem(param1:DisplayObject, param2:Number = 0, param3:Number = 0)
      {
         ...
         this._children = new Vector.<TreeItem>();
      ...
      public function getChildItemAt(param1:int) : TreeItem
      {
      ...
      private function addChildItem(param1:TreeItem) : void
      {
      ...
      public function get rootItem() : TreeItem
      {
         var _loc1_:* = this;
      ...
      {
         var _loc1_:int = 0;
         var _loc2_:Number = this._displayObj.height;
         if(this._showChildren)
         {
            _loc1_ = 0;
            while(_loc1_ < this._children.length)
            {
               _loc2_ += this._children[_loc1_].mesuredHeight + this._yPadding;
               _loc1_++;
            }
         }
         return _loc2_;
      ...
      private function layoutChildren() : void
      {
         ...
         while(_loc1_ < this._children.length)
         {
            ...
            if(this._showChildren)
            {
               ...
               _loc3_.y = _loc2_ + this._yPadding;
               _loc3_.x = this._xMargin;
               addChild(_loc3_);
               _loc2_ += _loc3_.mesuredHeight + this._yPadding;
            }
            else
            {
         ...
         if(hasEventListener("layoutComplete"))
         {
            dispatchEvent(new Event("layoutComplete"));
         }
      }
