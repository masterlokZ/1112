package com.taomee.seer2.app.vip
{
   ...
   public class VipManager extends BaseBean
   {
      ...
      private static function onGetSession(param1:MessageEvent) : void
      {
         ...
         var _loc4_:String = Util.getSessionString(_loc2_);
         _loc3_ = "http://pay.61.com/seer2/mbaccount";
         _loc3_ = _loc3_ + ("?userid=" + ActorManager.actorInfo.id);
         _loc3_ = _loc3_ + ("&gameid=" + ClientConfig.productID);
         _loc3_ = _loc3_ + ("&session=" + _loc4_);
      ...
      private static function onSetChpher(param1:MessageEvent) : void
      {
         ...
         var _loc2_:ByteArray = param1.message.getRawData();
         var _loc4_:String = Util.getSessionString(_loc2_);
         _loc3_ = "http://pay.61.com/account/pwd";
         _loc3_ = _loc3_ + ("?userid=" + ActorManager.actorInfo.id);
         _loc3_ = _loc3_ + ("&gameid=" + ClientConfig.productID);
         _loc3_ = _loc3_ + ("&session=" + _loc4_);
         navigateToURL(new URLRequest(_loc3_),"_blank");
      ...
      public static function entryBBS() : void
      {
         ...
         var _loc3_:* = _loc2_ + "?username=" + _loc1_ + "&gid=" + ClientConfig.productID + "&session=" + GlobalsManager.session + "&fid=37";
         navigateToURL(new URLRequest(_loc3_),"_blank");
      }
      ...
      {
         var _loc2_:String = "http://bbs.61.com/checksession/";
         var _loc4_:uint = ActorManager.actorInfo.id;
         var _loc3_:String = _loc2_ + "?username=" + _loc4_ + "&gid=" + ClientConfig.productID + "&session=" + GlobalsManager.session + "&fid=37" + "&tid=" + param1;
         navigateToURL(new URLRequest(_loc3_),"_blank");
      }
      ...
      private static function onEntryMi(param1:MessageEvent) : void
      {
         ...
         var _loc2_:ByteArray = param1.message.getRawData();
         var _loc4_:String = Util.getSessionString(_loc2_);
         _loc3_ = "http://pay.61.com/buy/paytype";
         _loc3_ = _loc3_ + ("?userid=" + ActorManager.actorInfo.id);
         _loc3_ = _loc3_ + ("&gameid=" + ClientConfig.productID);
         _loc3_ = _loc3_ + ("&session=" + _loc4_);
         navigateToURL(new URLRequest(_loc3_),"_blank");
