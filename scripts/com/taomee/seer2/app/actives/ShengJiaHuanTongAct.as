package com.taomee.seer2.app.actives
{
   ...
   public class ShengJiaHuanTongAct
   {
      ...
      {
         ActiveCountManager.requestActiveCountList([203844,203845,206252],function(param1:Parser_1142):void
         {
            ...
            DayLimitListManager.getDaylimitList(DAY_LIST,(function():*
            {
               ...
               return callBack = function(param1:DayLimitListInfo):void
               {
                  ...
                  canGet = 0;
                  if(SceneManager.prevSceneType == 2 && FightManager.currentFightRecord.initData.positionIndex == 1752)
                  {
                     if(FightManager.fightWinnerSide == 1)
                     {
                        ...
                        {
                           SwapManager.swapItem(4459,1,function(param1:IDataInput):void
                           {
                              new SwapInfo(param1);
      ...
      private function onCLick(param1:MouseEvent) : void
      {
         ...
         if(this.canFight > 0)
         {
            FightManager.startFightWithBoss(1752);
         }
         else
         {
