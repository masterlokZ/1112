package com.taomee.seer2.app.actives
{
   ...
   public class SkyFightManager
   {
      ...
      public function addListener() : void
      {
         ...
         {
            SceneManager.addEventListener("switchComplete",this.onChangeScene);
      ...
      private function onChangeScene(param1:SceneEvent) : void
      {
         ...
         else if(SceneManager.currentSceneType == 1)
         {
            SceneManager.removeEventListener("switchComplete",this.onChangeScene);
