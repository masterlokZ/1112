package com.taomee.seer2.app.actives
{
   ...
   public class ShengJiaYongYeAct
   {
      
      private static var _instance:ShengJiaYongYeAct;
      ...
      private const buy_turn_id:int = 206264;
      
      private const fight_index:int = 1755;
      
      private const fight_chance_item_id:int = 606826;
      ...
      private const leave_map_swap_id:int = 4477;
      
      private const buy_rong_yao_id:int = 606825;
      
      private const DAY_LIST:Array = [1876,1877];
      
      public function ShengJiaYongYeAct()
      {
         super();
      }
      
      public static function getInstance() : ShengJiaYongYeAct
      {
         if(_instance == null)
         {
            _instance = new ShengJiaYongYeAct();
         }
         return _instance;
      }
      ...
      {
         ActiveCountManager.requestActiveCountList([203844,203845,206264],function(param1:Parser_1142):void
         {
            ...
            DayLimitListManager.getDaylimitList(DAY_LIST,(function():*
            {
               ...
               return callBack = function(param1:DayLimitListInfo):void
               {
                  ...
                  canGet = 0;
                  if(SceneManager.prevSceneType == 2 && FightManager.currentFightRecord.initData.positionIndex == 1755)
                  {
                     if(FightManager.fightWinnerSide == 1)
                     {
                        ...
                        AlertManager.showAlert("由于你赢得了胜利,你将获得【暗甲碎片】" + canGet + "个",function():void
                        {
                           SwapManager.swapItem(4477,1,function(param1:IDataInput):void
                           {
                              new SwapInfo(param1);
      ...
      private function onCLick(param1:MouseEvent) : void
      {
         ...
         if(this.canFight > 0)
         {
            FightManager.startFightWithBoss(1755);
         }
         else
         {
            _loc2_ = new BuyPropInfo();
            _loc2_.itemId = 606826;
