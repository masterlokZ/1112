package com.taomee.seer2.app.actives
{
   ...
   public class HaniSnowManActivity
   {
      ...
      {
         this._resLoader = new ResourceLibraryLoader(URLUtil.getRes("active/resource/hani_snow_man_activity.swf"));
      ...
      public function dispose() : void
      {
         ...
         ItemManager.removeEventListener1("requestItemSuccess",this.onRequestSuccess);
         if(this._smileAnimation)
         {
            this._smileAnimation.removeEventListener("click",this.onSmileAnimationClick);
         }
         if(this._normalAnimation)
         {
            this._normalAnimation.removeEventListener("click",this.onNormalClick);
         }
      ...
      private function processSnowNormal() : void
      {
         ...
         this._normalAnimation.addEventListener("click",this.onNormalClick);
      }
      
      private function onNormalClick(param1:MouseEvent) : void
      {
         ItemManager.addEventListener1("requestItemSuccess",this.onRequestSuccess);
      ...
      {
         ItemManager.removeEventListener1("requestItemSuccess",this.onRequestSuccess);
         var _loc2_:int = ItemManager.getItemQuantityByReferenceId(400216);
         if(_loc2_ == 0)
         {
      ...
      private function processSmile() : void
      {
         ...
         this._smileAnimation.addEventListener("click",this.onSmileAnimationClick);
      }
