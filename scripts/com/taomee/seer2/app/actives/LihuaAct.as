package com.taomee.seer2.app.actives
{
   ...
   public class LihuaAct
   {
      ...
      public static function fire(param1:int, param2:int) : void
      {
         ...
         x = MathUtil.randomRegion(300,900);
         y = MathUtil.randomRegion(48,200);
         hongBaoY = MathUtil.randomRegion(450,550);
      ...
      private static function addHongaoClick(param1:DisplayObject, param2:int) : void
      {
         ...
         {
            hongbao.removeEventListener("removedFromStage",onRemove);
            hongbao.removeEventListener("click",onClick);
         };
         ...
         hongbao.addEventListener("click",onClick);
      }
      ...
      private static function loadFireMc(param1:Function) : void
      {
         ...
         QueueLoader.load(URLUtil.getRes("activity/animation/lihua.swf"),"swf",function(param1:ContentInfo):void
         {
