package com.taomee.seer2.app.actives
{
   ...
   public class YueseCraft2016Act
   {
      ...
      public function setup() : void
      {
         ...
         ActiveCountManager.requestActiveCount(206356,this.getArmy);
         ...
         ActiveCountManager.requestActiveCount(206357,function(param1:uint, param2:uint):void
         {
            ...
            if(value == 2)
            {
               if(SceneManager.active.mapID == ARMY_MAP_IDS[army - 1])
               {
                  ...
                  {
                     SwapManager.swapItem(4533,1,(function():*
                     {
      ...
      public function initStep1() : void
      {
         ...
         else
         {
            SceneManager.addEventListener("switchComplete",(function():*
            {
               ...
               return onComplete = function(param1:SceneEvent):void
               {
            ...
            SceneManager.changeScene(9,80518);
         }
      }
         ...
         NpcDialog.showDialogs(dialogs,function():void
         {
            SwapManager.swapItem(4533,1,(function():*
            {
               ...
               return success = function(param1:IDataInput):void
               {
                  ...
                  ActiveCountManager.requestActiveCount(206356,function(param1:uint, param2:uint):void
                  {
                     var type:uint = param1;
                     var value:uint = param2;
