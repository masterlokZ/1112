package com.taomee.seer2.app.actives
{
   ...
   public class ActiveProcess_1 extends BaseActiveProcess
   {
      ...
      override public function start() : void
      {
         ...
         if(time < 720 || time > 1200 || time < 1080 && time > 840)
         {
            this.notOpen();
            return;
         }
         ServerBufferManager.getServerBuffer(100000,function(param1:ServerBuffer):void
         {
      ...
      private function stepOne() : void
      {
         NpcDialog.show(429,"伊特",[[0,"矮冬瓜，我就知道你会来帮我的！准备好了吗？他们就快来了。"]],["我准备好了","再等会"],[function():void
         {
            ...
            {
               UILoader.load("res/active/exteral/1_0.swf","swf",function(param1:ContentInfo):void
               {
      ...
      private function onGameOver(param1:SyncEvent) : void
      {
         ...
         {
            ServerBufferManager.updataSvrExpandBuffer(100000,this._step + 1,1);
            this.overStep(true);
         }
      ...
      private function stepThree() : void
      {
         ...
         {
            UILoader.load("res/active/exteral/1_1.swf","swf",function(param1:ContentInfo):void
            {
               _currentGame = param1.content;
               _currentGame.addEventListener("over",onGameOver);
               LayerManager.topLayer.addChild(_currentGame);
