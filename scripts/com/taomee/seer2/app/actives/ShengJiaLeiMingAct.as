package com.taomee.seer2.app.actives
{
   ...
   public class ShengJiaLeiMingAct
   {
      
      private static var _instance:ShengJiaLeiMingAct;
      ...
      private const buy_turn_id:int = 206248;
      
      private const fight_index:int = 1751;
      ...
      private const leave_map_swap_id:int = 4454;
      
      private const buy_rong_yao_id:int = 606801;
      
      private const DAY_LIST:Array = [1860,1861];
      
      public function ShengJiaLeiMingAct()
      {
         super();
      }
      
      public static function getInstance() : ShengJiaLeiMingAct
      {
         if(_instance == null)
         {
            _instance = new ShengJiaLeiMingAct();
         }
         return _instance;
      }
      ...
      {
         ActiveCountManager.requestActiveCountList([203844,203845,206248],function(param1:Parser_1142):void
         {
            ...
            DayLimitListManager.getDaylimitList(DAY_LIST,(function():*
            {
               ...
               return callBack = function(param1:DayLimitListInfo):void
               {
                  ...
                  canGet = 0;
                  if(SceneManager.prevSceneType == 2 && FightManager.currentFightRecord.initData.positionIndex == 1751)
                  {
                     if(FightManager.fightWinnerSide == 1)
                     {
                        ...
                        AlertManager.showAlert("由于你赢得了胜利,你将获得雷甲碎片" + canGet + "个",function():void
                        {
                           SwapManager.swapItem(4454,1,function(param1:IDataInput):void
                           {
                              new SwapInfo(param1);
      ...
      private function onCLick(param1:MouseEvent) : void
      {
         ...
         if(this.canFight > 0)
         {
            FightManager.startFightWithBoss(1751);
         }
         else
         {
            _loc2_ = new BuyPropInfo();
            _loc2_.itemId = 606802;
