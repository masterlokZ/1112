   ...
   public class GuanXingBossHurtAct
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.petBagBtn)
         {
            ...
            this.fightItemBtn.removeEventListener("click",this.openBoxPanel);
            this.openVipBtn.removeEventListener("click",this.openVipPanel);
         }
      }
      ...
      {
         ActiveCountManager.requestActiveCountList([203981,203982,203984],function(param1:Parser_1142):void
         {
            var canGet:uint;
            var i:int = 0;
            ...
            canGet = 0;
            if(SceneManager.prevSceneType == 2 && FightManager.currentFightRecord.initData.positionIndex == 875)
            {
               if(FightManager.fightWinnerSide == 1)
               {
                  ...
                  {
                     SwapManager.swapItem(2633,1,function(param1:IDataInput):void
                     {
                        new SwapInfo(param1);
      ...
      private function onCLick(param1:MouseEvent) : void
      {
         ...
         if(this.canFight > 0)
         {
            FightManager.startFightWithBoss(875);
         }
         else
         {
            _loc2_ = new BuyPropInfo();
            _loc2_.itemId = 603663;
      ...
      private function initEvent() : void
      {
         ...
         this.fightItemBtn.addEventListener("click",this.openBoxPanel);
         this.openVipBtn.addEventListener("click",this.openVipPanel);
      }
      ...
      private function onExitBtn(param1:MouseEvent) : void
      {
         ...
         AlertManager.showConfirm("离开地图将结束此轮挑战，你确定要离开吗？",function():void
         {
            ...
            {
               new SwapInfo(param1);
               SceneManager.addEventListener("switchComplete",showPanel);
               SceneManager.changeScene(1,70);
            });
         });
      }
      ...
      {
         SceneManager.removeEventListener("switchComplete",this.showPanel);
