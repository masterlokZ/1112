package com.taomee.seer2.app.actives
{
   ...
   public class ShengJiaKuangZhanAct
   {
      
      private static var _instance:ShengJiaKuangZhanAct;
      ...
      private const fight_index:int = 1753;
      
      private const fight_chance_item_id:int = 606814;
      ...
      private const leave_map_swap_id:int = 4465;
      
      private const buy_rong_yao_id:int = 606813;
      
      private const DAY_LIST:Array = [1868,1869];
      
      public function ShengJiaKuangZhanAct()
      {
         super();
      }
      
      public static function getInstance() : ShengJiaKuangZhanAct
      {
         if(_instance == null)
         {
            _instance = new ShengJiaKuangZhanAct();
         }
         return _instance;
      }
      ...
      {
         ActiveCountManager.requestActiveCountList([203844,203845,206256],function(param1:Parser_1142):void
         {
            ...
            DayLimitListManager.getDaylimitList(DAY_LIST,(function():*
            {
               ...
               return callBack = function(param1:DayLimitListInfo):void
               {
                  ...
                  canGet = 0;
                  if(SceneManager.prevSceneType == 2 && FightManager.currentFightRecord.initData.positionIndex == 1753)
                  {
                     if(FightManager.fightWinnerSide == 1)
                     {
                        ...
                        AlertManager.showAlert("由于你赢得了胜利,你将获得【勇气之心】" + canGet + "个",function():void
                        {
                           SwapManager.swapItem(4465,1,function(param1:IDataInput):void
                           {
                              new SwapInfo(param1);
      ...
      private function onCLick(param1:MouseEvent) : void
      {
         ...
         if(this.canFight > 0)
         {
            FightManager.startFightWithBoss(1753);
         }
         else
         {
            _loc2_ = new BuyPropInfo();
            _loc2_.itemId = 606814;
