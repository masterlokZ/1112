package com.taomee.seer2.app.init
{
   ...
   public class LoginInfo
   {
      ...
      public static function setFromOnline(param1:IDataInput) : void
      {
         ...
         _userInfo.ip = param1.readUTFBytes(20);
         _userInfo.isYearVip = param1.readUnsignedInt();
         if(_loc3_ != 0)
         {
            _userInfo.birthdayInfo.isOpen = true;
            _userInfo.birthdayInfo.year = _loc3_ / 10000;
            _userInfo.birthdayInfo.month = _loc3_ % 10000 / 100;
      ...
      {
         ServerBufferManager.getServerBuffer(20,onGetServer);
      }
