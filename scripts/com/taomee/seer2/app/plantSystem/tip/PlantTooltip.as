package com.taomee.seer2.app.plantSystem.tip
{
   ...
   internal class PlantTooltip extends Sprite
   {
      ...
      private var _currentItemTipSkin:PlantItemSkin;
      
      private var _currentIconTipSkin:PlantIconSkin;
      ...
      {
         var _loc8_:TipStuct = null;
         if(this._map.containsKey(param1))
         {
            this.chanegTip(param1,param2,param3,param4,param5,param6);
            return;
         }
         param1.addEventListener("rollOver",this.onTargetOver);
         param1.addEventListener("rollOut",this.onTargetOut);
         param2.addEventListener("rollOver",this.onTargetOver);
         param2.addEventListener("rollOut",this.onTargetOut);
         _loc8_ = new TipStuct();
         _loc8_.nick = param3;
      ...
      public function addIcon(param1:InteractiveObject, param2:String, param3:uint, param4:Boolean, param5:PlantIconSkin) : void
      {
         var _loc6_:TipStuct = null;
         if(this._map.containsKey(param1))
         {
            this.chanegIconTip(param1,param2,param3,param4);
            return;
         }
         param1.addEventListener("rollOver",this.onIconTargetOver);
         param1.addEventListener("rollOut",this.onIconTargetOut);
         _loc6_ = new TipStuct();
      ...
      private function onIconTargetOver(param1:MouseEvent) : void
      {
         ...
         if(_loc2_)
         {
            ...
            this.deployTooltip(param1.stageX,param1.stageY - 10);
         }
         LayerManager.stage.addEventListener("mouseMove",this.onTooltipMove);
      }
      ...
      private function onIconTargetOut(param1:MouseEvent) : void
      {
         ...
         LayerManager.stage.removeEventListener("mouseMove",this.onTooltipMove);
      }
      
      public function addItem(param1:InteractiveObject, param2:String, param3:PlantItemSkin) : void
      {
         var _loc4_:TipStuct = null;
         if(this._map.containsKey(param1))
         {
            this.chanegItemTip(param1,param2);
            return;
         }
         param1.addEventListener("rollOver",this.onItemTargetOver);
         param1.addEventListener("rollOut",this.onItemTargetOut);
         _loc4_ = new TipStuct();
      ...
      public function removeItem(param1:InteractiveObject) : void
      {
         ...
         if(this._map.containsKey(param1) && this._map.getValue(param1) is TipStuct)
         {
            param1.removeEventListener("rollOver",this.onTargetOver);
            param1.removeEventListener("rollOut",this.onTargetOut);
         ...
         {
            param1.removeEventListener("rollOver",this.artTipsControl);
            param1.removeEventListener("rollOut",this.artTipsControl);
            this._map.remove(param1);
         }
      }
      ...
      public function remove(param1:InteractiveObject, param2:InteractiveObject) : void
      {
         ...
         if(this._map.containsKey(param1) && this._map.getValue(param1) is TipStuct)
         {
            param1.removeEventListener("rollOver",this.onTargetOver);
            param1.removeEventListener("rollOut",this.onTargetOut);
            param2.removeEventListener("rollOver",this.onTargetOver);
            param2.removeEventListener("rollOut",this.onTargetOut);
      ...
      public function chanegTip(param1:InteractiveObject, param2:InteractiveObject, param3:String, param4:String, param5:uint, param6:uint) : void
      {
         ...
         if(this._map.containsKey(param1))
         {
            _loc7_ = this._map.getValue(param1);
            _loc7_.nick = param3;
      ...
      public function chanegIconTip(param1:InteractiveObject, param2:String, param3:uint, param4:Boolean) : void
      {
         ...
         if(this._map.containsKey(param1))
         {
            _loc5_ = this._map.getValue(param1);
            _loc5_.content = param2;
            _loc5_.id = param3;
            _loc5_.isPet = param4;
         }
      }
      ...
      public function addArtTips(param1:InteractiveObject, param2:InteractiveObject, param3:DisplayObject) : void
      {
         ...
         param1.addEventListener("rollOver",this.artTipsControl);
         param1.addEventListener("rollOut",this.artTipsControl);
         param2.addEventListener("rollOver",this.onTargetOver);
         param2.addEventListener("rollOut",this.onTargetOut);
      ...
      private function artTipsControl(param1:MouseEvent) : void
      {
         ...
         {
            _loc2_.addEventListener("mouseMove",this.artTipsControl);
      ...
      private function deployTooltip(param1:int, param2:int) : void
      {
         ...
         if(_loc3_ - this._currentTipSkin.height < 0)
         {
            _loc3_ = this._currentTipSkin.height - 22;
         }
         if(_loc4_ + this._currentTipSkin.width - 10 > LayerManager.root.width)
         {
            _loc4_ = LayerManager.root.width - this._currentTipSkin.width + 10;
         }
         if(_loc3_ + this._currentTipSkin.height > LayerManager.root.height)
         {
            _loc3_ = LayerManager.root.height - this._currentTipSkin.height - 25;
         }
         this._currentTipSkin.x = _loc4_;
         this._currentTipSkin.y = _loc3_;
      }
   }
}
