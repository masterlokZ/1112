package com.taomee.seer2.app.seriesActivity.xieesiling
{
   ...
   public class XieesilingFengyinModule extends XieesilingModule
   {
      ...
      {
         DayLimitListManager.getDaylimitList([xieesilignConfig.fengyinFightNumId,xieesilignConfig.fightDamageId],(function():*
         {
      ...
      public function onPanelClick(param1:MouseEvent) : void
      {
         ...
         switch(e.target.name)
         {
            case "fightBtn":
               ...
               break;
            case "addBtn":
               ShopManager.buyItemForId(xieesilignConfig.addFengyinFightNumBuyId,(function():*
               {
                  var buyComplete:Function;
                  return buyComplete = function(param1:*):void
                  {
                     refreshPanel();
                  };
               })());
      ...
      protected function passByMoney() : void
      {
         ...
         module = this;
         ShopManager.buyItemForId(xieesilignConfig.xingzuanFengyinByStartId + this._fengyinIndex,(function():*
         {
            var buyComplete:Function;
            return buyComplete = function(param1:*):void
            {
      ...
      {
         DayLimitListManager.getDaylimitList([xieesilignConfig.fightFlagId],(function():*
         {
            var callback:Function;
            return callback = function(param1:DayLimitListInfo):void
            {
