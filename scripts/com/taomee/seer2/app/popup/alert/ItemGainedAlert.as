package com.taomee.seer2.app.popup.alert
{
   ...
   public class ItemGainedAlert extends Sprite implements IAlert
   {
      ...
      public function ItemGainedAlert()
      {
         super();
         this.initialize();
      }
      ...
      private function initialize() : void
      {
         ...
         this._iconDisplay.x = 97;
         this._iconDisplay.y = 42;
      ...
      {
         var _loc2_:String = ItemConfig.getItemIconUrl(this._info.referenceId);
         var _loc1_:String = ItemConfig.getItemName(this._info.referenceId);
