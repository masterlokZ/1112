package com.taomee.seer2.app.config
{
   ...
   [Embed(source="/_assets/115_com.taomee.seer2.app.config.SkillConfig__hideMovesXmlClass.bin", mimeType="application/octet-stream")]
   public class SkillConfig__hideMovesXmlClass extends ByteArrayAsset
   {
      
      public function SkillConfig__hideMovesXmlClass()
      {
         super();
      }
   }
