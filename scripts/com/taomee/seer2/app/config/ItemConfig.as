package com.taomee.seer2.app.config
{
   ...
   public class ItemConfig
   {
      ...
      {
         var _loc4_:* = null;
         _loc4_ = param1.elements(param2).toString();
         if(_loc4_ == "")
         {
            _loc4_ = param3;
         }
      ...
      {
         var _loc13_:int = 0;
         var _loc21_:int = parseInt(param1,"ID");
         var _loc7_:int = parseInt(param1.parent(),"ID");
         var _loc22_:String = parseString(param1,"Name");
         var _loc5_:int = parseInt(param1,"Price",0);
         var _loc19_:int = parseInt(param1,"CurrencyType",1);
         var _loc6_:int = parseInt(param1,"Tradability",0);
         var _loc20_:int = parseInt(param1,"VipTradability",0);
         var _loc3_:Boolean = parseBool(param1,"VipOnly",false);
         var _loc26_:Boolean = parseBool(param1,"isHide",false);
         if(param1.attribute("Max").toString() == "")
         {
            _loc13_ = parseInt(param1.parent(),"Max");
         }
         else
         {
            _loc13_ = parseInt(param1,"Max");
         }
         var _loc24_:String = parseChild(param1,"Tip");
         var _loc11_:int = parseInt(param1,"SlotIndex",0);
         var _loc31_:int = parseInt(param1,"SuitID",0);
         var _loc17_:int = parseInt(param1,"LifeTime",0);
         var _loc29_:int = parseInt(param1,"TimeLimit",0);
         var _loc15_:int = parseInt(param1,"Bonus",0);
         var _loc23_:int = parseInt(param1,"HP",0);
         var _loc9_:int = parseInt(param1,"Exp",0);
         var _loc4_:String = parseString(param1,"LevelLimit");
         var _loc12_:int = parseInt(param1,"Type",0);
         var _loc28_:int = parseInt(param1,"SellPrice",0);
         var _loc10_:int = parseInt(param1,"SwapId",0);
         var _loc25_:String = parseString(param1,"Rule");
         var _loc16_:int = parseInt(param1,"Level",0);
         var _loc32_:String = parseString(param1,"Title");
         var _loc14_:int = parseInt(param1,"BreedTime",0);
         var _loc30_:int = parseInt(param1,"BreedMonID",0);
         var _loc8_:int = parseInt(param1,"BreedMonLv",0);
         var _loc2_:int = parseInt(param1,"ExchangeItemID",0);
         var _loc18_:int = parseInt(param1,"ExchangeCount",0);
         var _loc27_:int = parseInt(param1,"MiBuyID");
         switch(_itemType)
         {
            case "characteristic":
               _basisMap.add(_itemID,new BasisItemDefinition(_loc21_,_loc7_,_loc22_,_loc5_,_loc19_,_loc6_,_loc20_,_loc3_,_loc26_,_loc13_,_loc24_));
               break;
            case "equip":
               _equipMap.add(_itemID,new EquipItemDefinition(_loc21_,_loc7_,_loc22_,_loc5_,_loc19_,_loc6_,_loc20_,_loc3_,_loc26_,_loc13_,_loc24_,_loc11_,_loc31_,_loc17_,_loc29_));
               break;
            case "emblemItem":
               _emblemMap.add(_itemID,new EmblemItemDefinition(_loc21_,_loc7_,_loc22_,_loc5_,_loc19_,_loc6_,_loc20_,_loc3_,_loc26_,_loc13_,_loc24_,_loc27_));
               break;
            case "petItem":
               _petMap.add(_itemID,new PetItemDefinition(_loc21_,_loc7_,_loc22_,_loc5_,_loc19_,_loc6_,_loc20_,_loc3_,_loc26_,_loc13_,_loc24_,_loc15_,_loc23_,_loc9_,_loc4_,_loc12_,_loc28_,_loc10_));
               break;
            case "collection":
               _collectionMap.add(_itemID,new CollectionItemDefinition(_loc21_,_loc7_,_loc22_,_loc5_,_loc19_,_loc6_,_loc20_,_loc3_,_loc26_,_loc13_,_loc24_,_loc25_,_loc28_,_loc12_));
               break;
            case "medalItem":
               _medalMap.add(_itemID,new MedalItemDefinition(_loc21_,_loc7_,_loc22_,_loc5_,_loc19_,_loc6_,_loc20_,_loc3_,_loc26_,_loc13_,_loc24_,_loc12_,_loc16_,_loc32_));
               break;
            case "petSpirtItem":
               _petSpirtTrainMap.add(_itemID,new PetSpirtTrainItemDefinition(_loc21_,_loc7_,_loc22_,_loc5_,_loc19_,_loc6_,_loc20_,_loc3_,_loc26_,_loc13_,_loc24_,_loc12_,_loc14_,_loc30_,_loc8_,_loc2_,_loc18_));
         }
      }
      ...
      private static function getItemType(param1:XML) : String
      {
         ...
         else if(100000 < _itemID && _itemID <= 200000)
         {
            _loc2_ = "equip";
         }
         else if(200000 < _itemID && _itemID <= 300000)
         {
            _loc2_ = "petItem";
         }
         else if(300000 < _itemID && _itemID <= 400000)
         {
            _loc2_ = "emblemItem";
         }
         else if(400000 < _itemID && _itemID <= 500000)
         {
            _loc2_ = "collection";
         }
         else if(500000 < _itemID && _itemID <= 700000)
         {
            _loc2_ = "medalItem";
         }
         else if(700000 < _itemID && _itemID <= 750000)
         {
            _loc2_ = "emblemItem";
         }
         else if(750000 < _itemID && _itemID <= 805999)
         {
            _loc2_ = "petSpirtItem";
         }
         return _loc2_;
      ...
      public static function getSuitEquipList(param1:uint) : Vector.<EquipItemDefinition>
      {
         ...
         var _loc4_:Vector.<EquipItemDefinition> = Vector.<EquipItemDefinition>([]);
         for each(_loc3_ in _loc2_)
         {
      ...
      public static function getItemIconUrl(param1:uint) : String
      {
         ...
         {
            case 0:
               _loc3_ = URLUtil.getItemIcon(param1);
               break;
            case 4:
               _loc3_ = URLUtil.getCollectionIcon(param1);
               break;
            case 3:
               _loc3_ = URLUtil.getEmblemIcon(param1);
               break;
            case 1:
               _loc3_ = URLUtil.getEquipIcon(param1);
               break;
            case 5:
               _loc3_ = URLUtil.getMedalIcon(param1);
               break;
            case 2:
               _loc3_ = URLUtil.getPetRelateIcon(param1);
               break;
            case 101:
               _loc3_ = URLUtil.getSpecialIcon(param1);
               break;
            case 8:
               _loc3_ = URLUtil.getPetSpirtTrainIcon(param1);
         }
         if(param1 >= 102000 && param1 < 102999)
         {
            _loc3_ = URLUtil.getNonoEquipIconSwf(param1);
         }
         return _loc3_;
      }
