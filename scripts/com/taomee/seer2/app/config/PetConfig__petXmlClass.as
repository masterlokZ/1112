package com.taomee.seer2.app.config
{
   ...
   [Embed(source="/_assets/74_com.taomee.seer2.app.config.PetConfig__petXmlClass.bin", mimeType="application/octet-stream")]
   public class PetConfig__petXmlClass extends ByteArrayAsset
   {
      
      public function PetConfig__petXmlClass()
      {
         super();
      }
   }
