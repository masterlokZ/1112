package com.taomee.seer2.app.config
{
   ...
   public class PetConfig
   {
      ...
      public static function parseData(param1:XML, param2:XML, param3:XML) : void
      {
         ...
         var _loc6_:XML = null;
         _sloganXml = param3;
         var _loc8_:XMLList = param2.elements("Monster");
         for each(_loc5_ in _loc8_)
         {
            parsePetDictionary(_loc5_);
         }
         _loc8_ = param3.elements("Monster");
         for each(_loc4_ in _loc8_)
         {
            parsePetDialog(_loc4_);
         }
         _loc8_ = param1.elements("Monster");
      ...
      private static function parsePet(param1:XML) : void
      {
         ...
         var _loc25_:uint = 0;
         var _loc22_:uint = uint(param1.@NumbersID);
         var _loc7_:String = String(param1.@ID);
         var _loc23_:PetDictionaryInfo = getPetDefinitionInfo(int(_loc7_));
         var _loc5_:PetDialogInfo = getPetDialogInfo(int(_loc7_));
         var _loc20_:String = param1.@DefName;
         var _loc6_:uint = addUintPropertyToResult(param1.@Type);
         var _loc21_:uint = addUintPropertyToResult(param1.@GrowthType);
         var _loc3_:uint = addUintPropertyToResult(param1.@EvolvingLv);
         var _loc29_:uint = addUintPropertyToResult(param1.@CatchRate);
         var _loc14_:uint = addUintPropertyToResult(param1.@Features);
         var _loc26_:String = param1.@gender;
         var _loc11_:uint = addUintPropertyToResult(param1.@HP);
         var _loc33_:uint = addUintPropertyToResult(param1.@Atk);
         var _loc18_:uint = addUintPropertyToResult(param1.@SpAtk);
         var _loc31_:uint = addUintPropertyToResult(param1.@Def);
         var _loc16_:uint = addUintPropertyToResult(param1.@SpDef);
         var _loc24_:uint = addUintPropertyToResult(param1.@Spd);
         var _loc9_:Boolean = param1.@FreeForbidden == "0" ? true : false;
         var _loc4_:uint = uint(param1.@StarLv);
         var _loc12_:uint = addUintPropertyToResult(param1.@ChgMonId);
         var _loc30_:uint = uint(param1.@RealId);
         if(_loc5_)
         {
            _loc10_ = _loc5_.slogan0;
            _loc27_ = _loc5_.slogan1;
         }
         if(_loc23_)
         {
            _loc17_ = _loc23_.intro;
            _loc34_ = _loc23_.Foundin;
            _loc15_ = _loc23_.Features;
            _loc32_ = addUintPropertyToResult(_loc23_.emblemID);
            _loc8_ = addUintPropertyToResult(_loc23_.isNew);
            _loc2_ = _loc23_.Height;
            _loc19_ = _loc23_.Weight;
            _loc28_ = _loc23_.chara;
            _loc13_ = _loc23_.charaPoint;
            _loc25_ = addUintPropertyToResult(_loc23_.emblem2ID);
         }
         addPetDefinition(_loc22_,uint(_loc7_),_loc20_,_loc8_,_loc6_,_loc21_,_loc28_,_loc13_,_loc3_,_loc29_,_loc2_,_loc19_,_loc14_,_loc15_,_loc32_,_loc26_,_loc34_,_loc11_,_loc33_,_loc18_,_loc31_,_loc16_,_loc24_,_loc9_,_loc17_,[_loc10_,_loc27_],_loc4_,_loc12_,_loc30_,_loc25_);
      }
      ...
      public static function getPetSkillSettingDefinitionVec(param1:uint) : Vector.<PetSkillSettingDefinition>
      {
         ...
         var _loc4_:uint = 0;
         var _loc6_:Vector.<PetSkillSettingDefinition> = new Vector.<PetSkillSettingDefinition>();
         var _loc8_:String = param1.toString();
         _loc7_ = _bunchSkillSettingMap_2.getKeys();
         var _loc3_:int = int(_loc7_.length);
         var _loc2_:int = 0;
         while(_loc2_ < _loc3_)
         {
            _loc5_ = String(_loc7_[_loc2_]);
            _loc4_ = uint(_loc5_.indexOf("_"));
            if(_loc5_.substr(0,_loc4_) == param1.toString())
            {
               _loc6_.push(_bunchSkillSettingMap_2.getValue(_loc5_));
            }
            _loc2_++;
         }
         return _loc6_;
      ...
      private static function parsePetBunchSkill(param1:XML) : void
      {
         ...
         var _loc6_:uint = uint(param1.@NumbersID);
         var _loc8_:XMLList = param1.descendants("Move");
         for each(_loc7_ in _loc8_)
         {
            _loc3_ = uint(_loc7_.@ID);
            _loc2_ = uint(_loc7_.@LearningLv);
            _loc5_ = _loc7_.@SoundID;
            _loc4_ = _loc7_.@EffectID;
            addPetSkillSettingDefinition(_loc6_,_loc3_,_loc2_,_loc5_,_loc4_);
         }
      }
