package com.taomee.seer2.app.gameRule.spt
{
   ...
   public class SptFeiYaSiSupport extends BaseSptSupport
   {
      ...
      {
         if(Boolean(this._sptNPC_1) && this._sptNPC_1.hasEventListener("click"))
         {
            this._sptNPC_1.removeEventListener("click",this.onSPTClickHandler);
         }
         this._sptNPC_1 = null;
         if(Boolean(this._sptNPC_2) && this._sptNPC_2.hasEventListener("click"))
         {
            this._sptNPC_2.removeEventListener("click",this.onSPTDoubleHandler);
         }
         this._sptNPC_2 = null;
      }
      ...
      private function showNPCUnCondition() : void
      {
         ...
         onActionEnd = function(param1:Event):void
         {
            ...
            _sptNPC_1.addEventListener("click",onSPTClickHandler);
         };
         this.removeSptNpc();
      ...
      private function showNPCWin() : void
      {
         ...
         onActionEnd = function(param1:Event):void
         {
            ...
            _sptNPC_2.addEventListener("click",onSPTDoubleHandler);
         };
         this.removeSptNpc();
         this._feiyasi_MC.addEventListener("actionEnd",onActionEnd);
      ...
      override protected function dealWithMapInit() : void
      {
         ...
         mapInitCallBack = function(param1:LittleEndianByteArray):void
         {
            ...
            var _loc4_:uint = _loc2_.highestPetLevel;
            if(_loc4_ >= _petMaxLevelLimit)
            {
               _loc3_ = SptBossInfoManager.resolveSpt(_sptBossId,param1);
               if(_winHistory)
               {
                  if(_loc3_ >= 11)
                  {
      ...
      override protected function fightFailure(param1:LittleEndianByteArray) : void
      {
         ...
         if(_loc2_ < 2)
         {
            ...
            _loc4_ = new XML(SptDialogConfig.getSptDialog(_sptBossId,3,[SptDialogConfig.getTalkContent(_sptBossId)]));
      ...
      override protected function fightWin() : void
      {
         ...
         onSwitchComplete = function(param1:Event):void
         {
            ...
            _animationPlayer.addEventListener("end",fullScreenAnimaitonEnd);
         ...
         fullScreenAnimaitonEnd = function(param1:Event):void
         {
            ...
            _animationPlayer.removeEventListener("end",fullScreenAnimaitonEnd);
      ...
      override protected function onSPTClickHandler(param1:MouseEvent) : void
      {
         ...
         {
            var _loc2_:uint = SptBossInfoManager.resolveSpt(127,param1);
            if(_loc2_ < 1)
            {
               unConfigDialoge();
            }
         ...
         var doWhenNeverWinBefore:Function = function():void
         {
            ...
            DialogPanel.showForCommon(_loc1_,onClose_1);
         };
