package com.taomee.seer2.app.quest.target
{
   ...
   public class QuestStepTargetMine extends BaseQuestStepTarget
   {
      ...
      {
         super.start();
         ItemManager.addEventListener1("mineSuccess",this.onMineSuccess);
      }
      
      override public function finish() : void
      {
         ItemManager.removeEventListener1("mineSuccess",this.onMineSuccess);
         super.finish();
      }
      
      private function onMineSuccess(param1:ItemEvent) : void
      {
         if(_params != "" && param1.content == uint(_params))
         {
            ItemManager.removeEventListener1("mineSuccess",this.onMineSuccess);
            execute();
         }
