package com.taomee.seer2.app.common
{
   ...
   public class MovieClipPlayer
   {
      ...
      public function playMc(param1:MovieClip, param2:*, param3:* = null, param4:Boolean = false, param5:Function = null) : void
      {
         ...
         this._mc.addEventListener("enterFrame",this.onEnterFrame);
      }
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         {
            _loc2_ = this._endFrame == this._mc.currentFrame;
         }
         else if(this._endFrame is String)
         {
            _loc2_ = this._endFrame == this._mc.currentLabel;
         }
         if(_loc2_)
         {
            this._mc.removeEventListener("enterFrame",this.onEnterFrame);
