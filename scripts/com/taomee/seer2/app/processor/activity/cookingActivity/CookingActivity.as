package com.taomee.seer2.app.processor.activity.cookingActivity
{
   ...
   public class CookingActivity
   {
      ...
      private function init() : void
      {
         ...
         {
            ServerBufferManager.updateServerBuffer(17,0,0);
         }
      ...
      {
         this._suer = MobileManager.getMobile(314,"npc");
      ...
      private function initTime() : void
      {
         ...
         {
            TimeManager.addEventListener("timeUpdate",this.onTimeUpdate);
         }
      }
      ...
      private function onDialogShow(param1:DialogPanelEvent) : void
      {
         ...
         if(param1.content == 314)
         {
            ...
            _loc2_.addEventListener("customUnitClick",this.onUnitClick);
      ...
      private function onUnitClick(param1:FunctionalityBoxEvent) : void
      {
         ...
         {
            ServerBufferManager.getServerBuffer(17,this.onGetSer,false);
            StatisticsManager.sendNoviceAccountHttpd("0x1003320E");
         }
      }
      ...
      private function initPot() : void
      {
         ...
         this._pot.addEventListener("click",this.onPot);
      }
      
      private function onPot(param1:MouseEvent) : void
      {
         ServerBufferManager.getServerBuffer(17,this.onGetSer,false);
         StatisticsManager.sendNoviceAccountHttpd("0x1003320F");
      }
      ...
      private function onClick(param1:MouseEvent) : void
      {
         ...
         ServerBufferManager.getServerBuffer(17,this.onGetSerLeiNa);
      }
      ...
      private function onGetSerLeiNa(param1:ServerBuffer) : void
      {
         ...
         {
            ServerBufferManager.updateServerBuffer(17,0,ran);
      ...
      {
         TimeManager.removeEventListener("timeUpdate",this.onTimeUpdate);
