package com.taomee.seer2.app.processor.activity.map800Activity
{
   ...
   public class BlackFight
   {
      ...
      {
         super();
         StatisticsManager.sendNovice("0x10033800");
         ...
         this._activity.addEventListener("click",this.onActivity);
      }
      ...
      {
         this._mainNpc = MobileManager.getMobile(565,"npc");
         this._ruikeNpc = MobileManager.getMobile(524,"npc");
         this._loulanNpc = MobileManager.getMobile(525,"npc");
         this._bifuNpc = MobileManager.getMobile(526,"npc");
         this.addEvent();
      }
      ...
      private function addEvent() : void
      {
         ...
         this._mainNpc.addEventListener("click",this.onMain,false,1);
         this._ruikeNpc.addEventListener("click",this.onRuike,false,1);
         this._loulanNpc.addEventListener("click",this.onLoulan,false,1);
         this._bifuNpc.addEventListener("click",this.onBifu,false,1);
      }
      ...
      private function onMain(param1:MouseEvent) : void
      {
         ...
         DayLimitManager.getDoCount(644,function(param1:uint):void
         {
            ...
            if(param1 < 50)
            {
               ...
               _loc2_ = new CustomUnit("active","黑羽之战","heiyu");
      ...
      private function addUnit(param1:String) : void
      {
         ...
         _loc2_ = new CustomUnit("active","兑换精灵",param1);
         DialogPanel.functionalityBox.addUnit(_loc2_);
      }
      ...
      private function addMiBuyUint(param1:String) : void
      {
         ...
         _loc2_ = new CustomUnit("active","一键获得",param1);
         DialogPanel.functionalityBox.addUnit(_loc2_);
      }
      ...
      public function dispose() : void
      {
         ...
         this._mainNpc.removeEventListener("click",this.onMain);
         this._ruikeNpc.removeEventListener("click",this.onRuike);
         this._loulanNpc.removeEventListener("click",this.onLoulan);
         this._bifuNpc.removeEventListener("click",this.onBifu);
         this._mainNpc = null;
         this._ruikeNpc = null;
