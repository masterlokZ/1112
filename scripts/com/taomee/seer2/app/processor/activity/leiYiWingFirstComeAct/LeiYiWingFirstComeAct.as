package com.taomee.seer2.app.processor.activity.leiYiWingFirstComeAct
{
   ...
   public class LeiYiWingFirstComeAct
   {
      ...
      {
         QueueLoader.load(URLUtil.getActivityAnimation("LeiYiWingFirstComeAct"),"swf",function(param1:ContentInfo):void
         {
      ...
      private static function onPieceClick(param1:MouseEvent) : void
      {
         ...
         SwapManager.swapItem(4126,1,function(param1:IDataInput):void
         {
