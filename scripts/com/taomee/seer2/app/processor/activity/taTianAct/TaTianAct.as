package com.taomee.seer2.app.processor.activity.taTianAct
{
   ...
   public class TaTianAct
   {
      ...
      {
         if(SceneManager.prevSceneType == 1)
         {
      ...
      {
         QueueLoader.load(URLUtil.getActivityAnimation("taTianAct/TaTianAct"),"swf",function(param1:ContentInfo):void
         {
      ...
      {
         this._tipLink.addEventListener("click",this.onTipShow);
         this._tipCloseBtn.addEventListener("click",this.onTipHide);
         var _loc1_:int = 0;
      ...
      private function onLeave(param1:MouseEvent) : void
      {
         ...
         if(_resMapId != 0)
         {
            SceneManager.changeScene(1,_resMapId);
         }
         else
         {
      ...
      private function onForward(param1:MouseEvent) : void
      {
         ...
         if(this.forwardFilter())
         {
            ...
            ActiveCountManager.requestActiveCount(204331,function(param1:uint, param2:uint):void
            {
               ...
               MovieClipUtil.playMc(_forwardMC,2,_forwardMC.totalFrames,function():void
               {
                  ...
                  {
                     Connection.send(CommandSet.RANDOM_EVENT_1140,98,0);
                  }
               });
            });
         }
      ...
      private function onGetItem(param1:MessageEvent) : void
      {
         ...
         while(_loc4_ < _loc5_)
         {
            ...
            if(GOLD_CARD_LIST.indexOf(_loc2_) != -1)
            {
      ...
      private function onEventHandleById(param1:int) : void
      {
         ...
         {
            ModuleManager.addEventListener("TaTianEventTwoActPanel","dispose",function(param1:ModuleEvent):void
            {
               addRandomGift();
            });
         ...
         {
            ModuleManager.addEventListener("TaTianEventFourActPanel","dispose",this.onEventFourHide);
      ...
      {
         ModuleManager.removeEventListener("TaTianEventFourActPanel","dispose",this.onEventFourHide);
         this.update();
      }
      ...
      private function onEventStart(param1:MessageEvent) : void
      {
         ...
         if(parser.index == 98)
         {
            ...
            {
               ModuleManager.addEventListener("TaTianEventTwoActPanel","dispose",(function():*
               {
                  var onTwoClose:Function;
                  return onTwoClose = function(param1:ModuleEvent):void
                  {
                     ModuleManager.removeEventListener("TaTianEventTwoActPanel","dispose",onTwoClose);
                     addRandomGift();
                  };
               })());
               ModuleManager.showModule(URLUtil.getAppModule("TaTianEventTwoActPanel"),"正在打开遇到悬浮物提示面板...");
            ...
            {
               ModuleManager.addEventListener("TaTianEventThreeActPanel","dispose",(function():*
               {
                  var onThreeClose:Function;
                  return onThreeClose = function(param1:ModuleEvent):void
                  {
                     ModuleManager.removeEventListener("TaTianEventThreeActPanel","dispose",onThreeClose);
                     update();
                  };
               })());
               ModuleManager.showModule(URLUtil.getAppModule("TaTianEventThreeActPanel"),"正在打开获得卡牌面板...",{
            ...
            {
               ModuleManager.addEventListener("TaTianEventFourActPanel","dispose",(function():*
               {
                  var onFourClose:Function;
                  return onFourClose = function(param1:ModuleEvent):void
                  {
                     ModuleManager.removeEventListener("TaTianEventFourActPanel","dispose",onFourClose);
                     update();
                  };
               })());
               ModuleManager.showModule(URLUtil.getAppModule("TaTianEventFourActPanel"),"正在打开天上掉馅饼面板...");
      ...
      private function onGiftClick(param1:MouseEvent) : void
      {
         ...
         MineManger.getMineItem(324,function(param1:Parser_1060):void
         {
            param1.showResult();
      ...
      private function update(param1:Function = null) : void
      {
         ...
         this._forward.mouseEnabled = false;
         ActiveCountManager.requestActiveCountList([204330,204331],function(param1:Parser_1142):void
         {
            var par:Parser_1142 = param1;
            DayLimitManager.getDoCount(1200,function(param1:int):void
            {
      ...
      public function dispose() : void
      {
         ...
         if(this._tipLink)
         {
            this._tipLink.removeEventListener("rollOver",this.onTipShow);
            this._tipLink.removeEventListener("rollOut",this.onTipHide);
