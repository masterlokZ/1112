package com.taomee.seer2.app.processor.activity.LightTorch
{
   ...
   public class LightTorchManager
   {
      ...
      public function LightTorchManager(param1:MapModel)
      {
         ...
         MovieClipUtil.getSwfContent(URLUtil.getActivityAnimation("lightTorchActivity"),(function():*
         {
            var callBack:Function;
            return callBack = function(param1:MovieClip):void
            {
               var _loc2_:int = 0;
               _loc2_ = int(mapID.indexOf(_mapModel.id));
               ...
               _clickMc.addEventListener("click",onTorchClick);
            };
         })());
         ItemManager.addEventListener1("requestSpecialItemSuccess",(function():*
         {
            var requestSuccess:Function;
            return requestSuccess = function(param1:ItemEvent):void
            {
               ItemManager.removeEventListener1("requestSpecialItemSuccess",requestSuccess);
            };
         })());
      ...
      public function onTorchClick(param1:MouseEvent) : void
      {
         ...
         itemID = 606689;
         DayLimitListManager.getDaylimitList(this.DAY_LIST,(function():*
         {
            var callBack:Function;
            return callBack = function(param1:DayLimitListInfo):void
            {
               ...
               if(cdTime <= 0 && num < 5)
               {
                  SwapManager.swapItem(4350,1,(function():*
                  {
      ...
      {
         if(this._torchMC.hasEventListener("click"))
         {
            this._torchMC.removeEventListener("click",this.onTorchClick);
         }
      }
   }
}
