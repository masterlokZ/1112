package com.taomee.seer2.app.processor.activity.findMoInSnowAct
{
   ...
   public class FindMoInSnowAct
   {
      ...
      private static var _self:FindMoInSnowAct;
      ...
      public static function getInstance() : FindMoInSnowAct
      {
         if(_self == null)
         {
            _self = new FindMoInSnowAct();
         }
         return _self;
      }
      ...
      {
         QueueLoader.load(URLUtil.getActivityAnimation("findMoInSnowAct/FindMoInSnowAct"),"swf",function(param1:ContentInfo):void
         {
      ...
      private function onForward(param1:MouseEvent) : void
      {
         ...
         if(this.forwardFilter())
         {
            ...
            MovieClipUtil.playMc(this._forwardMC,2,this._forwardMC.totalFrames,function():void
            {
               ...
               Connection.send(CommandSet.RANDOM_EVENT_1140,73,0);
            });
         }
      }
         ...
         if(parser.index == 73)
         {
               ...
               MovieClipUtil.playMc(sceneMC,2,sceneMC.totalFrames,function():void
               {
                  ...
                  ModuleManager.showModule(URLUtil.getAppModule("FindMoInSnowEventTwoActPanel"),"正在打开小动物冰冻小游戏面板...",{"func":function(param1:Boolean):void
                  {
                     ...
                     if(isFinish)
                     {
                        ...
                        {
                           SwapManager.swapItem(2217,1,function(param1:IDataInput):void
                           {
                              new SwapInfo(param1);
                              _menu.visible = true;
            ...
            else if(parser.id == 4)
            {
               ...
               MovieClipUtil.playMc(sceneMC,2,sceneMC.totalFrames,function():void
               {
                  DisplayUtil.removeForParent(sceneMC);
                  sceneMC = null;
                  ModuleManager.addEventListener("FindMoInSnowEventFourActPanel","dispose",function(param1:ModuleEvent):void
                  {
                     _menu.visible = true;
                  });
            ...
            else if(parser.id == 6)
            {
               ...
               MovieClipUtil.playMc(sceneMC,2,sceneMC.totalFrames,function():void
               {
                  DisplayUtil.removeForParent(sceneMC);
                  sceneMC = null;
                  ModuleManager.addEventListener("FindMoInSnowEventSixActPanel","dispose",function(param1:ModuleEvent):void
                  {
                     addRandomGift();
                  });
            ...
            else if(parser.id == 7)
            {
               ...
               ActiveCountManager.requestActiveCount(203498,function(param1:uint, param2:uint):void
               {
      ...
      private function onGiftClick(param1:MouseEvent) : void
      {
         ...
         MineManger.getMineItem(269,function(param1:Parser_1060):void
         {
            param1.showResult();
      ...
      private function update(param1:Function = null) : void
      {
         ...
         this._forward.mouseEnabled = false;
         DayLimitManager.getDoCount(901,function(param1:int):void
         {
            var val:int = param1;
            ActiveCountManager.requestActiveCount(203497,function(param1:uint, param2:uint):void
            {
               var _loc3_:int = 0;
               if(param1 == 203497)
               {
