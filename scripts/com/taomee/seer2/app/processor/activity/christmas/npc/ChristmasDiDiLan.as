package com.taomee.seer2.app.processor.activity.christmas.npc
{
   ...
   public class ChristmasDiDiLan implements IChristmasNpc
   {
      ...
      {
         var url:String = URLUtil.getActivityAnimation("9/3");
      ...
      {
         var _loc2_:XML = <npc id="425" resId="425" name="迪迪兰" dir="1" width="25" height="50" pos="331,313"
         ...
         this._npc.addEventListener("click",this.onClick);
      ...
      private function onClick(param1:MouseEvent) : void
      {
         ...
         {
            _npc.removeEventListener("click",onClick);
            var _loc1_:* = URLUtil.getActivityAnimation("9/didilanAnimation");
            QueueLoader.load(_loc1_,"swf",onTakePicLoaded);
         }]);
      }
      ...
      private function processTakePic() : void
      {
         ...
         while(_loc2_ <= 3)
         {
            _loc1_ = this._takePicMC["targetDilan" + _loc2_];
            _loc1_.gotoAndStop(1);
            this._targetPicVec.push(_loc1_);
            _loc3_ = this._takePicMC["dilan" + _loc2_];
            _loc3_.visible = true;
         ...
         this._cameraMouse.addEventListener("enterFrame",this.onCameraMove);
         this._cameraMouse.addEventListener("click",this.onTakePic);
         Mouse.hide();
         this._takePicTimeMC = this._takePicMC["timer"];
         this._takePicTimeMC.addEventListener("enterFrame",this.onTakePicTimeEnd);
      ...
      private function clearTaksPic() : void
      {
         ...
         this._takePicTimeMC.removeEventListener("enterFrame",this.onTakePicTimeEnd);
         this._cameraMouse.removeEventListener("enterFrame",this.onCameraMove);
         this._cameraMouse.removeEventListener("click",this.onTakePic);
      ...
      public function dispose() : void
      {
         ...
         this._npc = null;
         var _loc1_:String = URLUtil.getActivityAnimation("9/TakePicAnimation");
