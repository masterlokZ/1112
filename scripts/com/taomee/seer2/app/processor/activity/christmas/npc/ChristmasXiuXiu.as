package com.taomee.seer2.app.processor.activity.christmas.npc
{
   ...
   public class ChristmasXiuXiu implements IChristmasNpc
   {
      ...
      {
         var url:String = URLUtil.getActivityAnimation("9/4");
      ...
      {
         var _loc2_:XML = <npc id="426" resId="426" name="休咻" dir="1" width="25" height="50" pos="331,313"
      ...
      private function processTakePic() : void
      {
         ...
         this._xiuxiuMC.addEventListener("click",this.onXiuXiu);
      }
      ...
      private function onXiuXiu(param1:MouseEvent) : void
      {
         ...
         {
            this._xiuxiuMC.removeEventListener("click",this.onXiuXiu);
            this._thisMC.addEventListener("xiuxiuComplete",this.onComplete);
      ...
      {
         this._thisMC.removeEventListener("xiuxiuComplete",this.onComplete);
         this.win();
      }
      ...
      public function dispose() : void
      {
         ...
         this._npc = null;
         this._thisMC = null;
         var _loc1_:String = URLUtil.getActivityAnimation("9/xiuxiuAnimation");
