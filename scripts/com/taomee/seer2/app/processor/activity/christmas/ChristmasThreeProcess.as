package com.taomee.seer2.app.processor.activity.christmas
{
   ...
   public class ChristmasThreeProcess
   {
      ...
      public function ChristmasThreeProcess()
      {
         var url:String = null;
         super();
         if(SceneManager.prevSceneType == 2 && isActivityFight)
         {
            isActivityFight = false;
            url = URLUtil.getActivityAnimation("9/0");
      ...
      private function onRandomStatus(param1:MessageEvent) : void
      {
         ...
         this._eventId = _loc3_.readUnsignedInt();
         var _loc4_:uint = uint(_loc3_.readUnsignedInt());
         var _loc2_:uint = uint(_loc3_.readUnsignedInt());
         if(this._eventId != 6 && QuestManager.isFreshQuestComplete() && _loc5_ == 9)
         {
            this.initRes();
         }
      }
      ...
      {
         var _loc1_:String = URLUtil.getActivityAnimation("9/0");
