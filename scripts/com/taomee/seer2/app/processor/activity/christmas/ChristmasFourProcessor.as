package com.taomee.seer2.app.processor.activity.christmas
{
   ...
   public class ChristmasFourProcessor
   {
      ...
      private var _dialogThisVec:Vector.<String> = Vector.<String>(["哇！飞天小麋鹿","没礼物有祝福也不错。","哇！飞天小麋鹿！！","嘿！全家都要健健康康呢！","哇！！！！是哪里呢？","我保证不告诉人家！","……真小气！","光什么呢？"]);
      ...
      private function onRandomStatus(param1:MessageEvent) : void
      {
         ...
         if(_loc5_ == 1 && QuestManager.isFreshQuestComplete())
         {
            this.play();
         }
      }
      ...
      {
         var url:String = URLUtil.getActivityAnimation("9/10");
         ...
         this._resourceLoader.getLib(function(param1:ResourceLibrary):void
         {
            ...
            _mc0.gotoAndPlay(1);
            _mc0.addEventListener("click",onClick);
            _mc0.addEventListener("enterFrame",onEnterFrame);
         });
      }
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         if(this._mc0.currentFrame == this._mc0.totalFrames)
         {
            ...
            this._mc0.removeEventListener("enterFrame",this.onEnterFrame);
         }
      }
      ...
      private function onClick(param1:MouseEvent) : void
      {
         ...
         this._mc0.stop();
         this._mc0.removeEventListener("click",this.onClick);
         this._mc0.removeEventListener("enterFrame",this.onEnterFrame);
         DisplayUtil.removeForParent(this._mc0);
