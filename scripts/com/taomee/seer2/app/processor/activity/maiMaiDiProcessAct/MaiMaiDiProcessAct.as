package com.taomee.seer2.app.processor.activity.maiMaiDiProcessAct
{
   ...
   public class MaiMaiDiProcessAct
   {
      ...
      private function update() : void
      {
         ...
         {
            var val:int = param1;
            ActiveCountManager.requestActiveCountList(FOR_LIST,(function():*
            {
               var getData:Function;
               return getData = function(param1:Parser_1142):void
               {
      ...
      private function catchDispose() : void
      {
         ...
         this.stopMove();
         this.camera.removeEventListener("click",this.reqResult);
      }
      ...
      private function stopMove() : void
      {
         ...
         {
            this._map.content.stage.removeEventListener("mouseMove",this.moveCamera);
         }
      }
      ...
      private function reqResult(param1:MouseEvent) : void
      {
         ...
         this.ghost.stop();
         this.camera.removeEventListener("click",this.reqResult);
         ActiveCountManager.requestActiveCountList([FOR_LIST[2],FOR_LIST[3],FOR_LIST[1]],(function():*
         {
            var getData:Function;
            return getData = function(param1:Parser_1142):void
            {
               ...
               {
                  SwapManager.swapItem(2279,1,function(param1:IDataInput):void
                  {
                     new SwapInfo(param1);
                     update();
                  });
               ...
               else
               {
                  ...
                  Connection.send(CommandSet.RANDOM_EVENT_1140,76,0);
               }
            };
         })());
      }
      ...
      private function initMouse() : void
      {
         if(this._map.content.stage == null)
         {
            ...
            {
               _map.content.stage.addEventListener("mouseMove",moveCamera);
            });
         }
         else
         {
            this._map.content.stage.addEventListener("mouseMove",this.moveCamera);
         }
      }
      ...
      private function addRandomGift(param1:int) : void
      {
         ...
         while(_loc2_ < 6)
         {
            if(_loc2_ < param1)
            {
               ...
               this._giftList[_loc2_].addEventListener("click",this.onGiftClick);
            }
            else
            {
      ...
      private function onGiftClick(param1:MouseEvent) : void
      {
         ...
         SwapManager.swapItem(2280,1,function(param1:IDataInput):void
         {
      ...
      private function getShowNum() : int
      {
         ...
         while(_loc1_ < this._giftList.length)
         {
            if(this._giftList[_loc1_].visible == true)
            {
               _loc2_++;
            }
            _loc1_++;
      ...
      public function dispose() : void
      {
         Tick.instance.removeRender(this.fightStateValidate);
         this.clearGiftList();
         this.leave.removeEventListener("click",this.onLeave);
         this.leave = null;
         this._giftList = null;
         this.catchDispose();
         this.camera = null;
