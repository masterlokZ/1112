   ...
   public class HolyAreaProtectAct
   {
      ...
      private function init() : void
      {
         ...
         while(_loc1_ < 5)
         {
            ...
            this._clickResList[_loc1_].addEventListener("click",this.onClickRes);
            _loc1_++;
         }
         this._npc = MobileManager.getMobile(NPC_ID_LIST[0],"npc");
         this._npc.addEventListener("click",this.onNpc);
         this._npc1 = MobileManager.getMobile(NPC_ID_LIST[1],"npc");
      }
      ...
      private function onClickRes(param1:MouseEvent) : void
      {
         ...
         index = int(this._clickResList.indexOf(evt.currentTarget as MovieClip));
         ...
         DayLimitManager.getDoCount(DAY_LIST[index],function(param1:int):void
         {
            ...
            {
               SwapManager.swapItem(2256,1,function(param1:IDataInput):void
               {
                  new SwapInfo(param1);
                  setClickBtnEnable(true);
      ...
      public function dispose() : void
      {
         ...
         if(this._clickResList)
         {
            ...
            {
               this._clickResList[_loc1_].removeEventListener("click",this.onClickRes);
               _loc1_++;
            }
