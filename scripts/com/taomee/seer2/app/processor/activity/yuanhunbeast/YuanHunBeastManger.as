package com.taomee.seer2.app.processor.activity.yuanhunbeast
{
   ...
   public class YuanHunBeastManger
   {
      ...
      public static function init(param1:MapModel) : void
      {
         ...
         ActiveCountManager.requestActiveCountList(FOR_LIST,function(param1:Parser_1142):void
         {
            ...
            if(par.infoVec[0] > 0 && par.infoVec[1] <= 0)
            {
               ...
               _npc3011 = MobileManager.getMobile(3011,"npc");
               ...
               DayLimitListManager.getDaylimitList(DAY_LIST,function(param1:DayLimitListInfo):void
               {
                  ...
                  npcBoss.addEventListener("click",onFightBoss);
                  if(curWinCount < 4)
                  {
                     ...
                     {
                        npcArr[j].addEventListener("click",onFight);
                        j++;
                     }
                  }
                  else
                  {
                     ...
                     ServerBufferManager.getServerBuffer(377,function(param1:ServerBuffer):void
                     {
                        var _loc2_:Boolean = Boolean(param1.readDataAtPostion(1));
                        if(!_loc2_)
                        {
                           ServerBufferManager.updateServerBuffer(377,1,1);
                           QueueLoader.load(URLUtil.getActivityAnimation("yuanhunshouAct"),"swf",onResLoaded);
                        }
                     });
                  }
               });
      ...
      {
         var _loc2_:int = int(npcArr.indexOf(param1.currentTarget as Mobile));
      ...
      private static function createNpc(param1:int, param2:String, param3:Point, param4:Number) : Mobile
      {
         ...
         _loc5_ = new Mobile();
         _loc5_.setPostion(new Point(param3.x,param3.y));
      ...
      public static function dispose() : void
      {
         ...
         if(npcArr != null)
         {
            ...
            {
               MobileManager.removeMobile(npcArr[_loc1_],"npc");
               _loc1_++;
            }
         }
         if(npcBoss)
         {
            MobileManager.removeMobile(npcBoss,"npc");
            npcBoss = null;
         }
      }
   }
