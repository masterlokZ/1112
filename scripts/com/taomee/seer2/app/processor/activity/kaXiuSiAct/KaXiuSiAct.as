package com.taomee.seer2.app.processor.activity.kaXiuSiAct
{
   ...
   public class KaXiuSiAct
   {
      ...
      {
         QueueLoader.load(URLUtil.getActivityAnimation("kaXiuSiAct/KaXiuSiAct"),"swf",function(param1:ContentInfo):void
         {
      ...
      private function onForward(param1:MouseEvent) : void
      {
         ...
         if(this.forwardFilter())
         {
            ...
            MovieClipUtil.playMc(this._forwardMC,2,this._forwardMC.totalFrames,function():void
            {
               ...
               Connection.send(CommandSet.RANDOM_EVENT_1140,57,0);
            });
         }
      }
      ...
      private function onEventTest(param1:int) : void
      {
         ...
         {
            ModuleManager.addEventListener("KaXiuSiEventTwoActPanel","dispose",function(param1:ModuleEvent):void
            {
               addRandomGift();
            });
         ...
         {
            ModuleManager.addEventListener("KaXiuSiEventFourActPanel","dispose",this.onEventFourHide);
      ...
      {
         ModuleManager.removeEventListener("KaXiuSiEventFourActPanel","dispose",this.onEventFourHide);
         this.update();
      }
      ...
      private function onEventStart(param1:MessageEvent) : void
      {
         ...
         if(parser.index == 57)
         {
            ...
            {
               ModuleManager.addEventListener("KaXiuSiEventTwoActPanel","dispose",(function():*
               {
                  var onTwoClose:Function;
                  return onTwoClose = function(param1:ModuleEvent):void
                  {
                     ModuleManager.removeEventListener("KaXiuSiEventTwoActPanel","dispose",onTwoClose);
                     addRandomGift();
                  };
               })());
               ModuleManager.showModule(URLUtil.getAppModule("KaXiuSiEventTwoActPanel"),"正在打开遇到悬浮物提示面板...");
            ...
            {
               ModuleManager.addEventListener("KaXiuSiEventThreeActPanel","dispose",(function():*
               {
                  var onThreeClose:Function;
                  return onThreeClose = function(param1:ModuleEvent):void
                  {
                     ModuleManager.removeEventListener("KaXiuSiEventThreeActPanel","dispose",onThreeClose);
                     update();
                  };
               })());
               ModuleManager.showModule(URLUtil.getAppModule("KaXiuSiEventThreeActPanel"),"正在打开获得卡牌面板...",{
            ...
            {
               ModuleManager.addEventListener("KaXiuSiEventFourActPanel","dispose",(function():*
               {
                  var onFourClose:Function;
                  return onFourClose = function(param1:ModuleEvent):void
                  {
                     ModuleManager.removeEventListener("KaXiuSiEventFourActPanel","dispose",onFourClose);
                     update();
                  };
               })());
               ModuleManager.showModule(URLUtil.getAppModule("KaXiuSiEventFourActPanel"),"正在打开天上掉馅饼面板...");
      ...
      private function onGiftClick(param1:MouseEvent) : void
      {
         ...
         SwapManager.swapItem(1783,1,function(param1:IDataInput):void
         {
            new SwapInfo(param1);
      ...
      private function update(param1:Function = null) : void
      {
         ...
         this._forward.mouseEnabled = false;
         ActiveCountManager.requestActiveCount(203131,function(param1:int, param2:int):void
         {
            var num1:int = 0;
            var type:int = param1;
            var val:int = param2;
            num1 = val;
            DayLimitManager.getDoCount(800,function(param1:int):void
            {
               var _loc2_:int = 0;
