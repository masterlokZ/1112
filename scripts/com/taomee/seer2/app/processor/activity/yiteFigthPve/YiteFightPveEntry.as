package com.taomee.seer2.app.processor.activity.yiteFigthPve
{
   ...
   public class YiteFightPveEntry
   {
      ...
      private function initYite() : void
      {
         ...
         while(_loc1_ < 4)
         {
            this._yiteList.push(MobileManager.getMobile(this.npcIdList[_loc1_],"npc"));
            this._yiteList[_loc1_].buttonMode = true;
            this._yiteList[_loc1_].addEventListener("click",this.onYite,false,1);
            _loc1_++;
         }
      }
      ...
      private function onYite(param1:MouseEvent) : void
      {
         ...
         var _loc2_:int = int(this._yiteList.indexOf(param1.currentTarget as Mobile));
         var _loc3_:Object = {};
         _loc3_.index = _loc2_;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_.removeEventListener("click",this.onYite);
         }
      }
   }
}
