package com.taomee.seer2.app.processor.activity.mascot
{
   ...
   public class MascotActor extends Sprite
   {
      ...
      private var _teamInfo:MascotTeamInfo;
      ...
      private var forLimit:Array = [204720];
      
      private var playerBelong:int;
      
      private var idList:Array = [2,3,4];
      
      public function MascotActor()
      {
         super();
         this._teamInfo = new MascotTeamInfo();
      }
      ...
      public function setActor(param1:MovieClip, param2:MapModel) : void
      {
         ...
         ActiveCountManager.requestActiveCountList(this.forLimit,function(param1:Parser_1142):void
         {
            ...
            _actor.addEventListener("click",onOpenActivityPanel);
      ...
      private function updateActor(param1:MapModel) : void
      {
         ...
         ShootController.addEventListener("serverLeftPlayStart",this.onServerStart);
      ...
      private function showComplete(param1:MovieClip, param2:MapModel) : void
      {
         ...
         this._completeGift.addEventListener("click",this.onGift);
         this._completeGift2.addEventListener("click",this.onGift2);
      ...
      private function onGetTeamStatus(param1:MessageEvent) : void
      {
         ...
         switch(this._teamInfo.mapId)
         {
            case 40:
               this._teamInfo.id = 1;
               this._teamInfo.blood = _loc8_;
               this._teamInfo.status = _loc7_;
               break;
            case 30:
               this._teamInfo.id = 2;
               this._teamInfo.blood = _loc3_;
               this._teamInfo.status = _loc2_;
               break;
            case 81:
               this._teamInfo.id = 3;
      ...
      public function setThisActor(param1:MascotActor) : void
      {
         this._thisActor = param1;
      }
      
      public function get info() : MascotTeamInfo
      {
      ...
      {
         this.removeMC();
         ShootController.removeEventListener("serverLeftPlayStart",this.onServerStart);
