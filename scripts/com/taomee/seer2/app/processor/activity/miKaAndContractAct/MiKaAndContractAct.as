package com.taomee.seer2.app.processor.activity.miKaAndContractAct
{
   ...
   public class MiKaAndContractAct
   {
      ...
      {
         QueueLoader.load(URLUtil.getActivityAnimation("MiKaAndContractAct"),"swf",function(param1:ContentInfo):void
         {
      ...
      private static function init() : void
      {
         ...
         if(isNewStart)
         {
            ...
            MovieClipUtil.playMc(_scene0,2,_scene0.totalFrames,function():void
            {
               ...
               _scene0.addEventListener("click",onScene0Click);
            });
         }
         else
         {
      ...
      private static function onScene0Click(param1:MouseEvent) : void
      {
         ...
         _scene0.removeEventListener("click",onScene0Click);
         ...
         ActiveCountManager.requestActiveCountList(FOR_LIST,function(param1:Parser_1142):void
         {
            ...
            else
            {
               ...
               while(_loc3_ < param1.infoVec[1])
               {
                  ...
                  _loc2_.addEventListener("click",onPieceClick);
                  _loc3_++;
               }
            }
         });
      ...
      private static function onPieceClick(param1:MouseEvent) : void
      {
         var index:int = 0;
         var evt:MouseEvent = param1;
         index = int(_pieceList.indexOf(evt.currentTarget as MovieClip));
         setPieceMouseEnable(false);
         SwapManager.swapItem(3875,1,function(param1:IDataInput):void
         {
      ...
      private static function disposePiece() : void
      {
         ...
         if(_pieceList)
         {
            ...
            {
               _pieceList[_loc1_].removeEventListener("click",onPieceClick);
