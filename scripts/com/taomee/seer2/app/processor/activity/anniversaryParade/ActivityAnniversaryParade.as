package com.taomee.seer2.app.processor.activity.anniversaryParade
{
   ...
   public class ActivityAnniversaryParade
   {
      ...
      private static var _instance:ActivityAnniversaryParade;
      
      public const config:Array = [["克拉克教官",6,60],["菲鲁",4,50],["娜维拉",7,30],["伊娃博士",2,20],["乔休尔",5,40],["辛迪船长",1,10]];
      
      private var questions0:Array = [["今年是约瑟传说多少周岁生日？",["5周岁","3周岁","1周岁"],1],["令精灵王约瑟重生的关键是什么？",["17种王魄","\'希望之光\'","打败奎尔斯"],2],["在萨伦帝国与北半球联盟长久的战争与对峙中，暗影氏族的立场是什么？",["与萨伦帝国合作","支持北半球联盟","中立"],3]];
      
      private var questions1:Array = [["以下哪个地图存在绿色矿脉",["异蘑世界","异蘑谷","悲伤残骸"],3],["在地图【深幽沼泽】中可以收集到以下哪种道具？",["黄铁矿","\'夜明珠\'","藤蔓花子"],1],["《赛尔计划》建造深空探索机器人及远航星舰的根本目标是？",["捕获、进化更多精灵，构筑正义的精灵战队、打击宇宙邪恶势力","寻找传说中的“无尽能源”挽救资源枯竭的地球","寻找地球文明能够移居的新星球"],2]];
      ...
      public static function get instance() : ActivityAnniversaryParade
      {
         if(_instance == null)
         {
            _instance = new ActivityAnniversaryParade();
         }
         return _instance;
      }
      ...
      private function onCustomUnitClick(param1:DialogPanelEvent) : void
      {
         ...
         DayLimitListManager.getDaylimitList([1932],(function():*
         {
      ...
      private function processNpc0() : void
      {
         ...
         NpcDialog.showDialogs(dialogs,function():void
         {
            ...
            SceneManager.addEventListener("switchComplete",(function():*
            {
               ...
               return complete = function(param1:SceneEvent):void
               {
                  var e:SceneEvent = param1;
                  if(SceneManager.prevSceneType == 2)
                  {
                     SceneManager.removeEventListener("switchComplete",complete);
      ...
      private function finishStep(param1:int, param2:Function) : void
      {
         ...
         SwapManager.swapItem(4534,1,(function():*
         {
