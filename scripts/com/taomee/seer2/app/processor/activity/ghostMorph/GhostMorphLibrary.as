package com.taomee.seer2.app.processor.activity.ghostMorph
{
   ...
   public class GhostMorphLibrary
   {
      ...
      {
         if(DateUtil.inInDateScope(6,13,0,15,1) || DateUtil.inInDateScope(5,13,0,15,1) || DateUtil.inInDateScope(0,13,0,15,1))
         {
            return true;
         }
         return false;
      ...
      {
         var _loc1_:uint = uint(new Date(2012,9,27,13).getTime());
