package com.taomee.seer2.app.processor.quest
{
   ...
   public class QuestProcessor_10043 extends QuestProcessor
   {
      ...
      private function processStep1() : void
      {
         ...
         else if(SceneManager.active.mapID == 122 && SceneManager.prevSceneType == 2)
         {
            if(PetInfoManager.getFirstPetInfo().resourceId == 45 && FightManager.currentFightRecord && FightManager.currentFightRecord.initData && FightManager.currentFightRecord.initData.positionIndex && FightManager.currentFightRecord.initData.positionIndex < 10 && FightManager.fightWinnerSide == 1)
            {
      ...
      {
         StatisticsManager.sendStatisticsByUrl("http://misc.taomee.com/seer2/seer2.php?type=lose_weight_plan_" + param1.toString() + "&mm=" + ActorManager.actorInfo.id);
      }
      ...
      private function processStep2() : void
      {
         ...
         {
            QuestManager.addEventListener("stepComplete",this.onCompleteStep2);
            QuestManager.completeStep(_quest.id,2);
         }
         else if(SceneManager.prevSceneType == 2 && MAP_ID_2.indexOf(SceneManager.active.mapResourceID) != -1)
         {
            index = int(MAP_ID_2.indexOf(SceneManager.active.mapResourceID));
            if(FightManager.currentFightRecord && FightManager.currentFightRecord.initData && FightManager.currentFightRecord.initData.positionIndex && FightManager.currentFightRecord.initData.positionIndex < 10 && FightManager.fightWinnerSide == 1)
            {
               ...
               if(!(count & FLAG_2[index]))
               {
                  ...
                  if(_quest.getStepData(2,0) >= 15)
                  {
                     ...
                     {
                        QuestManager.addEventListener("stepComplete",onCompleteStep2);
                        QuestManager.completeStep(_quest.id,2);
                     });
                  }
                  else
      ...
      private function onCompleteStep2(param1:QuestEvent) : void
      {
         ...
         {
            QuestManager.removeEventListener("stepComplete",this.onCompleteStep2);
      ...
      private function processStep3() : void
      {
         ...
         {
            QuestManager.addEventListener("stepComplete",this.onCompleteStep3);
            QuestManager.completeStep(_quest.id,3);
         }
         else if(SceneManager.prevSceneType == 2 && MAP_ID_3.indexOf(SceneManager.active.mapResourceID) != -1)
         {
            if(FightManager.fightWinnerSide == 1)
            {
               index = int(MAP_ID_3.indexOf(SceneManager.active.mapResourceID));
               if(SceneManager.active.mapResourceID == 510 && FightManager.currentFightRecord && FightManager.currentFightRecord.initData && Boolean(FightManager.currentFightRecord.initData.positionIndex) && FightManager.currentFightRecord.initData.positionIndex < 10)
               {
                  ...
                  if(count + 1 >= 5)
                  {
                     ...
                     if(_quest.getStepData(3,0) >= 7)
                     {
                        ...
                        {
                           QuestManager.addEventListener("stepComplete",onCompleteStep3);
                           QuestManager.completeStep(_quest.id,3);
                        });
                     }
                     else
      ...
      private function onCompleteStep3(param1:QuestEvent) : void
      {
         ...
         {
            QuestManager.removeEventListener("stepComplete",this.onCompleteStep3);
      ...
      private function processStep4() : void
      {
         if(SceneManager.active.mapID == 122)
         {
            ...
            else if(PetInfoManager.getFirstPetInfo().resourceId == 45 && SceneManager.prevSceneType == 2 && FightManager.currentFightRecord && FightManager.currentFightRecord.initData && FightManager.currentFightRecord.initData.positionIndex && FightManager.currentFightRecord.initData.positionIndex == 48 && FightManager.fightWinnerSide == 1)
            {
            ...
            {
               this._npc.addEventListener("click",this.onNpcClickStep4,false,1);
            }
         }
      }
      ...
      private function onNpcClickStep4(param1:MouseEvent) : void
      {
         ...
         if(PetInfoManager.getFirstPetInfo().resourceId != 45)
         {
         ...
         else
         {
            ...
            FightManager.startFightWithWild(48,null,null,_loc2_);
         }
      }
      ...
      private function processAccept() : void
      {
         ...
         if(PetInfoManager.getFirstPetInfo().resourceId != 45 || followPetInfo == null || followPetInfo.resourceId != 45)
         {
         ...
         else
         {
            ...
            {
               QuestManager.addEventListener("accept",onQuestAccepted);
      ...
      private function onMapComplete(param1:SceneEvent) : void
      {
         if(SceneManager.active)
         {
            ...
            {
               this.createNpc();
               DialogPanel.addEventListener("questUnitClick",this.onOpenQuestModule);
            }
      ...
      {
         this.clearLayout();
         DialogPanel.removeEventListener("questUnitClick",this.onOpenQuestModule);
      }
      ...
      private function clearLayout() : void
      {
         if(this._npc)
         {
            this._npc.removeEventListener("click",this.onNpcClickStep4);
