   ...
   public class QuestProcessor_42 extends QuestProcessor
   {
      ...
      private function onMapComplete(param1:SceneEvent) : void
      {
         if(QuestManager.isAccepted(42) && QuestManager.isStepComplete(42,1) == false && this.gotoMapList.indexOf(SceneManager.active.mapID) != -1)
         {
            ...
            ServerBufferManager.getServerBuffer(12,this.getServer,false);
         }
      }
      
      private function getServer(param1:ServerBuffer) : void
      {
         var _loc2_:uint = uint(this.gotoMapList.indexOf(SceneManager.active.mapID));
      ...
      private function setNpc(param1:uint) : void
      {
         ...
         this._currNpc = MobileManager.getMobile(param1,"npc");
         if(this._currNpc)
         {
      ...
      private function onDialogShow(param1:DialogPanelEvent) : void
      {
         ...
         if(param1.content == this.npcIdList[_loc2_])
         {
            ...
            _loc3_.addEventListener("customUnitClick",this.onUnitClick);
      ...
      private function onUnitClick(param1:FunctionalityBoxEvent) : void
      {
         ...
         if(_quest.id == param1.content)
         {
            ...
            DialogPanel.functionalityBox.removeEventListener("customUnitClick",this.onUnitClick);
            if(this._currNpc)
            {
               this._currNpc.removeOverHeadMark();
            }
            _loc2_ = uint(this.gotoMapList.indexOf(SceneManager.active.mapID));
      ...
      {
         var _loc1_:XML = null;
         var _loc2_:uint = uint(this.mapNpcIdList.indexOf(SceneManager.active.mapID));
         if(_loc2_ == -1)
         {
            return;
         }
         ...
         {
            case 0:
               _loc1_ = <npc id="55" resId="55" name="" dir="0" width="25" height="90" pos="241,476" actorPos="439,433"
                              path="">
               ...
               break;
            case 1:
               _loc1_ = <npc id="56" resId="56" name="" dir="0" width="25" height="90" pos="647,343" actorPos="647,333"
                              path="">
               ...
               break;
            case 2:
               _loc1_ = <npc id="49" resId="49" name="" dir="0" width="25" height="90" pos="758,324" actorPos="758,314"
                              path="">
               ...
               break;
            case 3:
               _loc1_ = <npc id="107" resId="107" name="" dir="0" width="25" height="90" pos="515,313"
                              actorPos="635,293" path="">
         ...
         this._npc.addEventListener("click",this.onShowNpc);
      }
