package com.taomee.seer2.app.processor.quest.handler.activity.quest30050
{
   ...
   public class QuestMapHandler_30050_141 extends QuestMapHandler
   {
      ...
      private function openNpc() : void
      {
         ...
         this._npc3.addEventListener("click",this.onNpc);
      }
      ...
      private function onNpc(param1:MouseEvent) : void
      {
         ...
         this._npc3.removeEventListener("click",this.onNpc);
         NpcDialog.show(626,"晨璨",[[0,"小胖子，怎么样？和我一起做游戏好玩吗？~"]],["哈哈哈哈~"],[function():void
         {
            ...
            {
               _map.content["ligthFlowerLeft"].addEventListener("click",onLight);
      ...
      {
         _map.content["ligthFlowerLeft"].removeEventListener("click",this.onLight);
         this.showGame();
      }
      ...
      private function showGame() : void
      {
         ...
         this._mouseMC.addEventListener("click",this.onMouse);
      }
      ...
      {
         this._mouseMC.removeEventListener("click",this.onMouse);
         this._mouseMC.addEventListener("click",this.onHit);
         this._gameMC.addEventListener("mouseMove",this.onMove);
         this.openIndex(1);
         Mouse.hide();
      }
      ...
      {
         this._gameMC.removeEventListener("mouseMove",this.onMove);
         Mouse.show();
      ...
      private function showAlert() : void
      {
         ...
         while(_loc1_ < 2)
         {
            ...
            this._switchList[_loc1_].addEventListener("click",this.onSwitch);
            _loc1_++;
         }
      }
      ...
      private function onSwitch(param1:MouseEvent) : void
      {
         ...
         var event:MouseEvent = param1;
         index = int(this._switchList.indexOf(event.currentTarget as MovieClip));
         this._switchList[index].gotoAndStop(2);
         for each(sw in this._switchList)
         {
            sw.removeEventListener("click",this.onSwitch);
         }
