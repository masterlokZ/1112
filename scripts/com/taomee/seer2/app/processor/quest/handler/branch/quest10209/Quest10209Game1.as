package com.taomee.seer2.app.processor.quest.handler.branch.quest10209
{
   ...
   public class Quest10209Game1
   {
      ...
      public function Quest10209Game1(param1:MovieClip, param2:Function)
      {
         ...
         this._helpBtn.addEventListener("click",this.onHelp);
         ...
         while(_loc3_ < 2)
         {
            ...
            this._point1List[_loc3_].addEventListener("click",this.onPoint);
            this._point2List[_loc3_].addEventListener("click",this.onPoint);
            _loc3_++;
         }
      }
      ...
      private function onPoint(param1:MouseEvent) : void
      {
         ...
         var index:int = int(this._point1List.indexOf(event.currentTarget as MovieClip));
         if(index == -1)
         {
            index = int(this._point2List.indexOf(event.currentTarget as MovieClip));
         }
         this._point1List[index].removeEventListener("click",this.onPoint);
         this._point2List[index].removeEventListener("click",this.onPoint);
      ...
      {
         this._helpBtn.removeEventListener("click",this.onHelp);
         this._closeBtn.removeEventListener("click",this.onClose);
         this._point1List[0].removeEventListener("click",this.onPoint);
         this._point2List[0].removeEventListener("click",this.onPoint);
         this._point1List[1].removeEventListener("click",this.onPoint);
         this._point2List[1].removeEventListener("click",this.onPoint);
