   ...
   public class Panel42
   {
      ...
      private function initEvent() : void
      {
         ...
         for each(_loc1_ in this._npcMCList)
         {
            ...
            {
               _loc1_["goBtn"].addEventListener("click",this.onGoto);
            }
         }
      }
      ...
      {
         var _loc2_:uint = uint(this._npcMCList.indexOf(param1.currentTarget.parent as MovieClip));
         SceneManager.changeScene(1,this.gotoMapList[_loc2_]);
         this.dispose();
      }
      ...
      private function showPanel() : void
      {
         ...
         DisplayUtil.align(this._panel,4);
      }
      ...
      private function removeEvent() : void
      {
         ...
         for each(_loc1_ in this._npcMCList)
         {
            if(_loc1_.currentFrame == 1)
            {
               _loc1_["goBtn"].removeEventListener("click",this.onGoto);
            }
         }
      }
