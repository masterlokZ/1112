package com.taomee.seer2.app.processor.quest.handler.activity.quest30030
{
   ...
   public class QuestMapHandler_30030_10 extends QuestMapHandler
   {
         ...
         if((event.content as DialogPanelEventData).params == "10122_0")
         {
            ...
            MovieClipUtil.playFullScreen(URLUtil.getQuestFullScreenAnimation("30030_0"),function():void
            {
               ...
               NpcDialog.show(1,"辛迪船长",[[0,"&%￥@…$#%居然是……贾斯汀这个老伙计来的信！快一起看看他写了什么？"]],["好呀好呀！我也要看！"],[function():void
               {
                  ...
                  _loc1_.addEventListener("click",onCloseLetterHandler);
               }]);
            },true,false,2);
         }
      }
      ...
      private function initNpc() : void
      {
         ...
         this._npc_1.addEventListener("click",this.onNpcTalkHandler);
      }
      ...
      private function initPanel() : void
      {
         ...
         _loc7_ = this._panel["npc"] as MovieClip;
         this._panel_npc_normal = _loc7_["normal"] as MovieClip;
         this._panel_npc_angry = _loc7_["angry"] as MovieClip;
         this._panel_npc_happy = _loc7_["happy"] as MovieClip;
         this._panel_Btn = this._panel["joinBtn"] as SimpleButton;
         _loc9_ = this._panel["btn1"] as SimpleButton;
         _loc8_ = this._panel["btn2"] as SimpleButton;
         _loc3_ = this._panel["btn3"] as SimpleButton;
         _loc2_ = this._panel["btn4"] as SimpleButton;
         _loc5_ = this._panel["btn5"] as SimpleButton;
         _loc4_ = this._panel["btn6"] as SimpleButton;
         _loc1_ = this._panel["closeBtn"] as SimpleButton;
         ...
         _loc9_.addEventListener("click",this.onWrongHandler);
         _loc8_.addEventListener("click",this.onWrongHandler);
         _loc3_.addEventListener("click",this.onWrongHandler);
         _loc2_.addEventListener("click",this.onWrongHandler);
         _loc5_.addEventListener("click",this.onWrongHandler);
         _loc4_.addEventListener("click",this.onRightHandler);
         _loc1_.addEventListener("click",this.onCloseHandler);
      }
      ...
      private function onRightHandler(param1:MouseEvent) : void
      {
         ...
         MovieClipUtil.playMc(this._panel_npc_happy,1,this._panel_npc_happy.totalFrames,function():void
         {
            ...
            _panel_Btn.addEventListener("click",onJoinHandler);
         });
      }
      ...
      {
         this._npc_1.removeEventListener("click",this.onNpcTalkHandler);
      ...
      private function initNpcAgain() : void
      {
         ...
         _map.content.addChild(this._npc_1);
         this._npc_1.buttonMode = true;
         this._npc_1.addEventListener("click",this.onNpcTalkAgainHandler);
      }
         ...
         NpcDialog.show(515,"邮差",[[4,"啊哈！这是我目前看到的最帅的邮票了！即使把它送给我我也不会高兴的！哈哈哈！哈哈！"]],["这可是我最珍惜的收藏了，那我请你帮的忙"],[function():void
         {
            NpcDialog.show(515,"邮差",[[4,"哈哈！本帅就答应你啦！你有多少邮票，我就帮你送多少次信！送多少次都可以！哈哈！"]],["好吧，那你要把信安全交给我的偶像贾斯汀站长哦！"],[function():void
            {
               NpcDialog.show(515,"邮差",[[0,"你就放心吧！我一直都是全宇宙最靠谱儿的超时空邮差！把信给我吧，我这就给你送去！"]],["那好！就拜托你啦！"],[function():void
               {
                  ...
                  {
                     QuestManager.addEventListener("complete",onStep2CompleteHandler);
      ...
      private function onStep2CompleteHandler(param1:QuestEvent) : void
      {
         ...
         QuestManager.removeEventListener("complete",this.onStepCompleteHandler);
      }
