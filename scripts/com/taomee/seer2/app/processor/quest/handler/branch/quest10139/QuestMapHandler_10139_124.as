package com.taomee.seer2.app.processor.quest.handler.branch.quest10139
{
   ...
   public class QuestMapHandler_10139_124 extends QuestMapHandler
   {
      ...
      private function addBird(param1:int) : void
      {
         ...
         if(param1 == 0)
         {
            this._mc_0.addEventListener("click",this.onClickBirdHandler);
         }
         else
         {
            this._mc_0.addEventListener("click",this.onClickBirdAgainHandler);
         }
      }
      ...
      private function gameOver() : void
      {
         ...
         NpcDialog.show(526,"孔雀",[[0,"真是美丽的花环啊，看来族人们是真心不再战争了，我愿意再次为他们祈福，送吉祥。"]],["孔雀，你愿意开屏了吗？"],[function():void
         {
            ...
            MovieClipUtil.playMc(_mc_0,1,_mc_0.totalFrames,function():void
            {
               ...
               {
                  QuestManager.addEventListener("complete",onStep9Handler);
      ...
      {
         QuestManager.removeEventListener("complete",this.onStep9Handler);
      ...
      override public function processMapDispose() : void
      {
         ...
         QuestManager.removeEventListener("accept",this.onAcceptHandler);
         QuestManager.removeEventListener("stepComplete",this.onStep9Handler);
      }
   }
}
