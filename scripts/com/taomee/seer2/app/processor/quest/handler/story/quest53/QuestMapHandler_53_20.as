package com.taomee.seer2.app.processor.quest.handler.story.quest53
{
   ...
   public class QuestMapHandler_53_20 extends QuestMapHandler
   {
      ...
      private function init() : void
      {
         ...
         this._npc2 = MobileManager.getMobile(2,"npc");
         DialogPanel.addEventListener("dialogShow",this.onDialogShow);
         DialogPanel.addEventListener("questUnitClick",this.onUnitClick);
         DialogPanel.addEventListener("customReplyClick",this.onCustomReplyClick);
         ModuleManager.addEventListener("BusinessPanel","open",this.hideGudie);
         ModuleManager.addEventListener("BusinessPanel","setup",this.onShowBusiness);
         ModuleManager.addEventListener("BusinessPanel","dispose",this.onDisposeBusiness);
      ...
      private function onComplete(param1:QuestEvent) : void
      {
         ...
         if(e.questId == 53)
         {
            NpcDialog.show(2,"伊娃博士",[[0,"真是好样的！道具买了，新精灵也获得了，接下来会由<font color=\'#ff0000\'>NONO</font>来指引你旅程哦！"]],["OK。"],[function():void
            {
               ...
               ModuleManager.addEventListener("FightResultPanel","hide",onFightHide);
            }]);
            StatisticsManager.sendNovice("0x1003323E");
         }
      }
      
      private function onFightHide(param1:ModuleEvent) : void
      {
         ModuleManager.removeEventListener("FightResultPanel","hide",this.onFightHide);
      ...
      private function onShowBusiness(param1:ModuleEvent) : void
      {
         ...
         if(QuestManager.isAccepted(53) && QuestManager.isStepComplete(53,1) == true && QuestManager.isStepComplete(53,2) == true && QuestManager.isStepComplete(53,3) == false)
         {
            ...
            GuideManager.instance.addGuide2Target(_loc2_,0,12,new Point(467,195),false,false,9);
      ...
      private function onDisposeBusiness(param1:ModuleEvent) : void
      {
         ...
         if(QuestManager.isAccepted(_quest.id) && QuestManager.isStepComplete(_quest.id,1) == true && QuestManager.isStepComplete(_quest.id,2) == true && QuestManager.isStepComplete(_quest.id,3) == false)
         {
            ...
            {
               QuestManager.addEventListener("stepComplete",StepHandler);
      ...
      private function onDialogShow(param1:DialogPanelEvent) : void
      {
         ...
         if(param1.content == 2 && QuestManager.isAccepted(_quest.id))
         {
            ...
            GuideManager.instance.addGuide2Target(_loc2_,0,9,new Point(284,480),false,false,9);
      ...
      private function onUnitClick(param1:DialogPanelEvent) : void
      {
         ...
         if(param1.content.questId == 53 && param1.content.stepId == 3)
         {
            ...
            GuideManager.instance.addGuide2Target(_loc2_,0,10,new Point(628,519),false,false,9);
            GuideManager.instance.pause();
         }
      }
      ...
      private function onCustomReplyClick(param1:DialogPanelEvent) : void
      {
         ...
         if((param1.content as DialogPanelEventData).params == "53_2")
         {
            ...
            GuideManager.instance.addGuide2Target(_loc2_,0,11,new Point(302,95),false,false,9);
      ...
      private function StepHandler(param1:QuestEvent) : void
      {
         ...
         {
            this.buyItems();
            StatisticsManager.sendNovice("0x1003323B");
         }
         else if(param1.questId == _quest.id && param1.stepId == 3)
         {
            this.fightPetGudie();
            StatisticsManager.sendNovice("0x1003323C");
         }
      ...
      private function recoverPetGudie() : void
      {
         NpcDialog.show(2,"伊娃博士",[[0,"真厉害！不过刚刚的战斗消耗了精灵大量的<font color=\'#ff0000\'>体力</font>，当<font color=\'#ff0000\'>体力为0</font>时就不能继续战斗咯，赶紧使用精灵</font>，当<font color=\'#ff0000\'>恢复按钮</font>帮助精灵恢复体力吧。"]],["我知道了，这就去补充。"],[function():void
         {
            ...
            GuideManager.instance.addGuide2Target(_loc1_,0,1,new Point(184,87),false,false,9);
      ...
      private function createPet() : void
      {
         ...
         MovieClipUtil.playMc(this._mc_0,1,this._mc_0.totalFrames,function():void
         {
            ...
            _mc_0.addEventListener("frameConstructed",onFrameConstructed);
            addGudie();
         });
      }
      ...
      {
         this._mc_0.removeEventListener("frameConstructed",this.onFrameConstructed);
         (this._mc_0["pet"] as MovieClip).buttonMode = true;
         (this._mc_0["pet"] as MovieClip).mouseEnabled = true;
         (this._mc_0["pet"] as MovieClip).addEventListener("click",this.onNPC);
      }
      ...
      private function addGudie() : void
      {
         ...
         GuideManager.instance.addGuide2Target(_loc1_,0,17,new Point(420,241),false,false,9);
      ...
      private function onNPC(param1:MouseEvent) : void
      {
         ...
         this._mc_0.removeEventListener("click",this.onNPC);
      ...
      private function buyItems() : void
      {
         ...
         GuideManager.instance.addGuide2Target(this._npc2,0,8,new Point(209,106),false,false,9);
      ...
      override public function processMapDispose() : void
      {
         ...
         DialogPanel.removeEventListener("customReplyClick",this.onCustomReplyClick);
         ModuleManager.removeEventListener("BusinessPanel","open",this.hideGudie);
         ModuleManager.removeEventListener("BusinessPanel","setup",this.onShowBusiness);
