   ...
   public class QuestMap_10211_80077_game extends Sprite
   {
      ...
      private function init() : void
      {
         ...
         while(_loc1_ < 3)
         {
            ...
            this.btnList[_loc1_].addEventListener("click",this.onClick);
            _loc1_++;
         }
      ...
      private function onClick(param1:MouseEvent) : void
      {
         ...
         var index:int = int(this.btnList.indexOf(e.currentTarget as SimpleButton));
         if(index == 1)
         {
            this.lightMc.visible = true;
            this.btnList[1].visible = false;
      ...
      private function dispose() : void
      {
         ...
         while(_loc1_ < 3)
         {
            this.btnList[_loc1_].removeEventListener("click",this.onClick);
            _loc1_++;
         }
