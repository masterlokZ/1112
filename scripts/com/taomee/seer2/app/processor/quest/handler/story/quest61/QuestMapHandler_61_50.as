package com.taomee.seer2.app.processor.quest.handler.story.quest61
{
   ...
   public class QuestMapHandler_61_50 extends QuestMapHandler
   {
      ...
      public function QuestMapHandler_61_50(param1:QuestProcessor)
      {
         super(param1);
      }
      ...
      override public function processMapComplete() : void
      {
         ...
         {
            _flag = param1.readDataAtPostion(3);
      ...
      {
         this._mc_0 = _processor.resLib.getMovieClip("ma2");
      ...
      private function addTalk() : void
      {
         ...
         {
            ServerBufferManager.updateServerBuffer(23,3,1);
            ergodicServerBuffer();
         },true);
      }
