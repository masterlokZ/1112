package com.taomee.seer2.app.processor.quest.handler.main.quest76
{
   ...
   public class QuestMapHandler_76_80326 extends QuestMapHandler
   {
      ...
      private var lightList:Vector.<MovieClip> = Vector.<MovieClip>([]);
      ...
      private function onComplete(param1:QuestEvent) : void
      {
         ...
         QuestManager.removeEventListener("complete",this.onComplete);
         SceneManager.changeScene(1,80378);
      }
      ...
      private function createNpc() : void
      {
         if(!this._npc)
         {
            ...
            this.mark.y = -120;
            this._npc.addEventListener("click",this.onMark);
      ...
      private function onMark(param1:MouseEvent) : void
      {
         ...
         NpcDialog.show(694,"黑武士",[[0,"该死的，这里怎么什么都没有？超能氏族密道在哪里？"]],["你在干什么！"],[function():void
         {
            NpcDialog.show(10,"巴蒂",[[0,"他在搞破坏！快制止他！"]],["住手！"],[function():void
            {
               ...
               {
                  FightManager.startFightWithWild(1274);
                  ++fightNums;
      ...
      private function createNpc1() : void
      {
         if(!this._npc1)
         {
            ...
            MobileManager.addMobile(this._npc1,"npc");
            this.mark = new AcceptableMark();
            this.mark.y = -70;
            this._npc1.addEventListener("click",this.onMark1);
      ...
      private function onMark1(param1:MouseEvent) : void
      {
         ...
         while(i < 3)
         {
            ...
            this.lightList[i].addEventListener("click",this.onLight);
            i++;
         }
      ...
      override public function processMapDispose() : void
      {
         ...
         MobileManager.removeMobile(this._npc1,"npc");
