package com.taomee.seer2.app.processor.quest.handler.branch.quest10023
{
   ...
   public class QuestMapHandler_10023_390 extends QuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         {
            QuestManager.addEventListener("complete",this.onPreQuestComplete);
         }
      ...
      private function onPreQuestComplete(param1:QuestEvent) : void
      {
         ...
         {
            QuestManager.removeEventListener("complete",this.onPreQuestComplete);
            this.processAccept();
         }
      }
      ...
      private function onAccepted(param1:QuestEvent) : void
      {
         if(param1.questId == _quest.id)
         {
            ...
            SceneManager.changeScene(1,360);
         }
      }
      ...
      {
         var _loc1_:uint = uint(ItemManager.getItemQuantityByReferenceId(400223));
         if(_loc1_ >= 6)
         {
      ...
      private function clearMamaNpc() : void
      {
         if(this._mamaNpc)
         {
            ...
            MobileManager.removeMobile(this._mamaNpc,"npc");
            this._mamaNpc = null;
         }
      }
