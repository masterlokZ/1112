package com.taomee.seer2.app.processor.quest.handler.story.quest61
{
   ...
   public class QuestMapHandler_61_60 extends QuestMapHandler
   {
      ...
      public function QuestMapHandler_61_60(param1:QuestProcessor)
      {
         super(param1);
      }
      ...
      override public function processMapComplete() : void
      {
         ...
         {
            _flag = param1.readDataAtPostion(1);
      ...
      {
         this._mc_0 = _processor.resLib.getMovieClip("ma1");
         _map.content.addChild(this._mc_0);
         this._mc_0.buttonMode = true;
         this._mc_0.addEventListener("click",this.onMoutherTalk);
      }
      
      private function onMoutherTalk(param1:MouseEvent) : void
      {
         this._mc_0.removeEventListener("click",this.onMoutherTalk);
         this.addTalk();
      }
      ...
      private function addTalk() : void
      {
         ...
         {
            ServerBufferManager.updateServerBuffer(23,1,1);
            ergodicServerBuffer();
         },true);
      }
      ...
      private function ergodicServerBuffer() : void
      {
         ServerBufferManager.getServerBuffer(23,function(param1:ServerBuffer):void
         {
            ...
            if(num == 5)
            {
               NpcDialog.show(137,"SEAN的妈妈",[[0,"呜呜呜…我大老远过来找我的儿子，还给他带了过冬的衣服和亲手做的点心…呜呜呜…"]],["(⊙o⊙)…你先别伤心我们去资料室看看吧"],[function():void
               {
                  QuestManager.addEventListener("stepComplete",onStepConpleteHandler);
      ...
      {
         QuestManager.removeEventListener("stepComplete",this.onStepConpleteHandler);
         SceneManager.changeScene(1,30);
      }
