package com.taomee.seer2.app.processor.quest.handler.story.quest66
{
   ...
   public class QuestMapHandler_66_1230 extends QuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         this._npc = MobileManager.getMobile(316,"npc");
         ...
         this._flower.addEventListener("click",this.onFlower);
         this._door.addEventListener("click",this.onDoor);
      ...
      private function createUgly() : void
      {
         ...
         this._uglyMc.resourceUrl = URLUtil.getNpcSwf(317);
         this._uglyMc.buttonMode = true;
         this._uglyMc.addEventListener("click",this.onUglyClick);
         this._uglyMc.setPostion(uglyPostion);
         this._uglyMc.height = 100;
         this._uglyMc.x = 546;
         this._uglyMc.y = 316;
         MobileManager.addMobile(this._uglyMc,"npc");
      }
      
      private function onUglyClick(param1:MouseEvent) : void
      {
         var e:MouseEvent = param1;
         NpcDialog.show(317,"白雪公主",[[0,"啊？你们是谁，怎么找到了我？"]],["不要看我，我很丑"],[function():void
         {
                     ...
                     NpcDialog.show(316,"匹喏曹",[[3,"啊，原来，你们骗我，你们是皇后的卧底。"]],["你们都是坏人"],[function():void
                     {
                        NpcDialog.show(NpcUtil.getSeerNpcId(),"我",[[0,"不是，这发生了什么？巴蒂你住手！"]],["放开公主"],[function():void
                        {
                           MovieClipUtil.playFullScreen(URLUtil.getQuestFullScreenAnimation("66_2"),function():void
                           {
                              ...
                              if(_uglyMc)
                              {
                                 _uglyMc.removeEventListener("click",onUglyClick);
                                 MobileManager.removeMobile(_uglyMc,"npc");
                              }
                           });
                        }]);
                     }]);
      ...
      {
         this._flower.removeEventListener("click",this.onFlower);
         this._door.removeEventListener("click",this.onDoor);
         QuestManager.removeEventListener("accept",this.onAccept);
         if(this._uglyMc)
         {
            this._uglyMc.removeEventListener("click",this.onUglyClick);
         }
         DialogPanel.removeEventListener("customReplyClick",this.onStep);
         QuestManager.removeEventListener("stepComplete",this.onStepComplete);
