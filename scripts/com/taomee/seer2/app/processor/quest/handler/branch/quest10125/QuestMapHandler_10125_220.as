package com.taomee.seer2.app.processor.quest.handler.branch.quest10125
{
   ...
   public class QuestMapHandler_10125_220 extends QuestMapHandler
   {
      ...
      override public function processMapDispose() : void
      {
         ...
         DialogPanel.removeEventListener("customUnitClick",this.unitClick);
      }
      
      override public function processMapComplete() : void
      {
         super.processMapComplete();
         DialogPanel.addEventListener("customUnitClick",this.unitClick);
      }
      ...
      private function getBuff(param1:ServerBuffer) : void
      {
         ...
         var state:Array = [];
         state.push(buff.readDataAtPostion(12));
         state.push(buff.readDataAtPostion(13));
         state.push(buff.readDataAtPostion(14));
         state.push(buff.readDataAtPostion(15));
         isComplete = true;
         i = 0;
