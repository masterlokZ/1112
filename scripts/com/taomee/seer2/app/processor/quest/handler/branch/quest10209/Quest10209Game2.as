   ...
   public class Quest10209Game2
   {
      ...
      public function Quest10209Game2(param1:MovieClip, param2:Function)
      {
         ...
         while(_loc3_ < 5)
         {
            ...
            this._gameList[_loc3_].addEventListener("click",this.onGame);
            _loc3_++;
         }
      }
      ...
      private function onClose(param1:MouseEvent) : void
      {
         ...
         this._startBtn.removeEventListener("click",this.onStart);
         this._closeBtn.removeEventListener("click",this.onClose);
         for each(_loc2_ in this._gameList)
         {
            _loc2_.removeEventListener("click",this.onGame);
         }
      ...
      private function onGame(param1:MouseEvent) : void
      {
         ...
         var index:int = int(this._gameList.indexOf(event.currentTarget as SimpleButton));
