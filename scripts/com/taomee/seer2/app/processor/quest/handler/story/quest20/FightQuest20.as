   ...
   public class FightQuest20 extends EventDispatcher
   {
      ...
      private static function initEvent() : void
      {
         ...
         for each(_loc1_ in _petList)
         {
            ...
            _loc1_.addEventListener("click",onPetClick);
         }
         _ok.addEventListener("click",onOK);
      ...
      private static function onPetClick(param1:MouseEvent) : void
      {
         ...
         var _loc5_:int = int(_petList.indexOf(_loc3_));
         _loc4_ = _thisPetList[_loc5_];
         if(_loc4_.currentFrame == 1)
         {
            _loc4_.gotoAndStop(2);
            _selectList.push(_loc5_ + 1);
         }
         else
         {
            _loc2_ = int(_selectList.indexOf(_loc5_ + 1));
            _loc4_.gotoAndStop(1);
            _selectList.splice(_loc2_,1);
         }
      ...
      private static function removeEvent() : void
      {
         ...
         for each(_loc1_ in _petList)
         {
            ...
            _loc1_.removeEventListener("click",onPetClick);
         }
         _ok.removeEventListener("click",onOK);
         _closeBtn.removeEventListener("click",onClose);
      }
