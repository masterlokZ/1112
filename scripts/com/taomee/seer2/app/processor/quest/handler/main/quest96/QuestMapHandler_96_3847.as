   ...
   public class QuestMapHandler_96_3847 extends QuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         if(QuestManager.isAccepted(questID) && QuestManager.isComplete(questID) == false)
         {
            ...
            {
               MovieClipUtil.getSwfContent(URLUtil.getActivityAnimation("SearchDarkCode/dropBox"),(function():*
               {
                  var callBack:Function;
                  return callBack = function(param1:MovieClip):void
                  {
                     _dropMc = param1;
                     ...
                     MovieClip(_dropMc.boxMc).addEventListener("click",onBoxMc);
                  };
               })());
            }
      ...
      private function onBoxMc(param1:MouseEvent) : void
      {
         ...
         MovieClip(evt.currentTarget).removeEventListener("click",this.onBoxMc);
      ...
      private function onCompleteSwitch(param1:SceneEvent) : void
      {
         ...
         if(SceneManager.prevSceneType == 2)
         {
            ...
            if(1656 == FightManager.currentFightRecord.initData.positionIndex)
            {
               if(FightManager.isWinWar())
               {
                  this.npc = MobileManager.getMobile(40,"npc");
                  if(this.npc)
                  {
                  ...
                  MovieClipUtil.getSwfContent(URLUtil.getActivityAnimation("SearchDarkCode/dropBox"),(function():*
                  {
                     ...
                     return callBack = function(param1:MovieClip):void
                     {
                        ...
                        MovieClipUtil.playMc(MovieClip(mc.dropBox),2,MovieClip(mc.dropBox).totalFrames,(function():*
                        {
                           var ended:Function;
                           return ended = function():void
                           {
                              ...
                              MovieClip(mc.boxMc).addEventListener("click",onBoxMc);
                           };
                        })());
                     };
                  })());
      ...
      {
         MovieClipUtil.getSwfContent(URLUtil.getActivityAnimation("SearchDarkCode/game"),(function():*
         {
            var callBack:Function;
            return callBack = function(param1:MovieClip):void
            {
      ...
      {
         this._mainUI.addEventListener("mouseUp",this.onMouseUp);
         var _loc1_:int = 0;
         _loc1_ = 0;
         while(_loc1_ < this._targetList.length)
         {
            this._targetList[_loc1_].addEventListener("mouseUp",this.onMouseUp);
            this._pieceList[_loc1_].addEventListener("mouseDown",this.onMouseDown);
            _loc1_++;
         }
      ...
      private function onClose(param1:MouseEvent) : void
      {
         ...
         this._dropMc["boxMc"].addEventListener("click",this.onBoxMc);
      ...
      {
         var _loc2_:int = int(this._pieceList.indexOf(param1.currentTarget as MovieClip));
         if(_loc2_ != -1)
         {
      ...
      private function onMouseUp(param1:MouseEvent) : void
      {
         ...
         var _loc3_:int = 0;
         var _loc2_:int = int(this._targetList.indexOf(param1.currentTarget as MovieClip));
         if(_loc2_ != -1)
         {
            if(Boolean(this._curDrag) && this._pieceList.indexOf(this._curDrag) == _loc2_)
            {
               ...
               _loc3_ = 0;
               _loc3_ = 0;
               while(_loc3_ < this._targetLightList.length)
               {
                  if(this._targetLightList[_loc3_].visible == false)
                  {
                     _loc4_ = false;
                  }
                  _loc3_++;
      ...
      private function onStepComplete2(param1:QuestEvent) : void
      {
         ...
         MovieClipUtil.playFullScreen(URLUtil.getActivityFullScreen("searchDarkCode/searchDarkCode0"),(function():*
         {
            var callBack:Function;
      ...
      private function dialogShow(param1:MouseEvent) : void
      {
         ...
         NpcDialog.show(400,"赛尔",[[0,"站住，你！鬼鬼祟祟的在做什么?"]],["是不是偷法典的家伙？"],[function():void
         {
            NpcDialog.show(40,"萨伦小兵",[[0,"咳……你是什么鬼，我们要干嘛还轮不到你管，找死吗？"]],["找死的是你吧！"],[function():void
            {
               ...
               {
                  SceneManager.addEventListener("switchComplete",onCompleteSwitch);
                  FightManager.startFightWithWild(1656);
               }]);
            }]);
         }]);
      }
      ...
      {
         if(Boolean(this._closeBtn) && this._closeBtn.hasEventListener("click"))
         {
            this._closeBtn.removeEventListener("click",this.onClose);
            this._closeBtn = null;
         }
