package com.taomee.seer2.app.processor.quest.handler.branch.quest10189
{
   ...
   public class QuestMapHandler_10189_2 extends QuestMapHandler
   {
      ...
      private var _mapPointList:Array = [[160,332],[228,443],[722,214]];
      ...
      private function createPets() : void
      {
         ...
         while(_loc2_ < 3)
         {
            _loc1_ = new ActivePet(new Point(this._mapPointList[_loc2_][0],this._mapPointList[_loc2_][1]),146);
            _loc1_.addEventListener("click",this.onPetHandler);
            _loc1_.targetPoint = new Point(481,345);
      ...
      private function hasHitOn(param1:int) : void
      {
         ...
         while(_loc3_ < this._pets.length)
         {
            ...
            if((Boolean(_loc2_)) && HitTest.complexHitTestObject(_loc2_,this._hebenMC))
            {
               _loc6_ = HitTest.intersectionRectangle(_loc2_,this._hebenMC);
               ++this._hitCount;
               if(this._hitCount > 10)
               {
                  this._petCount = 0;
            ...
            NpcDialog.show(NpcUtil.getSeerNpcId(),"我",[[0,"你从哪里来的？刚才你打缇娜实在是太厉害了！你刚才还说梦话了哦！"]],["小赛尔，你好啰嗦！"],[function():void
            {
               NpcDialog.show(192,"S",[[0,"你好！我是S，这是小赛尔，谢谢你刚才救了我们。看得出，你是特别高贵的精灵吧？你从哪里来？"]],["不客气！我是赫本。关于我，不如你们自己去看吧——"],[function():void
               {
                  ...
                  MovieClipUtil.playMc(_mc_1,1,_mc_1.totalFrames,function():void
                  {
                     ...
                     _mc_1.addEventListener("click",OnPlaySecondFullMovie);
                  },true);
               }]);
            }]);
         }]);
