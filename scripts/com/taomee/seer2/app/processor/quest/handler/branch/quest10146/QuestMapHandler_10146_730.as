package com.taomee.seer2.app.processor.quest.handler.branch.quest10146
{
   ...
   public class QuestMapHandler_10146_730 extends QuestMapHandler
   {
      ...
      public function QuestMapHandler_10146_730(param1:QuestProcessor)
      {
         super(param1);
      }
      ...
      private function missOrSuccess() : void
      {
         ...
         Connection.send(CommandSet.RANDOM_EVENT_1140,37,0);
      }
