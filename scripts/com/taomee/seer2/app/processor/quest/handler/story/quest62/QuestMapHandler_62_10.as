package com.taomee.seer2.app.processor.quest.handler.story.quest62
{
   ...
   public class QuestMapHandler_62_10 extends QuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         ServerBufferManager.getServerBuffer(23,function(param1:ServerBuffer):void
         {
         ...
         if(QuestManager.isStepComplete(_quest.id,2) && QuestManager.isStepComplete(_quest.id,3) == false)
         {
            ...
            DialogPanel.addEventListener("customReplyClick",this.onStep2);
         }
            ...
            NpcDialog.show(1,"辛迪船长",[[0,"S应该是冲着他的妈妈来的！对了赛尔！S的妈妈恢复得怎么样了？"]],["不是很好，还在昏迷中"],[function():void
            {
               NpcDialog.show(1,"辛迪船长",[[0,"我们要跟S把事情说清楚，在没有任何危险的情况下让S和他的妈妈见面。"]],["但是这需要一点时间"],[function():void
               {
                  MovieClipUtil.playFullScreen(URLUtil.getQuestFullScreenAnimation("62_1"),function():void
                  {
                     ...
                     {
                        QuestManager.addEventListener("stepComplete",onStep1Handler);
      ...
      {
         QuestManager.removeEventListener("stepComplete",this.onStep1Handler);
      ...
      {
         QuestManager.addEventListener("stepComplete",this.onStep2Handler);
         QuestManager.completeStep(_quest.id,2);
      }
      
      private function onStep2Handler(param1:QuestEvent) : void
      {
         QuestManager.removeEventListener("stepComplete",this.onStep2Handler);
         DialogPanel.addEventListener("customReplyClick",this.onStep2);
      }
      ...
      private function onStep2(param1:DialogPanelEvent) : void
      {
         ...
         DialogPanel.removeEventListener("customReplyClick",this.onStep2);
      ...
      private function addSheps() : void
      {
         ...
         while(_loc1_ < 4)
         {
            _loc2_ = this._mc_0["shep" + _loc1_];
            _loc2_.gotoAndStop(1);
            _loc2_.buttonMode = true;
            _loc2_.addEventListener("click",this.onFightShepHandler);
            this._shep.push(_loc2_);
            _loc1_++;
         }
      }
      ...
      {
         var _loc2_:int = int(this._shep.indexOf(param1.currentTarget as MovieClip));
      ...
      private function win() : void
      {
         ...
         if(this._totalNum == 4)
         {
            ...
            {
               QuestManager.addEventListener("stepComplete",onStep3Handler);
      ...
      {
         QuestManager.removeEventListener("stepComplete",this.onStep3Handler);
         this.addMother();
         this.motherTalk();
      }
      ...
      private function addMother() : void
      {
         ...
         this._mc_0.addEventListener("click",this.onClickMaHandler);
      }
         ...
         MovieClipUtil.playMc(this._mc_1,1,this._mc_1.totalFrames,function():void
         {
            NpcDialog.show(1,"辛迪船长",[[0,"不好！s的妈妈还没有完全恢复过来，刚刚经过这么一折腾又晕倒了！"]],[],[function():void
            {
               NpcDialog.show(1,"辛迪船长",[[0,"为了s的妈妈现在我们只能先停止交战！快把s的妈妈送到医务室接受紧急治疗！"]],[],[function():void
               {
                  ...
                  {
                     QuestManager.addEventListener("complete",onStep4Handler);
      ...
      {
         QuestManager.removeEventListener("complete",this.onStep4Handler);
         if(this._mc_0)
         {
            DisplayUtil.removeForParent(this._mc_0);
         }
