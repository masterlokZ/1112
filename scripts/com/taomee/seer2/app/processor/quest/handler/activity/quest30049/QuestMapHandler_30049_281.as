package com.taomee.seer2.app.processor.quest.handler.activity.quest30049
{
   ...
   public class QuestMapHandler_30049_281 extends QuestMapHandler
   {
      ...
      private var pointList:Vector.<Point> = Vector.<Point>([new Point(332,415),new Point(431,335),new Point(582,413)]);
      
      private var titleList:Vector.<int> = Vector.<int>([0,2,0]);
      ...
      private function startQuest1() : void
      {
         ...
         this._npc.buttonMode = true;
         this._npc.addEventListener("click",this.onShiguang);
      }
      ...
      private function openTime() : void
      {
         ...
         this._npc.removeEventListener("click",this.onShiguang);
      ...
      private function onSwitch(param1:MouseEvent) : void
      {
         ...
         {
            switchMC.removeEventListener("click",this.onSwitch);
         }
         mc = event.currentTarget as MovieClip;
         index = int(this._switchList.indexOf(mc));
         mc.gotoAndStop(2);
