package com.taomee.seer2.app.processor.quest.handler.branch.quest10200
{
   ...
   public class QuestMapHandler_10200_2911 extends QuestMapHandler
   {
      ...
      override public function processMapComplete() : void
      {
         ...
         {
            if(SceneManager.prevSceneType == 2 && _questFight)
            {
               _questFight = false;
               this.nextQuest4();
            }
      ...
      private function nextQuest2() : void
      {
         ...
         this._mc3.addEventListener("click",this.onMC3);
      }
      ...
      private function nextQuest4() : void
      {
         ...
         this._mc3.removeEventListener("click",this.onMC3);
         this._mc4.addEventListener("click",this.onMC4);
      }
