   ...
   public class MaliangGame
   {
      ...
      private function initMC() : void
      {
         ...
         while(_loc1_ < 6)
         {
            ...
            this._uiuiList[_loc1_].addEventListener("mouseUp",this.onUiUp);
            this._moveList[_loc1_].gotoAndStop(1);
            this._moveList[_loc1_].visible = true;
            this._moveList[_loc1_].buttonMode = true;
            this._moveList[_loc1_].addEventListener("mouseDown",this.onDown);
            _loc1_++;
         }
      }
      ...
      private function onDown(param1:MouseEvent) : void
      {
         ...
         this._mc.addEventListener("enterFrame",this.onMove);
         this._mc.addEventListener("mouseUp",this.onUp);
      }
      ...
      private function onUp(param1:MouseEvent) : void
      {
         ...
         this._mc.removeEventListener("mouseUp",this.onUp);
         this._mc.removeEventListener("enterFrame",this.onMove);
      ...
      private function onUiUp(param1:MouseEvent) : void
      {
         ...
         var _loc2_:int = int(this._uiuiList.indexOf(param1.currentTarget as MovieClip));
