package com.taomee.seer2.app.processor.quest.handler.branch.quest10093
{
   ...
   public class QuestMapHandler_10093_850 extends QuestMapHandler
   {
      ...
      private var _arr:Array = ["1","2","3","1","2","3","1","2","3"];
      ...
      override public function processMapComplete() : void
      {
         ...
         if(QuestManager.isCanAccepted(_quest.id))
         {
            ...
            if(SceneManager.prevSceneType == 2 && this._hasFight)
            {
         ...
         {
            DialogPanel.addEventListener("customReplyClick",this.onStepOneHandler);
            if(SceneManager.prevSceneType == 2 && this._hasFightAgain)
            {
      ...
      private function onStepOneHandler(param1:DialogPanelEvent) : void
      {
         ...
         {
            DialogPanel.removeEventListener("customReplyClick",this.onStepOneHandler);
      ...
      private function win() : void
      {
         ...
         {
            QuestManager.addEventListener("accept",AcceptHandler);
      ...
      private function winAgain() : void
      {
         ...
         {
            QuestManager.addEventListener("stepComplete",onStep1Complete);
      ...
      {
         QuestManager.removeEventListener("stepComplete",this.onStep1Complete);
         this.initNpc();
      }
      ...
      private function initNpc() : void
      {
         ...
         DialogPanel.addEventListener("dialogShow",this.onNpcHandler);
      }
      ...
      private function onPlayHint(param1:MessageEvent) : void
      {
         ...
         if(count < 10)
         {
            if(count < 1)
            {
               ...
               close_Btn.addEventListener("click",function(param1:MouseEvent):void
               {
                  if(_mc_1)
                  {
               ...
               start_Btn.addEventListener("click",this.gotoNextPageHandler);
            }
            else
            {
               this._scene = SceneManager.active as LobbyScene;
      ...
      private function teacherMode() : void
      {
         ...
         this._upBtn2.addEventListener("click",function(param1:MouseEvent):void
         {
            var evt:MouseEvent = param1;
            _upBtn_mc.gotoAndStop(1);
            _seer_mc.gotoAndPlay(26);
            _gang_mc.gotoAndPlay(26);
            _seer_mc.addEventListener("enterFrame",function(param1:Event):void
            {
               var evt:Event = param1;
               if(_seer_mc.currentFrame == 50)
               {
                  _seer_mc.removeEventListener("enterFrame",arguments.callee);
                  _gang_mc.gotoAndPlay(51);
                  _downBtn_mc.gotoAndStop(2);
                  _tips_mc.gotoAndStop(2);
                  _downBtn2 = _downBtn_mc.getChildAt(0) as MovieClip;
                  _downBtn2.addEventListener("click",function(param1:MouseEvent):void
                  {
                     var evt:MouseEvent = param1;
                     ...
                     _seer_mc.addEventListener("enterFrame",function(param1:Event):void
                     {
                        ...
                        if(_seer_mc.currentFrame == 75)
                        {
                           ...
                           _middleBtn2.addEventListener("click",function(param1:MouseEvent):void
                           {
                              var evt:MouseEvent = param1;
                              ...
                              _seer_mc.addEventListener("enterFrame",function(param1:Event):void
                              {
                                 ...
                                 if(_seer_mc.currentFrame == 100)
                                 {
                                    ...
                                    _time_mc.addEventListener("enterFrame",function(param1:Event):void
                                    {
                                       if(_time_mc.currentFrame == 62)
                                       {
                                          _time_mc.removeEventListener("enterFrame",arguments.callee);
                                          ChooseFight();
                                       }
                                    });
                                 }
      ...
      {
         var _loc2_:int = Math.random() * 9;
         var _loc1_:int = int(this._arr[_loc2_]);
         ++this._fight_num;
      ...
      private function StartFightOne(param1:int) : void
      {
         ...
         this._help_mc.addEventListener("enterFrame",this.helpThingOne);
      }
      ...
      private function StartFightTwo(param1:int) : void
      {
         ...
         this._help_mc.gotoAndPlay(1);
         this._help_mc.addEventListener("enterFrame",this.helpThingTwo);
      }
      
      private function StartFightThree(param1:int) : void
      {
         this._help_mc.gotoAndPlay(1);
         this._help_mc.addEventListener("enterFrame",this.helpThingThree);
      }
      ...
      private function onFrame(param1:Event) : void
      {
         ...
         {
            this._seer_mc.removeEventListener("enterFrame",this.onFrame);
            this.ChooseFight();
         }
      }
      ...
      private function loseFrame(param1:Event) : void
      {
         ...
         {
            this._gang_mc.removeEventListener("enterFrame",this.loseFrame);
      ...
      private function helpThingOne(param1:Event) : void
      {
         ...
         if(this._help_mc.currentFrame == this._help_mc.totalFrames)
         {
            ...
            this._help_mc.removeEventListener("enterFrame",this.helpThingOne);
            this._gang_mc.gotoAndPlay(26);
            this._blood_mc.gotoAndStop(this._blood_num++);
            this._gang_mc.addEventListener("enterFrame",this.loseFrame);
         }
         else
         {
            this._upBtn2.addEventListener("click",function(param1:MouseEvent):void
            {
               _help_mc.removeEventListener("enterFrame",helpThingOne);
               _upBtn_mc.gotoAndStop(1);
               _seer_mc.gotoAndPlay(26);
               _gang_mc.gotoAndPlay(26);
               _seer_mc.addEventListener("enterFrame",onFrame);
            });
         }
      }
      ...
      private function helpThingTwo(param1:Event) : void
      {
         ...
         if(this._help_mc.currentFrame == this._help_mc.totalFrames)
         {
            ...
            this._help_mc.removeEventListener("enterFrame",this.helpThingTwo);
         ...
         {
            this._downBtn2.addEventListener("click",function(param1:MouseEvent):void
            {
               _help_mc.removeEventListener("enterFrame",helpThingTwo);
               _downBtn_mc.gotoAndStop(1);
               _seer_mc.gotoAndPlay(51);
      ...
      private function helpThingThree(param1:Event) : void
      {
         ...
         if(this._help_mc.currentFrame == this._help_mc.totalFrames)
         {
            ...
            this._help_mc.removeEventListener("enterFrame",this.helpThingThree);
         ...
         else
         {
            ...
            this._middleBtn2.addEventListener("click",function(param1:MouseEvent):void
            {
               _help_mc.removeEventListener("enterFrame",helpThingThree);
               _middleBtn_mc.gotoAndStop(1);
               _seer_mc.gotoAndPlay(76);
      ...
      private function initExchangePanel() : void
      {
         ...
         ItemManager.requestEquipList(function():void
         {
            ...
            {
               if(_loc8_[_loc7_].referenceId == 100401)
               {
                  thing2Coin = 1;
               }
               if(_loc8_[_loc7_].referenceId == 100402)
               {
                  thing3Coin = 1;
               }
               if(_loc8_[_loc7_].referenceId == 100403)
               {
                  thing4Coin = 1;
               }
               if(_loc8_[_loc7_].referenceId == 100404)
               {
                  thing5Coin = 1;
               }
               _loc7_++;
