package com.taomee.seer2.app.processor.copy.handler
{
   ...
   public class CopyProcessor_80023 extends CopyProcessor
   {
      
      private const BOSS_INDEX:Vector.<int> = Vector.<int>([437,438,439]);
      
      private const MONSTER_INDEX:int = 436;
      
      private const GOLE_KILL_NUM:int = 1;
      
      private const POS_LIST:Array = [490,399];
      ...
      public function CopyProcessor_80023(param1:CopyItemInfo)
      {
         super(param1);
      }
      ...
      {
         StatisticsManager.sendNovice("0x10033856");
      }
      ...
      {
         this.cartoonHandle("80022_1","",function():void
         {
            updateMonster();
            ...
            if(FightManager.fightWinnerSide == 1)
            {
               ...
               if(index == 436)
               {
                  ...
                  else
                  {
                     ...
                     this.cartoonHandle("80022_2","",function():void
                     {
               ...
               else if(this.BOSS_INDEX.indexOf(index) != -1)
               {
                  ...
                  if(posIndex == 0)
                  {
                     this.cartoonHandle("80022_3","",function():void
                     {
                        _stateOneBoss.removeEventListener("click",onBossClick);
                  ...
                  {
                     this.cartoonHandle("80022_4","",function():void
                     {
      ...
      private function updateMonster() : void
      {
         ...
         var _loc2_:int = 1 - this._killNum;
         var _loc1_:uint = 0;
         while(_loc1_ < _loc2_)
         {
            _loc3_ = new SpawnedPet(170,436,0);
