package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80158 extends TitleMapProcessor
   {
         ...
         if(SceneManager.prevSceneType != 2)
         {
            MovieClipUtil.playFullScreen(URLUtil.getActivityFullScreen("fightVsWuSha/FightVsWuSha1"),function():void
            {
               ActiveCountManager.requestActiveCountList(FOR_LIST,function(param1:Parser_1142):void
               {
                  ...
                  _par = par;
                  DayLimitManager.getDoCount(1028,function(param1:int):void
                  {
                     var val:int = param1;
      ...
      private function fightInit() : void
      {
         ...
         if(BitUtil.getBit(this._par.infoVec[3],_curIndex))
         {
         ...
         this._freeHelp.addEventListener("click",this.onFreeHelp);
         for each(_loc1_ in this._miHelpList)
         {
            _loc1_.addEventListener("click",this.onMiHelp);
         }
      }
      ...
      private function onFreeHelp(param1:MouseEvent) : void
      {
         ...
         {
            SwapManager.swapItem(2509,1,function(param1:IDataInput):void
            {
      ...
      private function onMiHelp(param1:MouseEvent) : void
      {
         var index:int = 0;
         var evt:MouseEvent = param1;
         index = int(this._miHelpList.indexOf(evt.currentTarget as SimpleButton));
         if(this._par.infoVec[2] == 0)
         {
      ...
      private function fightVsWuShaActDispose() : void
      {
         ...
         if(this._freeHelp)
         {
            this._freeHelp.removeEventListener("click",this.onFreeHelp);
            this._freeHelp = null;
         }
         if(this._miHelpList)
         {
            for each(_loc1_ in this._miHelpList)
            {
               _loc1_.removeEventListener("click",this.onMiHelp);
            }
