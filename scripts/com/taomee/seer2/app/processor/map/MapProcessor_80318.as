package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80318 extends MapProcessor
   {
      ...
      private var fightBossID:Array = [1269];
      ...
      private function addEvent() : void
      {
         ...
         while(_loc1_ < 3)
         {
            this.swapList[_loc1_].addEventListener("click",this.onSwap);
            _loc1_++;
         }
      }
      ...
      {
         this.hasEvent = false;
         this.exitBtn.removeEventListener("click",this.onExit);
         var _loc1_:int = 0;
         while(_loc1_ < 3)
         {
            this.swapList[_loc1_].removeEventListener("click",this.onSwap);
            _loc1_++;
         }
      }
      ...
      {
         var e:MouseEvent = param1;
         var idx:int = int(this.swapList.indexOf(e.target as SimpleButton));
