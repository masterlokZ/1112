package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_1900 extends MapProcessor
   {
      ...
      private static const request_limit:Array = [203205,203207,203214,204497,203208,203209,203210,203211,203212,203213];
      ...
      private function getSpecialItem(param1:ItemEvent) : void
      {
         ...
         ItemManager.removeEventListener1("requestSpecialItemSuccess",this.getSpecialItem);
         if(ItemManager.getSpecialItem(603309))
         {
            AlertManager.showAlert("你已经通关了，赶紧神化月神吧",function():void
            {
               SceneManager.changeScene(1,8502);
            });
         }
         else
         {
      ...
      {
         ItemManager.addEventListener1("requestSpecialItemSuccess",this.getSpecialItem);
      ...
      private function requestLimit() : void
      {
         ActiveCountManager.requestActiveCountList(request_limit,function(param1:Parser_1142):void
         {
            ...
            if(b)
            {
               SwapManager.swapItem(1909,1,function(param1:IDataInput):void
               {
                  requestData();
               });
               return;
