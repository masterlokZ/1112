package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80224 extends MapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         ServerBufferManager.getServerBuffer(211,this.getBuffer);
      ...
      private function toFight() : void
      {
         if(this.leftCount == 0)
         {
            ...
            {
               ShopManager.buyItemForId(603947,onCount);
            }]);
            return;
         }
         this.isToFight = true;
         FightManager.startFightWithBoss(1098);
      }
      ...
      private function getBuffer(param1:ServerBuffer) : void
      {
         ...
         ActiveCountManager.requestActiveCountList([204418,204419],this.getData);
      }
      ...
      private function getData(param1:Parser_1142) : void
      {
         ...
         DayLimitManager.getDoCount(1232,this.getDayData);
      }
      ...
      private function getDayData(param1:uint) : void
      {
         ...
         this.hurtBar.height = this.allHurtValue / 3000000 * 274;
         if(!this.hasPlayScene1)
         {
            this.npc.visible = false;
            ActorManager.getActor().visible = false;
            ServerBufferManager.updateServerBuffer(211,16,1);
      ...
      {
         var left:uint = uint(this.allHurtValue < 3000000 ? uint(3000000 - this.allHurtValue) : 0);
         if(left == 0)
         {
            this.onPass(null);
            return;
         ...
         {
            ShopManager.buyItemForId(603948,onPass);
         }]);
      }
      ...
      private function onPass(param1:*) : void
      {
         ...
         {
            SceneManager.changeScene(9,80225);
         });
      }
