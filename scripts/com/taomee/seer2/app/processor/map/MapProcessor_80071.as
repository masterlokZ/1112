package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80071 extends MapProcessor
   {
      ...
      {
         QueueLoader.load(URLUtil.getActivityAnimation("ziDianSuperProcess/ZiDianSceneMC"),"swf",function(param1:ContentInfo):void
         {
      ...
      {
         DayLimitManager.getDoCount(867,function(param1:int):void
         {
            var petNum:int = 0;
            var val:int = param1;
            if(val < 12)
            ...
            {
               DayLimitManager.getDoCount(868,function(param1:int):void
               {
      ...
      {
         ActiveCountManager.requestActiveCount(203405,function(param1:uint, param2:uint):void
         {
            var type:uint = param1;
            var val:uint = param2;
            if(val == 0)
            {
               SwapManager.swapItem(2146,1,function(param1:IDataInput):void
               {
                  new SwapInfo(param1);
            ...
            {
               ActiveCountManager.requestActiveCount(203407,function(param1:uint, param2:uint):void
               {
                  var type:uint = param1;
                  var val:uint = param2;
                  if(val == 1)
                  ...
                  else
                  {
                     ...
                     {
                        if(ItemManager.getItemQuantityByReferenceId(500597) > 0)
                        {
                           SwapManager.swapItem(2146,1,function(param1:IDataInput):void
                           {
                              new SwapInfo(param1);
      ...
      private function createPetList(param1:int) : void
      {
         ...
         while(_loc2_ < param1)
         {
            _loc3_ = new SpawnedPet(148,691,0);
      ...
      private function startFight() : void
      {
         ...
         {
            var val:int = param1;
            ActiveCountManager.requestActiveCount(203406,function(param1:uint, param2:uint):void
            {
               var type:uint = param1;
               ...
               if(_fightNum > 0)
               {
                  ...
                  {
                     FightManager.startFightWithWild(692);
                  }]);
               }
               else
               {
