   ...
   public class MapProcessor_80391 extends MapProcessor
   {
      ...
      private function createNpc() : void
      {
         if(!this._npc1)
         {
            ...
            this._npc1.addEventListener("click",this.onNpcClick);
         }
         if(!this._npc2)
         {
            ...
            this._npc2.labelPosition = 1;
            this._npc2.label = "梦魇";
            this._npc2.labelImage.y = -this._npc2.height - 10;
            this._npc2.buttonMode = true;
            MobileManager.addMobile(this._npc2,"npc");
            this._npc2.addEventListener("click",this.onNpcClick);
         }
      }
