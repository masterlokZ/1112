package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_70 extends TitleMapProcessor
   {
      ...
      {
         this._broadNpc = MobileManager.getMobile(3038,"npc");
         if(this._broadNpc)
         {
            this._broadNpc.addEventListener("click",this.onBroadClick);
         }
      }
      ...
      private function broadClickDispose() : void
      {
         if(this._broadNpc)
         {
            this._broadNpc.removeEventListener("click",this.onBroadClick);
            this._broadNpc = null;
         }
      }
      ...
      {
         var _loc1_:Mobile = MobileManager.getMobile(1038,"npc");
         _loc1_.addEventListener("click",this.onNpc1038);
      }
      ...
      private function onDialogShow(param1:DialogPanelEvent) : void
      {
         ...
         if(param1.content == 8)
         {
            if(DialogPanel.functionalityBox.getUnit("有奖调查"))
            {
               ...
               DialogPanel.functionalityBox.getUnit("有奖调查").createColorBtn(16711680);
            }
         }
      }
      ...
      private function addFirstVip() : void
      {
         ...
         this.shouChong.resourceUrl = URLUtil.getNpcSwf(347);
         this.shouChong.x = 470;
         this.shouChong.y = 219;
         this.shouChong.buttonMode = true;
         MobileManager.addMobile(this.shouChong,"npc");
         this.shouChong.addEventListener("click",this.onShouChong);
      }
      ...
      private function getState(param1:uint, param2:uint) : void
      {
         ...
         {
            this.oilBtn.addEventListener("click",this.toOil);
         }
      }
      ...
      private function initTest() : void
      {
         ...
         _loc1_.addEventListener("click",this.onTest);
      }
      ...
      {
         SceneManager.changeScene(1,1300);
      }
      ...
      {
         StatisticsManager.sendNovice("0x10033574");
      }
      ...
      {
         this._npc = MobileManager.getMobile(180,"npc");
      ...
      private function onAccept(param1:QuestEvent) : void
      {
         ...
         DisplayUtil.removeForParent(this._npc);
         SceneManager.changeScene(1,730);
      }
      ...
      private function addChrismasNpc() : void
      {
         if(DateUtil.isInTime(new Date(2012,11,21,10,0,0,0),new Date(2012,11,24,21,0,0,0)))
         {
            ...
            MobileManager.addMobile(this._saleNpc,"npc");
            this._saleNpc.addEventListener("click",this.onSaleNpcClick);
         }
      }
      ...
      private function addFirstNpc() : void
      {
         ...
         MobileManager.addMobile(this._firstNpc,"npc");
         this._firstNpc.addEventListener("click",this.onFirstNpc);
      }
      ...
      private function firstChargeSetDispose() : void
      {
         if(this._firstNpc)
         {
            this._firstNpc.removeEventListener("click",this.onFirstNpc);
      ...
      {
         var _loc7_:Mobile = MobileManager.getMobile(156,"npc");
         var _loc6_:Mobile = MobileManager.getMobile(157,"npc");
         var _loc9_:Mobile = MobileManager.getMobile(152,"npc");
         var _loc8_:Mobile = MobileManager.getMobile(158,"npc");
         var _loc3_:Mobile = MobileManager.getMobile(333,"npc");
         var _loc2_:Mobile = MobileManager.getMobile(332,"npc");
         var _loc5_:Mobile = MobileManager.getMobile(389,"npc");
         var _loc4_:Mobile = MobileManager.getMobile(390,"npc");
         var _loc1_:Mobile = MobileManager.getMobile(391,"npc");
         _loc7_.addEventListener("click",this.onClickAHandler,false,100);
         _loc6_.addEventListener("click",this.onClickBHandler);
         _loc9_.addEventListener("click",this.onClickCHandler);
         _loc8_.addEventListener("click",this.onClickDHandler);
         _loc3_.addEventListener("click",this.onMobile333);
         _loc2_.addEventListener("click",this.onMobile332);
         _loc5_.addEventListener("click",this.onmobile7);
         _loc4_.addEventListener("click",this.onmobile8);
         _loc1_.addEventListener("click",this.onmobile9);
      }
      ...
      {
         StatisticsManager.sendNovice("0x10033469");
      }
      
      private function onMobile332(param1:MouseEvent) : void
      {
         StatisticsManager.sendNovice("0x1003346A");
      }
      
      private function onMobile330(param1:MouseEvent) : void
      {
         StatisticsManager.sendNovice("0x1003346B");
      }
      
      private function initMikaMail() : void
      {
         _map.content["mikasnow"].visible = true;
         _map.content["mikasnow"].addEventListener("click",this.mikaMailHandler);
      }
      ...
      private function mikaMailHandler(param1:MouseEvent) : void
      {
         ...
         if((_loc2_.month == 0 || _loc2_.month == 1 && _loc2_.date <= 13) && _loc2_.hours == 13)
         {
            ...
            StatisticsManager.sendNovice("0x1003340C");
         }
         else
         {
      ...
      private function initUI() : void
      {
         ...
         this._leftBtn.addEventListener("click",this.onMouseLeftBtn);
         this._rightBtn.addEventListener("click",this.onMouseRightBtn);
      }
      ...
      private function onMouseLeftBtn(param1:MouseEvent) : void
      {
         ...
         StatisticsManager.sendNovice("0x10033464");
      }
      ...
      {
         var _loc1_:Mobile = MobileManager.getMobile(157,"npc");
         _loc1_.addEventListener("click",this.onClickXeggHandler);
      }
