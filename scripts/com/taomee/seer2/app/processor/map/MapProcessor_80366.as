package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80366 extends MapProcessor
   {
      ...
      public function MapProcessor_80366(param1:MapModel)
      {
         super(param1);
      }
      ...
      override public function init() : void
      {
         ...
         if(DateUtil.isInDayAndHourScope(3,8,14,14,10,20))
         {
      ...
      private function shootComplete(param1:ShootEvent) : void
      {
         ...
         if(!DateUtil.isInDayAndHourScope(3,8,14,14,0,30))
         {
            AlertManager.showAlert("活动时间已经结束了,去传送室看看其他活动吧!",function():void
            {
               SceneManager.changeScene(1,70);
