   ...
   public class MapProcessor_1501 extends MapProcessor
   {
      ...
      private function initGift() : void
      {
         ...
         while(i < 2)
         {
            ...
            this._giftMCList[i].addEventListener("click",this.onGift);
            i++;
         }
      ...
      private function onGift(param1:MouseEvent) : void
      {
         ...
         index = int(this._giftMCList.indexOf(event.currentTarget as MovieClip));
      ...
      {
         MobileManager.getMobile(330,"npc").addEventListener("click",this.onClickHandler);
         MobileManager.getMobile(329,"npc").addEventListener("click",this.onClickHandler);
         MobileManager.getMobile(331,"npc").addEventListener("click",this.onClickHandler);
         this._seMC.addEventListener("click",this.onSe);
      }
