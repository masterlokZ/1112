package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80413 extends MapProcessor
   {
      ...
      private function initSet() : void
      {
         ...
         this._miPass.addEventListener("click",this.onMiPass);
      ...
      private function updateBossState() : void
      {
         ...
         else
         {
            ...
            while(_loc3_ < 3)
            {
               if(_loc3_ > 0 && !BitUtil.getBit(_par.infoVec[2],_loc3_) && BitUtil.getBit(_par.infoVec[2],_loc3_ - 1))
               {
                  _loc1_ = _loc3_;
                  break;
               }
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:int = this.getCurPower();
         if(_loc1_ < NEED_POWER[0])
         {
            _loc2_ = 0;
         }
         else if(_loc1_ >= NEED_POWER[0] && _loc1_ < NEED_POWER[1])
         {
            _loc2_ = 1;
         }
         else
      ...
      private function getCurPower() : int
      {
         ...
         {
            _loc2_ += PetInfoManager.getPowerByPetInfo(_loc1_);
         }
         return _loc2_;
      }
      ...
      private function onActDispose() : void
      {
         ...
         if(this._miPass)
         {
            this._miPass.removeEventListener("click",this.onMiPass);
            this._miPass = null;
         }
         this._fightNum = null;
         this._npcList = null;
