package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80225 extends MapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         DayLimitManager.getDoCount(1233,this.onDay);
      ...
      private function onDay(param1:uint) : void
      {
         ...
         ActiveCountManager.requestActiveCountList([204452],this.onActive);
      }
      ...
      protected function onNpc(param1:MouseEvent) : void
      {
         ...
         else
         {
            ...
            {
               ShopManager.buyItemForId(603949,onBuyFight);
            }]);
         }
      }
      ...
      {
         FightManager.addEventListener("FIGHT_OVER",this.onFightOver);
         FightManager.startFightWithBoss(1099);
      }
      ...
      protected function onFightOver(param1:FightStartEvent) : void
      {
         ...
         if(!FightManager.isJustWinFight())
         {
            ...
            {
               ShopManager.buyItemForId(603950,onBuyChip);
            }]);
         }
         else
         {
