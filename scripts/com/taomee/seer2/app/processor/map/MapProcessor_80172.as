   ...
   public class MapProcessor_80172 extends MapProcessor
   {
      ...
      private function showPanel() : void
      {
         ...
         while(_loc1_ < 4)
         {
            ...
            this.clickTargetList[_loc1_].addEventListener("click",this.onClick);
            _loc1_++;
         }
      }
      ...
      private function onRandomStatus(param1:MessageEvent) : void
      {
         ...
         FightManager.startFightWithBoss(_loc3_);
      }
      ...
      override public function dispose() : void
      {
         ...
         while(_loc1_ < 4)
         {
            this.clickTargetList[_loc1_].removeEventListener("click",this.onClick);
