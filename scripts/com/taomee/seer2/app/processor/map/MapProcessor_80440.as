package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80440 extends MapProcessor
   {
         ...
         ActiveCountManager.requestActiveCountList(FOR_LIST,function(param1:Parser_1142):void
         {
            ...
            DayLimitListManager.getDaylimitList(DAY_LIST,function(param1:DayLimitListInfo):void
            {
               ...
               if(par.infoVec[2] < 5)
               {
                  ...
                  while(i < 5)
                  {
                     ...
                     else if(i == par.infoVec[2])
                     {
                        ...
                        curBossIndex = int((FIGHT_RES_LIST[i] as Array).indexOf(par.infoVec[3]));
               ...
               else
               {
                  ...
                  else if(SceneManager.prevSceneType == 2 && FightManager.currentFightRecord.initData.positionIndex == FIGHT_INDEX_LIST[1] && FightManager.fightWinnerSide == 2)
                  {
      ...
      private function initSet() : void
      {
         ...
         this._fightHelpUtil = new FightHelpUtil(_map.front["petBag"],_map.front["getBlood"],_map.front["itemShop"],_map.front["goBBS"],{"bbsId":150});
      ...
      private function initEvent() : void
      {
         ...
         while(_loc1_ < 5)
         {
            this._fightList[_loc1_].addEventListener("click",this.onFightSmallBoss);
            this._fightMiPassList[_loc1_].addEventListener("click",this.onMiPass);
            _loc1_++;
         }
         this._fightList[5].addEventListener("click",this.onFightBigBoss);
         this._miPass.addEventListener("click",this.onCdMiPass);
      }
      ...
      private function onFightSmallBoss(param1:MouseEvent) : void
      {
         ...
         index = int(this._fightList.indexOf(curSmallBoss));
      ...
      private function onMiPass(param1:MouseEvent) : void
      {
         ...
         index = int(this._fightMiPassList.indexOf(evt.currentTarget as SimpleButton));
      ...
      private function onActDispose() : void
      {
         ...
         while(_loc1_ < 5)
         {
            this._fightList[_loc1_].removeEventListener("click",this.onFightSmallBoss);
            this._fightMiPassList[_loc1_].removeEventListener("click",this.onMiPass);
            _loc1_++;
         }
         this._fightList[5].removeEventListener("click",this.onFightBigBoss);
         this._miPass.removeEventListener("click",this.onCdMiPass);
         Tick.instance.removeRender(this.timeUpdate);
