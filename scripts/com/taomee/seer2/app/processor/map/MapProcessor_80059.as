package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80059 extends MapProcessor
   {
      ...
      private var buyinfo:BuyPropInfo = new BuyPropInfo();
      ...
      private function initStone() : void
      {
         ...
         while(_loc1_ < 3)
         {
            ...
            this.stoneList[_loc1_].addEventListener("click",this.clearStone);
            _loc1_++;
         }
      }
      ...
      private function clearStone(param1:MouseEvent) : void
      {
         ...
         if(this.stoneNum == 0)
         {
            SwapManager.swapItem(1969,1,function():void
            {
               currentEvent = 0;
               updateSeat();
            },this.errorHandler);
      ...
      {
         DayLimitManager.getDoCount(828,this.getFreeNum);
      }
      ...
      private function getFreeNum(param1:uint) : void
      {
         ...
         ActiveCountManager.requestActiveCountList([203264,203265,203266],this.getData);
      }
      ...
      {
         super.dispose();
         this.buyActionBtn.removeEventListener("click",this.buyAction);
         this.goBtn.removeEventListener("click",this.getRandom);
         ...
         this.exitBtn.removeEventListener("click",this.to70);
      }
      
      private function initEvent() : void
      {
         this.buyActionBtn.addEventListener("click",this.buyAction);
         this.goBtn.addEventListener("click",this.getRandom);
         ...
         this.exitBtn.addEventListener("click",this.to70);
      }
      ...
      protected function getRandom(param1:MouseEvent) : void
      {
         ...
         if(_loc2_ % 5 == 0 && _loc2_ != 25)
         {
            ...
            Connection.send(CommandSet.RANDOM_EVENT_1140,63,0);
         }
         else if(_loc2_ < 25)
         {
            Connection.addCommandListener(CommandSet.RANDOM_EVENT_1140,this.onRandomNormal);
            Connection.send(CommandSet.RANDOM_EVENT_1140,62,0);
         }
         if(_loc2_ == 25)
         {
            ModuleManager.toggleModule(URLUtil.getAppModule("TianlongFinalBossPanel"));
         }
      }
