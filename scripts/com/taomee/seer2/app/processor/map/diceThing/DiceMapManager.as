package com.taomee.seer2.app.processor.map.diceThing
{
   ...
   public class DiceMapManager
   {
      ...
      private static var _instance:DiceMapManager;
      ...
      public static function getInstance() : DiceMapManager
      {
         if(!_instance)
         {
            _instance = new DiceMapManager(new instancs());
         }
         return _instance;
      }
      ...
      public function dispose(param1:SceneEvent) : void
      {
         ...
         if(this.swapNpc)
         {
            this.swapNpc.removeEventListener("click",this.toSwap);
         }
         ...
         ModuleManager.removeEventListener("DiceCompletePanel","dispose",this.resetData);
         this.diceResult = 0;
         this.roleMobileID = 0;
      ...
      private function initUI() : void
      {
         ...
         this.swapNpc.addEventListener("click",this.toSwap);
      ...
      private function toSwap(param1:MouseEvent) : void
      {
         ...
         ModuleManager.addEventListener("DiceStarSwapPanel","dispose",this.onDispose);
      }
      
      private function onDispose(param1:ModuleEvent) : void
      {
         ModuleManager.removeEventListener("DiceStarSwapPanel","dispose",this.onDispose);
         this.requestItem();
      }
      ...
      private function checkThing() : void
      {
         ...
         var _loc3_:* = null;
         var _loc2_:DiceThingInfo = null;
         var _loc5_:String = null;
         var _loc4_:Class = null;
         var _loc1_:int = 0;
         var _loc7_:DiceMapTileInfo = this.tileVec[this.currentTileSeat];
         if(_loc7_.thingType != "empty")
         {
            _loc6_ = _loc7_.thingType + _loc7_.thingId;
            if(_loc7_.thingId == "random")
            {
               _loc1_ = Math.random() * this.tileVec[this.currentTileSeat].thingNum;
               _loc6_ = _loc7_.thingType + _loc1_;
            }
            _loc9_ = "com.taomee.seer2.app.processor.map.diceThing.";
            _loc8_ = _loc7_.thingType;
            if(_loc7_.thingType == "addMoney" || _loc7_.thingType == "subMoney")
            {
               _loc8_ = "money";
            }
            _loc3_ = _loc8_ + ".";
            _loc2_ = DiceMapThingConfig.thingMap.getValue(_loc6_) as DiceThingInfo;
            _loc2_.currentSeat = this.currentTileSeat;
            _loc5_ = _loc2_.className;
            _loc4_ = DomainUtil.getCurrentDomainClass(_loc9_ + _loc3_ + _loc5_);
            this.currentThing = new _loc4_(_loc2_);
      ...
      private function getLimit(param1:MessageEvent) : void
      {
         ...
         ModuleManager.addEventListener("DiceCompletePanel","dispose",this.resetData);
      }
