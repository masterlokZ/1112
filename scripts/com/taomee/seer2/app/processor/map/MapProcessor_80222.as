package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80222 extends MapProcessor
   {
      ...
      {
         if(SceneManager.prevSceneType == 2 && FIGHT_LIST.indexOf(FightManager.currentFightRecord.initData.positionIndex) != -1)
         {
      ...
      private function initAct() : void
      {
         ...
         this._buyItem.addEventListener("click",this.onBuyItem);
         this.createNpc();
      }
      ...
      private function onActDispose() : void
      {
         ...
         if(this._buyItem)
         {
            this._buyItem.removeEventListener("click",this.onBuyItem);
            this._buyItem = null;
         }
      }
      ...
      private function createNpc() : void
      {
         if(!this._npc)
         {
            ...
            this._npc.resourceUrl = URLUtil.getNpcSwf(764);
      ...
      private function startFight() : void
      {
         DayLimitListManager.getDaylimitList(DAY_LIST,function(param1:DayLimitListInfo):void
         {
            ...
            ActiveCountManager.requestActiveCountList(FOR_LIST,function(param1:Parser_1142):void
            {
               ...
               var _fightNum:int = ActsHelperUtil.getCanNum(info.getCount(DAY_LIST[0]),par.infoVec[1],1);
               _curIndex = 0;
               var i:int = 0;
               while(i < 6)
               {
               ...
               if(_fightNum > 0)
               {
                  NpcDialog.show(764,"万劫魔尊",[[0,"         哪里来的小毛贼！不想活了吗？今天你有<font color=\'#FF0000\'>" + _fightNum + "</font>次挑战我的机会！"]],["挑战吧！","准备一下"],[function():void
                  {
               ...
               {
                  NpcDialog.show(764,"万劫魔尊",[[0,"         你已经没有机会了！明天再来找我挑战吧！"]],["通过星钻继续挑战"," 明天再说吧"],[function():void
                  {
