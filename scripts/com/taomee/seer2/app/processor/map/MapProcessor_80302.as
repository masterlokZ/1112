package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80302 extends MapProcessor
   {
      ...
      private var _dayLimit:Array = [1309,1310,1311];
      
      private var _foreverLimit:Array = [204652,204653,204655];
      
      private var _idxBuff:int = 0;
      
      private var _isUseBuff:Boolean;
      
      private var _fight2ID:Array = [1200];
      ...
      override public function init() : void
      {
         ...
         this._canChooseBtn.addEventListener("click",this.onChoose);
         this._skipWaitBtn.addEventListener("click",this.onSkip);
         this._itemShop.addEventListener("click",this.onItemShop);
         this._okBtn.addEventListener("click",this.onCloseTips);
         this._closeBtn.addEventListener("click",this.onCloseTips);
      ...
      private function checkStatues() : void
      {
         DayLimitListManager.getDaylimitList(this._dayLimit,function(param1:DayLimitListInfo):void
         {
            ...
            ActiveCountManager.requestActiveCountList(_foreverLimit,function(param1:Parser_1142):void
            {
               ...
               _isUseBuff = BitUtil.getBit(param1.infoVec[1],0);
      ...
      {
         --this._leftTime;
         var _loc1_:int = 100 - 100 * this._leftTime / 300;
