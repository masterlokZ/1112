package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_10372 extends MapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         ActsHelperUtil.firstPlayFullScreen(258,"xiaNaGame/XiaNaFullScenePlay",true,1,function():void
         {
         },function():void
         {
         });
         ...
         this._telPointMc.addEventListener("click",this.onClick);
         this._helpBtn.addEventListener("click",this.onClick);
      ...
      private function onClick(param1:MouseEvent) : void
      {
         ...
         switch(param1.currentTarget)
         {
            ...
            case this._telPointMc:
               ...
               SceneManager.changeScene(1,_preScene);
         }
      }
