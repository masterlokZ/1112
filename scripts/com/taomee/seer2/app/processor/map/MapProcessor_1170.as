package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_1170 extends MapProcessor
   {
      ...
      override public function init() : void
      {
         ...
         this._introduction.addEventListener("click",this.onIntroduction);
         this._yitePvp = _map.content["yitePvp"];
         this._yitePvp.addEventListener("click",this.onYitePvp);
         DialogPanel.addEventListener("dialogShow",this.onActorArriveShow);
      }
      ...
      private function onActorArriveShow(param1:DialogPanelEvent) : void
      {
         ...
         if(e.content == 151)
         {
            ...
            if(MysteryNpcYiTeManager.isActivityON)
            {
               ...
               if(!a)
               {
                  unit1 = new CustomUnit("active","小道消息","151");
                  DialogPanel.functionalityBox.addUnit(unit1);
               }
               if(!b)
               {
                  unit2 = new CustomUnit("active","活动规则","guize");
               ...
               NpcDialog.show(151,"包打听",[[0,"嘿嘿，如果你感兴趣的话可以给我5000赛尔豆，我就告诉你此时此刻他在哪里。你得赶快去，不然他要逃走了。"]],["花费5000赛尔豆打听消息"," 还是算了"],[function():void
               {
                  ...
                  if(ActorManager.actorInfo.coins >= 5000)
                  {
                     SwapManager.swapItem(1155,1,function(param1:IDataInput):void
                     {
                        ...
                        var _loc4_:* = MysteryNpcYiTeManager.currentYiTeMapId;
                        var _loc6_:* = new Date(TimeManager.getServerTime() * 1000);
                        var _loc5_:int = _loc6_.minutes / 15;
                        var _loc3_:* = 14 + _loc5_ * 15 - _loc6_.minutes;
                        _loc2_ = {};
                        _loc2_.mapid = _loc4_;
                        _loc2_.leftTime = _loc3_;
                        ModuleManager.showModule(URLUtil.getAppModule("MysteryBaodating"),"",_loc2_);
                     });
                  }
                  else
                  {
      ...
      private function clickYiTe(param1:MouseEvent) : void
      {
         ...
         {
            NpcDialog.show(183,"颁奖嘉宾",[[0,"耶？你没有参加过比赛"]],["打搅两位伊特老大了，闪！"],[null]);
         }
         else
         {
            ...
            OnlyFlagManager.RequestFlag(function():void
            {
               ...
               if(OnlyFlagManager.getFlag(onlyNum) == 1)
               {
                  ...
                  NpcDialog.show(183,"颁奖嘉宾",[[0,"耶？奖品已经领过了。"]],["打搅两位伊特老大了，闪！"],[null]);
               }
               else
               {
                  ...
                  NpcDialog.show(183,"颁奖嘉宾",[[0,diag]],["我要领奖!","想一下获奖感言再领."],[function():void
                  {
                     var teamID:*;
                     var ranknum:*;
                     var award:* = undefined;
                     ...
                     NpcDialog.show(183,"颁奖嘉宾",[[0,award]],["奖品超赞的！给我给我都给我！"],[function():void
                     {
