package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80312 extends MapProcessor
   {
      ...
      private var dayLimit:Array = [1339,1350];
      ...
      private var RES_ID:Array = [450,558,643];
      
      private var fightFirstID:Array = [1221,1222,1223];
      ...
      override public function init() : void
      {
         ...
         this.checkStatues();
         SceneManager.addEventListener("switchComplete",this.onSwitchMap);
      }
         ...
         if(SceneManager.prevSceneType == 2)
         {
            if(this.fightFirstID.indexOf(FightManager.currentFightRecord.initData.positionIndex) != -1)
            {
               if(this._par == 1)
               {
                  ...
                  SceneManager.removeEventListener("switchComplete",this.onSwitchMap);
               }
            }
         }
      }
      ...
      private function createMonster() : void
      {
         ...
         while(_loc1_ < 3)
         {
            ...
            MobileManager.addMobile(this._monsterList[_loc1_],"spawnedPet");
            _loc1_++;
         }
      }
      ...
      {
         --this._leftTime;
         var _loc1_:String = DateUtil.getMS(this._leftTime);
