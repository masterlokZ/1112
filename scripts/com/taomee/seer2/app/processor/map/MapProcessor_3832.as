package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_3832 extends MapProcessor
   {
      ...
      private function getStartAndEndTime() : Vector.<uint>
      {
         ...
         var _loc5_:Date = new Date(TimeManager.getPrecisionServerTime() * 1000);
         var _loc4_:uint = _loc5_.getTime() / 1000;
         var _loc7_:int = int(_loc5_.day == 0 ? 7 : int(_loc5_.day));
         var _loc6_:uint = (_loc7_ - 1) * 86400 + _loc5_.hours * 3600 + _loc5_.minutes * 60 + _loc5_.minutes + 600;
         _loc2_ = uint(_loc4_ - _loc6_);
         var _loc1_:uint = uint(_loc2_ - 604800 + 700);
         _loc3_ = Vector.<uint>([]);
         _loc3_.push(_loc1_);
         _loc3_.push(_loc2_);
         return _loc3_;
      ...
      override public function init() : void
      {
         ...
         _map.content["mc0"].addEventListener("click",this.onClick);
      ...
      private function getRankVal(param1:uint, param2:Vector.<uint>, param3:Function = null) : void
      {
         ...
         RankManager.getBeforeRank(rankType,(function():*
         {
            var getRank:Function;
            return getRank = function(param1:Parser_1521):void
            {
               if(callBack != null)
               {
      ...
      private function onGetDetailInfo(param1:MessageEvent) : void
      {
         ...
         UserInfoParseHelper.parseUserDetailInfo(_loc3_,_loc2_);
