package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80234 extends MapProcessor
   {
      ...
      private static const request_limit:Array = [204496,204498,204505,204497,204499,204500,204501,204502,204503,204504];
      ...
      private var butIDarr:Array = [604048,604049,604050,604051,604052,604063];
      ...
      private function initMc() : void
      {
         ...
         this.goodsBtn.addEventListener("click",this.onClick);
         this.oneKeyPass.addEventListener("click",this.onClick);
      }
      ...
      private function buyComplete(param1:Parser_1224) : void
      {
         ...
         ActiveCountManager.requestActiveCountList(request_limit,function(param1:Parser_1142):void
         {
            ...
            {
               SceneManager.changeScene(9,80233);
            }
         });
      }
      ...
      private function requestLimit() : void
      {
         ActiveCountManager.requestActiveCountList(request_limit,function(param1:Parser_1142):void
         {
            ...
            if(next_time > TimeManager.getServerTime())
            {
               ...
               {
                  SceneManager.changeScene(1,80233);
               });
               return;
            }
            b = true;
            ...
            if(b)
            {
               SwapManager.swapItem(3025,1,function(param1:IDataInput):void
               {
                  requestData();
               });
               return;
      ...
      private function updateTips() : void
      {
         ...
         if(this.currentWaveMonster == _loc2_)
         {
      ...
      private function updateMonsters() : void
      {
         ...
         while(_loc1_ < this.currentMonsterIds.length)
         {
            ...
            if(this.currentMonsterIds[_loc1_] != 0)
            {
               ...
               this.mobile_list[_loc1_].addEventListener("click",this.toFight);
               this.mobile_list[_loc1_].setPostion(Positions[_loc1_]);
               MobileManager.addMobile(this.mobile_list[_loc1_],"npc");
            }
            _loc1_++;
         }
      }
      ...
      {
         var _loc3_:int = int(this.mobile_list.indexOf(param1.currentTarget as Mobile));
         var _loc5_:int = int(this.currentMonsterIds[_loc3_]);
         var _loc4_:int = int(ALL_MONSTERS.indexOf(_loc5_));
         var _loc2_:int = int(FIGHT_ID[_loc4_]);
      ...
      override public function dispose() : void
      {
         ...
         if(Boolean(this.mobile_list) && this.mobile_list.length > 0)
         {
            ...
            {
               (this.mobile_list[_loc1_] as Mobile).removeEventListener("click",this.toFight);
               MobileManager.removeMobile(this.mobile_list[_loc1_],"npc");
               _loc1_++;
            }
         ...
         this.goodsBtn.removeEventListener("click",this.onClick);
         this.oneKeyPass.removeEventListener("click",this.onClick);
      }
   }
}
