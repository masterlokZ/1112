package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80146 extends MapProcessor
   {
      ...
      private function createNpc() : void
      {
         ...
         this.bossNpc.x = 545;
         this.bossNpc.y = 430;
         this.bossNpc.addEventListener("click",this.toFight);
         MobileManager.addMobile(this.bossNpc,"npc");
      }
      ...
      {
         NpcDialog.show(710,"约瑟",[[0,"与奎尔斯的那场大战给阿卡迪亚留下了永恒的疤痕，正义需要勇气和力量！"]],["直接挑战！","了解规则","离开"],[function():void
         {
            ModuleManager.showAppModule("FightYueSeWangPanel");
         },function():void
         {
            NpcDialog.show(710,"约瑟",[[0,"我会抽取一些系别出来，你必须具有对应的王魄才能携带这些系别的精灵参战！"]],["只能携带我拥有王魄的系别吗？"],[function():void
            {
               NpcDialog.show(710,"约瑟",[[0,"然后我会抽选出3只灵兽，只要你拥有我选中的灵兽，它就可以不作为你的对手！你准备好了吗？"]],["我有备而来","算了！我再练练吧！"],[function():void
               {
                  ModuleManager.showAppModule("FightYueSeWangPanel");
               }]);
            }]);
      ...
      private function checkIsInTime() : Boolean
      {
         ...
         var _loc4_:int = _loc5_.fullYear;
         var _loc7_:int = _loc5_.month;
         var _loc6_:int = _loc5_.date;
         var _loc2_:int = _loc5_.hours;
         var _loc1_:int = _loc5_.minutes;
         _loc3_ = _loc4_ == 2014 && _loc7_ == 9 && _loc6_ == 1;
         if(_loc3_)
         {
            return true;
         }
      ...
      {
         NpcDialog.show(711,"约瑟",[[0,"看来你通过了灵兽们的考验！接下来你的对手将是我！做好准备了吗？"]],["准备好了","离开一会"],[function():void
         {
            var index:* = undefined;
      ...
      private function canFight() : Boolean
      {
         ...
         while(_loc3_ < _loc1_)
         {
            _loc4_ = int(this.PET_TYPE.indexOf(_loc2_[_loc3_].type));
            if(_loc4_ == -1)
            {
               AlertManager.showAlert("你不能携带" + PetTypeNameMap.getTypeName(_loc2_[_loc3_].type) + "系的精灵去战斗!");
               return false;
            }
            if(!BitUtil.getBit(this.warPo,_loc4_))
            {
               AlertManager.showAlert("你不能携带" + PetTypeNameMap.getTypeName(_loc2_[_loc3_].type) + "系的精灵去战斗!");
               return false;
            }
