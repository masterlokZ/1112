package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80317 extends MapProcessor
   {
      ...
      private var fightID:Array = [1272];
      
      private var foreverLimit:Array = [204820,204821,204822,204823];
      
      private var dayLimit:int = 1359;
      
      private var fightSixID:Array = [1239,1240,1241,1242,1243,1244];
      ...
      {
         QueueLoader.load(URLUtil.getActivityAnimation("huanlingshouAct/huanlingshouAct"),"swf",function(param1:ContentInfo):void
         {
      ...
      private function initMc() : void
      {
         ...
         {
            ServerBufferManager.getServerBuffer(269,function(param1:ServerBuffer):void
            {
               var server:ServerBuffer = param1;
               var _isPlay:Boolean = Boolean(server.readDataAtPostion(1));
               if(!_isPlay)
               {
                  ServerBufferManager.updateServerBuffer(269,1,1);
      ...
      private function addEvent() : void
      {
         ...
         this.hasEvent = true;
         this.oneKeyPass.addEventListener("click",this.onOneKeyFire);
         this.fireDream.addEventListener("click",this.onFireDream);
      }
      ...
      {
         this.hasEvent = false;
         this.oneKeyPass.removeEventListener("click",this.onOneKeyFire);
         this.fireDream.removeEventListener("click",this.onFireDream);
      }
      ...
      private function onFireDream(param1:MouseEvent) : void
      {
         ...
         else if((e.target as MovieClip).currentFrame == 2)
         {
            ...
            {
               SceneManager.changeScene(9,80318);
            });
         }
      }
      ...
      private function firstPlayFullScreen(param1:Function = null) : void
      {
         ...
         ServerBufferManager.getServerBuffer(268,function(param1:ServerBuffer):void
         {
            var _loc2_:Boolean = Boolean(param1.readDataAtPostion(1));
            if(!_loc2_)
            {
               ServerBufferManager.updateServerBuffer(268,1,1);
      ...
      {
         var e:MouseEvent = param1;
         MobileManager.removeMobile(this.godLight,"npc");
      ...
      private function createNpc() : void
      {
         if(!this._npc)
         {
            ...
            this._npc.addEventListener("click",this.dialogShow1);
      ...
      private function createLight() : void
      {
         if(!this.godLight)
         {
            ...
            MobileManager.addMobile(this.godLight,"npc");
            this.godLight.addEventListener("click",this.showGodLight);
