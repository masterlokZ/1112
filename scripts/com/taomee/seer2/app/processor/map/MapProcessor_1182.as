package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_1182 extends MapProcessor
   {
      ...
      {
         super.init();
         _map.content["shifeng"].addEventListener("click",this.onShifengClick);
      }
      
      override public function dispose() : void
      {
         _map.content["shifeng"].removeEventListener("click",this.onShifengClick);
         super.dispose();
      }
      ...
      private function exchangeWenzhang() : void
      {
         ...
         {
            SwapManager.swapItem(4625,1,(function():*
            {
