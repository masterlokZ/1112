package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_1500 extends MapProcessor
   {
      ...
      private var _dayLimit:Vector.<int> = Vector.<int>([0,0,0,0,0]);
      ...
      override public function init() : void
      {
         ...
         while(_loc1_ < 5)
         {
            _loc2_.writeUnsignedInt(LimitIds[_loc1_]);
      ...
      private function checkMobile() : void
      {
         ...
         if(_loc2_)
         {
            if(SceneManager.prevSceneType == 2 && FightIds.indexOf(FightManager.currentFightRecord.initData.positionIndex) != -1)
            {
      ...
      private function showYueBeast() : void
      {
         ...
         this._mobiles[4].addEventListener("click",this.toFight);
         this._mobiles[4].setPostion(Positions[4]);
         MobileManager.addMobile(this._mobiles[4],"npc");
      }
      ...
      private function toFight(param1:MouseEvent) : void
      {
         ...
         index = int(this._mobiles.indexOf(e.currentTarget as Mobile));
         if(index != 4)
         {
      ...
      override public function dispose() : void
      {
         ...
         while(_loc1_ < 5)
         {
            this._mobiles[_loc1_].removeEventListener("click",this.toFight);
            _loc1_++;
         }
         super.dispose();
      }
