package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80349 extends MapProcessor
   {
      ...
      private function onActInit() : void
      {
         ...
         this.initEvent();
         this.update();
         if(SceneManager.prevSceneType == 2 && FightManager.fightWinnerSide == 2 && FightManager.currentFightRecord.initData.positionIndex == FIGHT_INDEX_LIST[0])
         {
      ...
      private function update() : void
      {
         this.updateData(function():void
         {
            ServerBufferManager.getServerBuffer(268,function(param1:ServerBuffer):void
            {
               ...
               if(!_isPlay)
               {
                  ServerBufferManager.updateServerBuffer(268,2,1);
      ...
      {
         var evt:MouseEvent = param1;
         var canFightNum:int = ActsHelperUtil.getCanNum(this._info.getCount(DAY_LIST[0]),this._par.infoVec[0],1);
      ...
      private function getBarStateHandle() : void
      {
         ...
         this._fightNum.text = ActsHelperUtil.getCanNum(this._info.getCount(DAY_LIST[0]),this._par.infoVec[0],1).toString();
      }
