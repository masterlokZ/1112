package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80090 extends MapProcessor
   {
      ...
      private function huoKeNuErSuperProcessActInit() : void
      {
         ...
         {
            DayLimitManager.getDoCount(893,function(param1:int):void
            {
               var val:int = param1;
               ActiveCountManager.requestActiveCount(203483,function(param1:uint, param2:uint):void
               {
      ...
      private function getURL(param1:Function = null) : void
      {
         ...
         QueueLoader.load(URLUtil.getActivityAnimation("huoKeNuErSuperProcess"),"swf",function(param1:ContentInfo):void
         {
      ...
      {
         ServerBufferManager.getServerBuffer(173,function(param1:ServerBuffer):void
         {
            var server:ServerBuffer = param1;
            var _isPlay:Boolean = Boolean(server.readDataAtPostion(1));
            if(!_isPlay)
            {
               ServerBufferManager.updateServerBuffer(173,1,1);
      ...
      private function onNpcClick(param1:MouseEvent) : void
      {
         ...
         index = int(this._npcList.indexOf(evt.currentTarget as Mobile));
