package com.taomee.seer2.app.processor.map
{
   ...
   public class MapProcessor_80335 extends MapProcessor
   {
      ...
      {
         this.onActInit();
         QueueLoader.load(URLUtil.getActivityAnimation("QingHolyPetProcessAct"),"swf",function(param1:ContentInfo):void
         {
      ...
      private function initEvent() : void
      {
         ...
         this._miPass.addEventListener("click",this.onOneBossMiPass);
         this._exitBtn.addEventListener("click",this.onTwoBossExit);
         this._goFight.addEventListener("click",this.onGoFight);
         for each(_loc1_ in this._getAwardList)
         {
            _loc1_.addEventListener("click",this.onGetAward);
         }
         this._randomBtn.addEventListener("click",this.onRandomBtn);
         this._miIcePass.addEventListener("click",this.onMiIcePass);
         this._luckRandomBtn.addEventListener("click",this.onLuckRandomBtn);
      }
      
      private function clearEvent() : void
      {
         var _loc1_:SimpleButton = null;
         this._miPass.removeEventListener("click",this.onOneBossMiPass);
         this._exitBtn.removeEventListener("click",this.onTwoBossExit);
         this._goFight.removeEventListener("click",this.onGoFight);
         for each(_loc1_ in this._getAwardList)
         {
            _loc1_.removeEventListener("click",this.onGetAward);
         }
         this._randomBtn.removeEventListener("click",this.onRandomBtn);
         this._miIcePass.removeEventListener("click",this.onMiIcePass);
         this._luckRandomBtn.removeEventListener("click",this.onLuckRandomBtn);
      ...
      {
         var evt:MouseEvent = param1;
         var index:int = int(this._getAwardList.indexOf(evt.currentTarget as SimpleButton));
      ...
      {
         SceneManager.changeScene(9,80336);
      }
      ...
      private function stateOneHandle() : void
      {
         ...
         if(_chacheDate[0] == 1)
         {
            ...
            this._npc0.addEventListener("click",this.onNpc0HandleTwo);
         }
         else
         {
            ...
            MovieClipUtil.playMc(_scenMc,2,_scenMc.totalFrames,function():void
            {
               ...
               _npc0.addEventListener("click",onNpc0HandleOne);
            },true);
         }
      }
      ...
      private function removeNpc0HandleOne() : void
      {
         if(this._npc0)
         {
            this._npc0.removeEventListener("click",this.onNpc0HandleOne);
            this._npc0.removeEventListener("click",this.onNpc0HandleTwo);
      ...
      private function playBeatOkAnim(param1:MovieClip) : void
      {
         ...
         MovieClipUtil.playMc(anima,2,anima.totalFrames,function():void
         {
            ...
            _npc0.addEventListener("click",onNpc0HandleTwo);
         },true);
      }
      ...
      private function updateBlood(param1:MovieClip) : void
      {
         if(param1)
         {
            (param1["bloodShow"]["bar"] as MovieClip).scaleX = param1.curBlood / 20;
         }
      }
      ...
      private function stateTwoHandle() : void
      {
         ...
         ServerBufferManager.getServerBuffer(280,function(param1:ServerBuffer):void
         {
            var _scenMc:MovieClip = null;
            ...
            if(!_isPlay)
            {
               ServerBufferManager.updateServerBuffer(280,1,1);
      ...
      private function iceStateHandle() : void
      {
         ...
         if(SceneManager.prevSceneType == 2)
         {
            ...
            index = int(FIGHT_INDEX_LIST.indexOf(fightId));
            i = 0;
            if(index >= 0 && index <= 6)
            {
               if(FightManager.fightWinnerSide == 2)
               {
