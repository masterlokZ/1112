package com.taomee.seer2.app.animationInteractive
{
   ...
   public class Interactive_16 extends BaseAniamationInteractive
   {
      ...
      override protected function paramAnimation() : void
      {
         ...
         while(_loc2_ < 5)
         {
            this._thisMCVec.push(_animation["thisMC" + _loc2_]);
            this._mcVec.push(_animation["mc" + _loc2_]);
            _loc2_++;
         }
      ...
      private function initEventListener() : void
      {
         ...
         for each(_loc1_ in this._thisMCVec)
         {
            ...
            _loc1_.addEventListener("mouseDown",this.onMouseDown);
            _loc1_.addEventListener("mouseUp",this.onMouseUp);
         }
      }
      ...
      private function disposeEventListener() : void
      {
         ...
         for each(_loc1_ in this._thisMCVec)
         {
            ...
            _loc1_.mouseChildren = false;
            _loc1_.mouseEnabled = false;
            _loc1_.removeEventListener("mouseDown",this.onMouseDown);
            _loc1_.removeEventListener("mouseUp",this.onMouseUp);
         }
      }
      ...
      private function cheakTestObj() : void
      {
         ...
         selectIndex = int(this._thisMCVec.indexOf(this._selectMC));
