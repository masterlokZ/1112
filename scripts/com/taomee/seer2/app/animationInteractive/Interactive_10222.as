   ...
   public class Interactive_10222 extends BaseAniamationInteractive
   {
      ...
      override protected function paramAnimation() : void
      {
         ...
         while(_loc1_ < 5)
         {
            ...
            this._mc1List[_loc1_].addEventListener("click",this.onMC1);
            this._mc2List.push(_animation["mc2_" + _loc1_]);
            this._mc2List[_loc1_].addEventListener("click",this.onMC2);
      ...
      private function onMC1(param1:MouseEvent) : void
      {
         ...
         var _loc2_:int = int(this._mc1List.indexOf(param1.currentTarget as MovieClip));
         if(_loc2_ != -1)
         {
            _loc3_ = param1.currentTarget as MovieClip;
            _loc3_.removeEventListener("click",this.onMC1);
      ...
      {
         var _loc3_:MovieClip = null;
         var _loc2_:int = int(this._mc2List.indexOf(param1.currentTarget as MovieClip));
         if(_loc2_ != -1)
         {
            _loc3_ = param1.currentTarget as MovieClip;
            _loc3_.removeEventListener("click",this.onMC2);
            this._mc1Play[_loc2_].visible = true;
            this._mc2Play[_loc2_].visible = true;
            this.checkWin();
         }
      ...
      private function checkWin() : void
      {
         ...
         for each(_loc1_ in this._mc1Play)
         {
