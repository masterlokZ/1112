package com.taomee.seer2.app.animationInteractive
{
   ...
   public class StoneInteractive extends BaseAniamationInteractive
   {
      ...
      private function addMouseClick() : void
      {
         ...
         {
            _loc1_.addEventListener("click",this.onStoneClick);
      ...
      private function onStoneClick(param1:MouseEvent) : void
      {
         ...
         this._stoneMC.addEventListener("enterFrame",this.onStoneEnterFrame);
      }
      ...
      private function addPitMouseClick() : void
      {
         ...
         {
            _loc1_.addEventListener("click",this.onPitClick);
            _loc1_.buttonMode = true;
         }
      }
      ...
      private function onPitClick(param1:MouseEvent) : void
      {
         ...
         var _loc4_:int = int(this._stonePitVec.indexOf(_loc2_));
         _loc3_ = int(this._stoneVec.indexOf(this._stoneMC));
         if(_loc4_ == _loc3_)
         {
            this._stoneMC.x = _loc2_.x;
            this._stoneMC.y = _loc2_.y;
            this.removePitMouseClick();
            this._stonePitVec.splice(_loc3_,1);
            this._stoneVec.splice(_loc3_,1);
            this.addMouseClick();
         }
         else
         {
         ...
         this._stoneMC.removeEventListener("enterFrame",this.onStoneEnterFrame);
      ...
      private function removeMouseClick() : void
      {
         ...
         for each(_loc1_ in this._stoneVec)
         {
            _loc1_.removeEventListener("click",this.onStoneClick);
         }
      }
      ...
      private function removePitMouseClick() : void
      {
         ...
         for each(_loc1_ in this._stonePitVec)
         {
            _loc1_.removeEventListener("click",this.onPitClick);
