   ...
   public class Interactive_10015 extends BaseAniamationInteractive
   {
      ...
      private function initEvent() : void
      {
         ...
         for each(_loc1_ in this._mcVec)
         {
            ...
            _loc1_.addEventListener("click",this.onClick);
         }
         this._restBtn.addEventListener("click",this.onRest);
      }
      ...
      private function removeEvent() : void
      {
         ...
         for each(_loc1_ in this._mcVec)
         {
            ...
            _loc1_.removeEventListener("click",this.onClick);
         }
         this._restBtn.removeEventListener("click",this.onRest);
      }
      ...
      private function noWin(param1:MovieClip) : void
      {
         ...
         MovieClipUtil.playMc(this._bag,153,this._bag.totalFrames,function():void
         {
            ...
            openBtn(true);
            _restBtn.addEventListener("click",onRest);
         },true);
      }
