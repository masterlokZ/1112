package com.taomee.seer2.app.activity.processor.grassBlade
{
   ...
   public class ActivityMapHandler_100 extends GrassBladeMapHandler
   {
      ...
      {
         var _loc2_:XML = <npc id="37" resId="37" name="民兵安德鲁" dir="1" width="25" height="80" pos="570,270"
         ...
         var _loc1_:XML = <npc id="38" resId="38" name="民兵安德烈" dir="1" width="25" height="80" pos="430,450"
         ...
         this._npc37Definition = new NpcDefinition(_loc2_);
         this._npc38Definition = new NpcDefinition(_loc1_);
      ...
      private function removeMapNpc() : void
      {
         if(this._npc37)
         {
            MobileManager.removeMobileById(this._npc37.id,"npc");
         }
         this._npc37 = null;
         this._npc37Definition = null;
         if(this._npc38)
         {
            MobileManager.removeMobileById(this._npc38.id,"npc");
         }
         this._npc38 = null;
