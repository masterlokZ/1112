package com.taomee.seer2.app.activity.processor.grassBlade
{
   ...
   public class ActivityMapHandler_101 extends GrassBladeMapHandler
   {
      ...
      {
         if(this._currentBossId == 1)
         {
            this.showFirstPhaseAnimation();
         }
         else if(this._currentBossId == 2)
         {
            this.showSecondPhaseAnimation();
         }
         else if(this._currentBossId == 3)
         {
      ...
      private function onGetActiveCount(param1:uint, param2:uint) : void
      {
         ...
         this.processsLayout();
         this.processNpc();
         if(this._count <= 3 && this._count > 0 && SceneManager.prevSceneType == 2 && FightManager.fightWinnerSide == 1 && _fightIndex == 1)
         {
      ...
      private function initNpcDefinition() : XML
      {
         ...
         if(this._count == 1)
         {
            _loc1_ = <npc id="15" resId="15" name="巴卢特" dir="1" width="25" height="150" pos="680,360" actorPos="670,400" path=""><dialog npcId="15" npcName="巴卢特" transport="1,300,400"><branch id="default"><node emotion="0"><![CDATA[你以为自己很强了吗？，我的青蜂可不是这么容易对付的！]]></node><reply action="close" params="3"><![CDATA[谁怕谁啊]]></reply><reply action="close"><![CDATA[你等着，我马上回来！]]></reply></branch></dialog><eventHandler><mouseOver><HandlerShowNpcSlogan><![CDATA[顺我者昌，逆我者亡！]]></HandlerShowNpcSlogan></mouseOver></eventHandler></npc>;
         }
         else if(this._count == 2)
         {
            _loc1_ = <npc id="15" resId="15" name="巴卢特" dir="1" width="25" height="150" pos="680,360" actorPos="670,400" path=""><dialog npcId="15" npcName="巴卢特" transport="1,300,400"><branch id="default"><node emotion="0"><![CDATA[这不可能!]]></node><reply action="close" params="3"><![CDATA[我还没热身呢]]></reply><reply action="close"><![CDATA[你等着，我马上回来！]]></reply></branch></dialog><eventHandler><mouseOver><HandlerShowNpcSlogan><![CDATA[顺我者昌，逆我者亡！]]></HandlerShowNpcSlogan></mouseOver></eventHandler></npc>;
         }
         else if(this._count == 3)
         {
            _loc1_ = <npc id="15" resId="15" name="巴卢特" dir="1" width="25" height="150" pos="680,360" actorPos="670,400" path=""><dialog npcId="15" npcName="巴卢特" transport="1,300,400"><branch id="default"><node emotion="0"><![CDATA[这样软弱的精灵我不配跟随我！哼！]]></node><reply action="close"  params="award"><![CDATA[回收青蜂]]></reply></branch></dialog><eventHandler><mouseOver><HandlerShowNpcSlogan><![CDATA[顺我者昌，逆我者亡！]]></HandlerShowNpcSlogan></mouseOver></eventHandler></npc>;
         }
         else
         {
            _loc1_ = <npc id="15" resId="15" name="巴卢特" dir="1" width="25" height="150" pos="680,360" actorPos="670,400" path=""><dialog npcId="15" npcName="巴卢特" transport="1,300,400"><branch id="default"><node emotion="0"><![CDATA[没有任何事物可以阻止我完成任务！你也一样！]]></node><reply action="close" params="3"><![CDATA[我一定会阻止你的！]]></reply><reply action="close"><![CDATA[你等着，我马上回来！]]></reply></branch></dialog><eventHandler><mouseOver><HandlerShowNpcSlogan><![CDATA[顺我者昌，逆我者亡！]]></HandlerShowNpcSlogan></mouseOver></eventHandler></npc>;
         }
         return _loc1_;
      }
      ...
      private function onTeamLeaderDialogClosed(param1:DialogCloseEvent) : void
      {
         ...
         if(_loc2_ == (3).toString())
         {
            _fightIndex = 1;
            FightManager.startFightWithActivityBoss(3);
         }
