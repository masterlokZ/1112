package com.taomee.seer2.app.activity.processor
{
   ...
   public class ActivityMapHandler
   {
      ...
      private function getCurrentTimeVec() : void
      {
         ...
         {
            _loc2_ = ActivityConfig.getActivityById(this._activityProcessor.getActivityID()).getPhaseTimeVec(_loc3_);
         }
         var _loc5_:uint = 0;
      ...
      protected function playActivityAnimation(param1:String = null) : void
      {
         ...
         this._activityAnimation.addEventListener("close",this.onActivityAnimationClose);
      ...
      {
         this._activityAnimation.removeEventListener("close",this.onActivityAnimationClose);
