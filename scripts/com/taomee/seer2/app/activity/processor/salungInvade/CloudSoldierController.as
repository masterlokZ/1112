package com.taomee.seer2.app.activity.processor.salungInvade
{
   ...
   public class CloudSoldierController extends SalungSoldierBase
   {
      ...
      override protected function initUI() : void
      {
         ...
         SceneManager.addEventListener("switchComplete",this.removeMc);
         this.playMc(1);
         _mc.addEventListener("click",this.clickHandler);
      }
      ...
      override public function dispose() : void
      {
         ...
         _mc.removeEventListener("click",this.clickHandler);
         SceneManager.removeEventListener("switchComplete",this.removeMc);
