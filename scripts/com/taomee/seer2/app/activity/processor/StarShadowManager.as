package com.taomee.seer2.app.activity.processor
{
   ...
   public class StarShadowManager
   {
      ...
      public static function goMap(param1:int, param2:int, param3:int, param4:int, param5:int, param6:Point, param7:Boolean = false) : void
      {
         ...
         SceneManager.changeScene(9,param1);
      ...
      {
         var _loc2_:PetDemoDisplayer = null;
         var _loc1_:IconDisplayer = null;
         var _loc3_:String = null;
         SceneManager.addEventListener("switchComplete",destoryMap);
         if(_type == 1)
         {
            _loc2_ = new PetDemoDisplayer();
            _loc2_.newSetUrl(URLUtil.getPetDemo(PetConfig.getPetDefinition(_iconId).resId));
            _icon = _loc2_;
         ...
         if(_type == 0)
         {
            ...
            _loc3_ = URLUtil.getRes("activity/icon/starShadow/" + _activityIndex + ".swf");
            _loc1_.setIconUrl(_loc3_);
            _icon = _loc1_;
            _loc1_.setBoundary(120,120);
         }
      ...
      private static function onIconClick(param1:MouseEvent) : void
      {
         ...
         NpcDialog.showDialogs(dialogs,function():void
         {
            ...
            if(_type == 0)
            {
               ...
               SwapManager.swapItem(4580,1,(function():*
               {
      ...
      {
         SceneManager.removeEventListener("switchComplete",destoryMap);
         if(_icon != null)
         {
