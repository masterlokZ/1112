package com.taomee.seer2.app.activity.processor.akadiyaPetExplore
{
   ...
   public class PetExplore2Manager
   {
      ...
      private var ss:Array = [206642,200721,200722,200723,200511,200518,200502,200505,200506,200508,200514,200564,200570,200567];
      ...
      {
         SceneManager.changeScene(9,80576);
      ...
      private static function initNpc() : void
      {
         ...
         if(_npcMv != null)
         {
            ...
            _npcMv.removeEventListener("click",onNpcClick);
            _npcMv = null;
         }
         resUrl = URLUtil.getRes("activity/animation/akadiya/proGress.swf");
         QueueLoader.load(resUrl,"swf",function(param1:ContentInfo):void
         {
         ...
         resUrl = URLUtil.getRes("activity/animation/akadiya/weiwei.swf");
         QueueLoader.load(resUrl,"swf",function(param1:ContentInfo):void
         {
            var _loc2_:* = DomainUtil.getClass("mv",param1.domain);
            _npcMv = new _loc2_();
            _npcMv.addEventListener("click",onNpcClick);
      ...
      private static function onNpcClick(param1:* = null) : void
      {
         ...
         var _loc4_:Function = _fightIndex == 0 ? chuFa : fight;
         var _loc3_:Function = chuFa1;
         if(_fightIndex == 0)
         {
            NpcDialog.showDialogs(_loc2_,_loc4_,_loc3_);
         }
         else
         {
            NpcDialog.showDialogs(_loc2_,_loc4_);
         }
      }
      ...
      private static function chuFa1() : void
      {
         NpcDialog.showDialogs(DIALOGS[1],chuFa,function():void
         {
            ...
            {
               SwapManager.swapItem(4616,1,(function():*
               {
      ...
      {
         SceneManager.removeEventListener("switchComplete",onOver);
      ...
      {
         var _loc2_:Array = [206642,200721,200722,200723,200511,200518,200502,200505,200506,200508,200514,200564,200570,200567];
         var _loc1_:int = 0;
         while(_loc1_ < _loc2_.length)
         {
            if(ItemManager.getItemQuantityByReferenceId(_loc2_[_loc1_]) > 1)
            {
               return 1;
            }
            _loc1_++;
