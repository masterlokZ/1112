package com.taomee.seer2.app.activity.processor.waterRecapture
{
   ...
   public class ActivityMapHandler_171 extends WaterRecaptureMapHandler
   {
      ...
      {
         if(this._currentBossId == 4)
         {
            this.showFirstPhaseAnimation();
         }
         else if(this._currentBossId == 5)
         {
            this.showSecondPhaseAnimation();
         }
         else if(this._currentBossId == 6)
         {
      ...
      {
         this.processActivityMonster(4);
      }
      
      private function processPhase23Mobile() : void
      {
         this.processActivityMonster(5);
      ...
      private function onGetActiveCount(param1:MessageEvent) : void
      {
         ...
         if(this._curTimes == 3 && SceneManager.prevSceneType != 2)
         {
            this._curTimes = 0;
         }
         this.createTeamLeader();
         if(this._curTimes <= 3 && this._curTimes > 0 && SceneManager.prevSceneType == 2 && FightManager.fightWinnerSide == 1)
         {
      ...
      private function createTeamLeader() : void
      {
         ...
         {
            MobileManager.removeMobileById(this._teamLeaderNpc.id,"npc");
         }
         this._teamLeaderNpc = MobileManager.createNpc(this._teamLeaderDefinition);
         this._teamLeaderNpc.buttonMode = true;
         this._teamLeaderNpc.addEventListener("click",this.onTeamLeaderClick);
      }
      
      private function initNpcDefinition() : XML
      {
         var _loc1_:XML = null;
         if(this._currentBossId == 5)
         {
            _loc1_ = <npc id="39" resId="39" name="缇娜" dir="0" width="25" height="160" pos="630,280" actorPos="650,320" path=""><dialog npcId="40" npcName="紫电士官" transport="1,300,400"><branch id="default"><node emotion="0"><![CDATA[想和缇娜队长动手必须先过我这关！]]></node><reply action="close" params="5"><![CDATA[要打便打！]]></reply><reply action="close"><![CDATA[你等着，我马上回来！]]></reply></branch></dialog><eventHandler><mouseOver><HandlerShowNpcSlogan><![CDATA[一切都是徒劳！]]></HandlerShowNpcSlogan></mouseOver></eventHandler></npc>;
         }
         else if(this._curTimes == 1)
         {
            _loc1_ = <npc id="39" resId="39" name="缇娜" dir="0" width="25" height="160" pos="630,280" actorPos="650,320" path=""><dialog npcId="39" npcName="缇娜" transport="1,300,400"><branch id="default"><node emotion="0"><![CDATA[你如果再厉害一点的话，或许我可以把紫电让给你哦！]]></node><reply action="close" params="6"><![CDATA[到底有什么阴谋]]></reply><reply action="close"><![CDATA[你等着，我马上回来！]]></reply></branch></dialog><eventHandler><mouseOver><HandlerShowNpcSlogan><![CDATA[一切都是徒劳！]]></HandlerShowNpcSlogan></mouseOver></eventHandler></npc>;
         }
         else if(this._curTimes == 2)
         {
            _loc1_ = <npc id="39" resId="39" name="缇娜" dir="0" width="25" height="160" pos="630,280" actorPos="650,320" path=""><dialog npcId="39" npcName="缇娜" transport="1,300,400"><branch id="default"><node emotion="0"><![CDATA[没想到你可以变得这么厉害，要不要我再多陪你玩玩？]]></node><reply action="close" params="6"><![CDATA[来吧]]></reply><reply action="close"><![CDATA[你等着，我马上回来！]]></reply></branch></dialog><eventHandler><mouseOver><HandlerShowNpcSlogan><![CDATA[一切都是徒劳！]]></HandlerShowNpcSlogan></mouseOver></eventHandler></npc>;
         }
         ...
         {
            _loc1_ = <npc id="39" resId="39" name="缇娜" dir="0" width="25" height="160" pos="630,280" actorPos="650,320" path=""><dialog npcId="39" npcName="缇娜" transport="1,300,400"><branch id="default"><node emotion="0"><![CDATA[小家伙还不死心吗？我倒是可以陪你玩玩~]]></node><reply action="close" params="6"><![CDATA[谁怕谁呀！]]></reply><reply action="close"><![CDATA[你等着，我马上回来！]]></reply></branch></dialog><eventHandler><mouseOver><HandlerShowNpcSlogan><![CDATA[一切都是徒劳！]]></HandlerShowNpcSlogan></mouseOver></eventHandler></npc>;
         }
         return _loc1_;
      }
      ...
      private function onTeamLeaderDialogClosed(param1:DialogCloseEvent) : void
      {
         ...
         if(_loc2_ == (6).toString() || _loc2_ == (5).toString())
         {
            _loc3_ = uint(_loc2_);
      ...
      {
         var _loc4_:NpcDefinition = null;
         var _loc3_:Mobile = null;
         if(this._currentBossId == 6 && Boolean(this._activityMonsterVec))
         {
            return;
         }
         ...
         while(_loc2_ < 3)
         {
            _loc4_ = this.generateNpcDefinition(param1,_loc2_);
            _loc3_ = MobileManager.createNpc(_loc4_);
            _loc3_.action = "正面";
            if(_loc2_ == 1)
            {
               _loc3_.action = "背面";
            ...
            _loc3_.addEventListener("click",this.onActivityMonsterClick);
      ...
      private function generateNpcDefinition(param1:uint, param2:uint) : NpcDefinition
      {
         ...
         if(param1 == 4)
         {
            _loc4_ = <npc id="40" resId="40" name="紫电卫兵" dir="0" width="25" height="90" pos="670,280" actorPos="650,320" path=""><eventHandler><mouseOver><HandlerShowNpcSlogan><![CDATA[缇娜队长会好好修理你们！]]></HandlerShowNpcSlogan></mouseOver></eventHandler></npc>;
         }
         else
         {
            _loc4_ = <npc id="41" resId="41" name="紫电士官" dir="0" width="25" height="90" pos="670,280" actorPos="650,320" path=""><eventHandler><mouseOver><HandlerShowNpcSlogan><![CDATA[缇娜队长会好好修理你们！]]></HandlerShowNpcSlogan></mouseOver></eventHandler></npc>;
         }
         _loc3_ = new NpcDefinition(_loc4_);
         _loc3_.direction = ACTIVITY_MONSTER_DEFINE[param2].dir;
         _loc3_.x = ACTIVITY_MONSTER_DEFINE[param2].x;
         _loc3_.y = ACTIVITY_MONSTER_DEFINE[param2].y;
         return _loc3_;
      }
      ...
      private function removeMapActivityMonster() : void
      {
         ...
         {
            MobileManager.removeMobileById(this._activityMonsterVec[_loc1_].id,"npc");
            (this._activityMonsterVec[_loc1_] as Mobile).removeEventListener("click",this.onActivityMonsterClick);
