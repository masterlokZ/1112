package com.taomee.seer2.app.activity.processor
{
   ...
   public class StarShadowShengtuManager
   {
      ...
      public static function start(param1:int) : void
      {
         ...
         SceneManager.changeScene(1,currentConfig["firstMapID"]);
      ...
      private static function initFirstMap() : void
      {
         ...
         iconUrl = URLUtil.getRes("activity/icon/starShadow/" + _currentIndex + ".swf");
         ...
         DayLimitListManager.getDaylimitList([limitId],(function():*
         {
      ...
      private static function startEnterMap(param1:int) : void
      {
         ...
         SwapManager.swapItem(swapId,1,(function():*
         {
            ...
            return success = function(param1:IDataInput):void
            {
               ...
               new SwapInfo(data);
               SceneManager.changeScene(9,currentConfig["secondMapId"]);
               SceneManager.addEventListener("switchComplete",function(param1:SceneEvent):void
               {
                  if(SceneManager.active.type != 2)
                  {
                     if(currentConfig["secondMapId"] == SceneManager.active.mapID)
                     {
                        SceneManager.removeEventListener("switchComplete",arguments.callee);
      ...
      {
         var _loc2_:int = int(currentConfig["followPetId"]);
         var _loc1_:int = int(ActorManager.actorInfo.followingPetInfo == null ? 0 : int(ActorManager.actorInfo.followingPetInfo.resourceId));
