package com.taomee.seer2.app.activity.processor.PrizeCeremony
{
   ...
   public class PrizeGiving
   {
      ...
      {
         if(DateUtil.inInDateScope(5,14,30,15,1) || DateUtil.inInDateScope(6,14,30,15,1) || DateUtil.inInDateScope(0,14,30,15,1) || DateUtil.inInDateScope(1,14,30,15,1) || DateUtil.inInDateScope(2,14,30,15,1) || DateUtil.inInDateScope(3,14,30,15,1) || DateUtil.inInDateScope(4,14,30,15,1))
         {
            ...
            else if(ItemManager.getSpecialItem(500508) != null)
            {
               ...
               {
                  switch(int(PetKingNumber.getTeam()) - 1)
                  {
                     case 0:
                        first();
                        break;
               ...
               MovieClipUtil.playFullScreen("res/activity/animation/petPrize/hotFire.swf",function():void
               {
                  MovieClipUtil.playFullScreen("res/activity/animation/petPrize/flayPrize.swf",function():void
                  {
                     MovieClipUtil.playFullScreen("res/activity/animation/petPrize/littleBad.swf",function():void
                     {
                        ...
                        {
                           StatisticsManager.sendNovice("0x1003326f");
                           var _loc2_:* = new SwapInfo(param1);
                           ServerBufferManager.updateServerBuffer(29,2,1);
                        });
                     },true,false,2);
                  },true,false,2);
               },true,false,2);
