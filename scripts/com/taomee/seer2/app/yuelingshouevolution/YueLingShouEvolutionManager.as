package com.taomee.seer2.app.yuelingshouevolution
{
   ...
   public class YueLingShouEvolutionManager
   {
      ...
      {
         QueueLoader.load(URLUtil.getActivityAnimation("yuelingshouAct/yuelingshouAct"),"swf",function(param1:ContentInfo):void
         {
      ...
      private static function initMc() : void
      {
         ...
         pingBtn.addEventListener("click",onClickPing);
         ...
         oneKeyPass.addEventListener("click",onOneKeyFire);
         startMc.addEventListener("click",onStart);
         ...
         while(_loc1_ < 6)
         {
            ...
            if(_loc1_ < 3)
            {
               ...
               swapBtnList[_loc1_].addEventListener("click",onSwap);
      ...
      private static function onSwap(param1:MouseEvent) : void
      {
         ...
         var idx:int = int(swapBtnList.indexOf(e.currentTarget as SimpleButton));
      ...
      private static function createNPC307() : void
      {
         ...
         MobileManager.addMobile(_npc307,"npc");
         _npc307.addEventListener("click",onNpc307Click);
         _mouseObj = new MouseClickHintSprite();
         _mouseObj.x = 400;
         _mouseObj.y = 275;
         _map.content.addChild(_mouseObj);
      ...
      private static function firstPlayFullScreen(param1:Function = null) : void
      {
         ...
         ServerBufferManager.getServerBuffer(361,function(param1:ServerBuffer):void
         {
            var _loc2_:Boolean = Boolean(param1.readDataAtPostion(1));
            if(!_loc2_)
            {
               ServerBufferManager.updateServerBuffer(361,1,1);
      ...
      private static function onClickPing(param1:MouseEvent) : void
      {
         var e:MouseEvent = param1;
         pingBtn.visible = false;
         ServerBufferManager.getServerBuffer(360,function(param1:ServerBuffer):void
         {
            var server:ServerBuffer = param1;
            var _isPlay:Boolean = Boolean(server.readDataAtPostion(1));
            if(!_isPlay)
            {
               ServerBufferManager.updateServerBuffer(360,1,1);
      ...
      private static function creatNPC581() : void
      {
         ...
         MobileManager.addMobile(_npc581,"npc");
         _npc581.addEventListener("click",onNpcClick);
         _mouseObj = new MouseClickHintSprite();
         _mouseObj.x = 681;
         _mouseObj.y = 255;
         _map.content.addChild(_mouseObj);
      ...
      {
         oneKeyPass.removeEventListener("click",onOneKeyFire);
         startMc.removeEventListener("click",onStart);
      }
      ...
      public static function dispose() : void
      {
         if(_npc581)
         {
            _npc581.removeEventListener("click",onNpcClick);
            MobileManager.removeMobile(_npc581,"npc");
            _npc581 = null;
         }
         if(_npc307)
         {
            _npc307.removeEventListener("click",onNpcClick);
            MobileManager.removeMobile(_npc307,"npc");
            _npc307 = null;
         }
         if(_mouseObj)
         {
