package com.taomee.seer2.app.arena.data
{
   ...
   public class FighterInfo
   {
      ...
      private var _fightBuffInfoVec:Vector.<FighterBuffInfo> = new Vector.<FighterBuffInfo>();
      ...
      public function getSkillInfo(param1:int) : SkillInfo
      {
         ...
         for each(var _loc2_ in this._skillInfoVec)
         {
            _loc3_ = _loc2_;
            _loc2_;
            if(_loc3_.id == param1)
      ...
      public function set fightAnger(param1:int) : void
      {
         ...
         param1 = int(param1 > 100 ? 100 : param1);
