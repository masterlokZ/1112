package com.taomee.seer2.app.arena.processor
{
   ...
   public class Processor_1031 extends ArenaProcessor
   {
      ...
      override public function processor(param1:MessageEvent) : void
      {
         ...
         if(!CATCHING)
         {
            ...
            if(_loc3_ != 0 && this._catchFighterId != 0)
            {
               ...
               {
                  fightController.changeFighterState("catchFighterSuccess");
                  ArenaAnimationManager.createAnimation("com.taomee.seer2.app.arena.animation.CatchFighterSuccessAnimation",{
            ...
            {
               fightController.changeFighterState("catchFighterFailed");
               ArenaAnimationManager.createAnimation("com.taomee.seer2.app.arena.animation.CatchFighterFailAnimation",{"target":this._catchFighterId},this.onCatchAnimationEnd);
               arenaUIController.showSkillPanel();
            }
            return;
         }
      ...
      private function onCatchAnimationEnd() : void
      {
         ...
         CATCHING = false;
         if(fightController.state == "catchFighterSuccess")
         {
            _loc1_ = {
         ...
         else if(fightController.state == "catchFighterFailed")
         {
            fightController.parseTurnResult();
         }
      }
