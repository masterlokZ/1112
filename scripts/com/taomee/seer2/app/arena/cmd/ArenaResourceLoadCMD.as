package com.taomee.seer2.app.arena.cmd
{
   ...
   public class ArenaResourceLoadCMD implements IArenaBaseCMD
   {
      ...
      private function onGetResourceInfo(param1:MessageEvent) : void
      {
         ...
         {
            if(_loc3_.fightUserInfoVec[0].fighterInfoVec[0].resourceId == 301)
            {
               DecorationControl.fightPetInfo = _loc3_.fightUserInfoVec[0].fighterInfoVec[0];
            }
            if(_loc3_.fightUserInfoVec[0].fighterInfoVec[0].resourceId == 302)
            {
               DecorationControl.fightPetInfo = _loc3_.fightUserInfoVec[0].fighterInfoVec[0];
            }
            if(_loc3_.fightUserInfoVec[0].fighterInfoVec[0].resourceId == 304)
            {
               DecorationControl.fightPetInfo = _loc3_.fightUserInfoVec[0].fighterInfoVec[0];
            }
            if(_loc3_.fightUserInfoVec[0].fighterInfoVec[0].resourceId == 305)
            {
               DecorationControl.fightPetInfo = _loc3_.fightUserInfoVec[0].fighterInfoVec[0];
            }
            if(_loc3_.fightUserInfoVec[0].fighterInfoVec[0].resourceId == 306)
            {
               DecorationControl.fightPetInfo = _loc3_.fightUserInfoVec[0].fighterInfoVec[0];
            }
            if(_loc3_.fightUserInfoVec[0].fighterInfoVec[0].resourceId == 307)
            {
               DecorationControl.fightPetInfo = _loc3_.fightUserInfoVec[0].fighterInfoVec[0];
            }
            if(_loc3_.fightUserInfoVec[0].fighterInfoVec[0].resourceId == 1276)
            {
               DecorationControl.fightPetInfo = _loc3_.fightUserInfoVec[0].fighterInfoVec[0];
            }
            if(_loc3_.fightUserInfoVec[0].fighterInfoVec[0].resourceId == 1296)
            {
               DecorationControl.fightPetInfo = _loc3_.fightUserInfoVec[0].fighterInfoVec[0];
            }
         }
