package com.taomee.seer2.app.arena.newUI.toolbar
{
   ...
   internal class NewItemPanel extends Sprite
   {
      ...
      public function NewItemPanel(param1:int)
      {
         ...
         else if(SceneManager.currentSceneType == 6)
         {
            this.addGudie();
         }
         else if(SceneManager.currentSceneType == 13)
         {
            this.addGudie5();
         }
      }
      ...
      private function onClick(param1:MouseEvent) : void
      {
         ...
         {
            if(SceneManager.currentSceneType == 10 || SceneManager.currentSceneType == 16)
            {
               this.useMedicineItem(_loc4_);
               _loc3_ = new OperateEvent(2,this._usedItemReferenceId,"operateEnd");
               _loc3_.fighterId = this._fighter.id;
      ...
      {
         var _loc4_:NewItemDisplay = null;
         var _loc6_:int = 0;
         var _loc5_:int = 0;
         var _loc3_:int = 0;
         var _loc2_:* = 0;
