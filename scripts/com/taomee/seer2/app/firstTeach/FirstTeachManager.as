package com.taomee.seer2.app.firstTeach
{
   ...
   public class FirstTeachManager extends BaseBean
   {
      ...
      private static var _teacher:IFirstTeach;
      ...
      {
         _callBack = param1;
         ServerBufferManager.getServerBuffer(2,onGetStatus);
      }
      
      private static function onGetStatus(param1:ServerBuffer) : void
      {
         _statusVec = new Vector.<int>();
         var _loc2_:uint = param1.data.length < 6 ? param1.data.length : 6;
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_)
         {
            _statusVec.push(param1.readDataAtPostion(_loc4_));
            _loc4_++;
         }
      ...
      {
         showTool();
         ServerBufferManager.updateServerBuffer(2,param1,param2);
      ...
      private static function processReward(param1:int) : void
      {
         ...
         switch(param1 - 3)
         {
            ...
            case 1:
            case 2:
               _loc2_ = (param1 - 3) * 3 + _petSkillTeachData.index + 48;
      ...
      {
         SceneManager.removeEventListener("switchStart",onMapStart);
         clearTeacher();
      }
