   ...
   public class ToolBar extends Sprite
   {
      ...
      public static function hide() : void
      {
         if(instance)
         {
            ...
            instance._widgetMap.getValue("chatOutput").hide();
         }
      ...
      private function createWidget() : void
      {
         ...
         {
            StatisticsManager.sendNovice("0x10030614");
         ...
         {
            StatisticsManager.sendNovice("0x10030613");
         ...
         this.addToolBarWidget("map",this._mainUI["mapBtn"],null,"大地图",new WorldMapWidgetClick());
         this.addToolBarWidget("shipmap",this._mainUI["shipmapBtn"],null,"小地图",new ShipMapWidgetClick());
         this.addToolBarWidget("emotion",this._mainUI["emotionBtn"],null,"表情",new EmotionWidgetClick(this._emotionPanel));
         this.addToolBarWidget("shot",this._mainUI["shootBtn"],null,"头部射击",new HeaderShootWidgetClick());
         this.addToolBarWidget("buddy",this._mainUI["buddyBtn"],this._mainUI["buddyMc"],"好友",new BuddyWidgetClick());
         this.addToolBarWidget("team",this._mainUI["teamBtn"],this._mainUI["teamMc"],"战队",new TeamWidgetClick());
         this.addToolBarWidget("trainer",this._mainUI["trainerBtn"],null,"训练师",new TrainerWidgetClick());
         this.addToolBarWidget("actorBag",this._mainUI["actorBag"],null,"背包",new ActorBagWidgetClick());
         this.addToolBarWidget("allPetBag",this._mainUI["petBag"],null,"精灵",new AllPetBagWidgetClick());
         this.addWidget("chatOutput",new ChatMessageBoardWidget(this._mainUI["chatOutput"]),0);
         this.addWidget("chatInput",new ChatInputFrameWidget(this._mainUI["chatInput"]));
         this.addWidget("time",new BatteryTimeWidget(this._mainUI["timePanel"]));
         this.addWidget("NonoInput",new NonoInputFrameWidget(this._mainUI["nonoPanel"]));
         this.addWidget("HomeInput",new HomeInputFrameWidget(this._mainUI["homePanel"]));
         this.addWidget("DicInput",new DicInputFrameWidget(this._mainUI["dicPanel"]));
         this.addWidget("yueseNono",new YueseNonoWidgetClick(this._mainUI["yueseNono"]));
         this.addWidget("SYSTEM_WIDGET",new SystemWidgetClick(this._mainUI["systemPanel"]));
         this._mainUI["userUp"].gotoAndStop(1);
         this._mainUI["userUp"].buttonMode = true;
         this._mainUI.addChild(this._mainUI["userUp"]);
         this._mainUI["userUp"].addEventListener("click",onUserUp);
      ...
      {
         if(SceneManager.active.type == 1 || SceneManager.active.type == 9)
         {
      ...
      {
         var _loc6_:ToolBarRadioWidget = null;
         _loc6_ = new ToolBarRadioWidget(param2,param3,param4);
         _loc6_.toggle(param5);
      ...
      private function readSound() : void
      {
         ...
         var _loc2_:SharedObject = SharedObjectManager.getUserSharedObject("userSetting");
         if(_loc2_.data["sound"] == null || _loc2_.data["sound"] == 1)
         {
            _loc2_.data["sound"] = 1;
      ...
      {
         var _loc1_:SharedObject = SharedObjectManager.getUserSharedObject("userSetting");
      ...
      {
         if(SceneManager.active.mapCategoryID == 0 || SceneManager.active.mapCategoryID == 101 || SceneManager.active.mapCategoryID == 201 || SceneManager.active.mapCategoryID == 8031 || SceneManager.active.mapID == 80075)
         {
            ToolBar.disableBtn("shipmap");
         }
         else
         {
            ToolBar.enableBtn("shipmap");
         }
      }
   }
}
