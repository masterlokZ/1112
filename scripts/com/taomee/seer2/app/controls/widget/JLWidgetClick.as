package com.taomee.seer2.app.controls.widget
{
   ...
   public class JLWidgetClick extends Sprite implements IWidgetable
   {
      ...
      {
         this._mainUI.addEventListener("click",this.onWidgetClick);
      }
      ...
      public function exec(param1:String) : void
      {
         ...
         {
            _loc3_ = "http://bbs.61.com/checksession/";
            _loc5_ = ActorManager.actorInfo.id;
            param1 = _loc3_ + "?username=" + _loc5_ + "&gid=" + ClientConfig.productID + "&session=" + GlobalsManager.session + "&fid=37";
