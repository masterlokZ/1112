package com.taomee.seer2.core.utils
{
   ...
   public class URLUtil
   {
      ...
      {
         var _loc2_:String = _moduleResBase + param1 + ".swf";
      ...
      public static function getFileName(param1:String) : String
      {
         ...
         var _loc4_:int = int(param1.lastIndexOf(".",_loc2_));
      ...
      {
         var _loc2_:String = _resURL + "ui/" + param1 + ".swf";
         return rewrite(ClientConfig.rootURL + VersionManager.getURL(_loc2_));
      }
      
      public static function getMapConfig(param1:String) : String
      {
         var _loc2_:String = _resURL + "map/config/" + param1 + ".xml";
         return rewrite(ClientConfig.rootURL + VersionManager.getURL(_loc2_));
      }
      
      public static function getMapData(param1:String) : String
      {
         var _loc2_:String = _resURL + "map/data/" + param1 + ".xml";
         return rewrite(ClientConfig.rootURL + VersionManager.getURL(_loc2_));
      }
      
      public static function getMapImage(param1:String) : String
      {
         var _loc2_:String = _resURL + "map/pics/" + param1 + ".jpg";
         return rewrite(ClientConfig.rootURL + VersionManager.getURL(_loc2_));
      }
      
      public static function getSharePic(param1:String) : String
      {
         var _loc2_:String = _resURL + "sharePic/" + param1 + ".jpg";
         return rewrite(ClientConfig.rootURL + VersionManager.getURL(_loc2_));
      }
      
      public static function getDiceMapData(param1:int) : String
      {
         var _loc2_:String = _diceMapBase + "config/" + param1.toString() + ".xml";
         return rewrite(ClientConfig.rootURL + VersionManager.getURL(_loc2_));
      }
      ...
      {
         var _loc2_:String = _resURL + "map/sound/" + param1 + ".mp3";
         return rewrite(ClientConfig.rootURL + VersionManager.getURL(_loc2_));
      }
      
      public static function getMapSignSwf(param1:uint) : String
      {
         var _loc2_:String = _resURL + "map/sign/" + param1 + ".swf";
         return rewrite(ClientConfig.rootURL + VersionManager.getURL(_loc2_));
      }
      
      public static function getMapSignXml(param1:uint) : String
      {
         var _loc2_:String = _resURL + "map/sign/" + param1 + ".xml";
         return rewrite(ClientConfig.rootURL + VersionManager.getURL(_loc2_));
      }
      
      public static function getMapMineSwf(param1:String) : String
      {
         var _loc2_:String = _resURL + "map/mine/" + param1 + ".swf";
         return rewrite(ClientConfig.rootURL + VersionManager.getURL(_loc2_));
      }
      ...
      {
         var _loc2_:String = _resURL + "npc/sound/" + param1 + ".mp3";
         return rewrite(ClientConfig.rootURL + VersionManager.getURL(_loc2_));
      }
      
      public static function getEquipSwf(param1:String) : String
      {
         var _loc2_:String = _equipBase + param1 + ".swf";
         return rewrite(ClientConfig.rootURL + VersionManager.getURL(_loc2_));
      }
      
      public static function getEquipPreview(param1:String) : String
      {
         var _loc2_:String = _equipPreviewBase + param1 + ".swf";
         return rewrite(ClientConfig.rootURL + VersionManager.getURL(_loc2_));
      }
      
      public static function getEquipIcon(param1:uint) : String
      {
         var _loc2_:String = _equipIconBase + param1 + ".swf";
         return rewrite(ClientConfig.rootURL + VersionManager.getURL(_loc2_));
      }
      ...
      {
         var _loc2_:String = _featureIconBase + param1 + ".swf";
         return rewrite(ClientConfig.rootURL + VersionManager.getURL(_loc2_));
      }
      
      public static function getCollectionSwf(param1:uint) : String
      {
         var _loc2_:String = _collectionBase + param1 + ".swf";
         return rewrite(ClientConfig.rootURL + VersionManager.getURL(_loc2_));
      }
      
      public static function getCollectionIcon(param1:uint) : String
      {
         var _loc2_:String = _collectionIconBase + param1 + ".swf";
         return rewrite(ClientConfig.rootURL + VersionManager.getURL(_loc2_));
      }
      
      public static function getPetSpirtTrainIcon(param1:uint) : String
      {
         var _loc2_:String = _petSpirtTrainIconBase + param1 + ".swf";
         return rewrite(ClientConfig.rootURL + VersionManager.getURL(_loc2_));
      }
      
      public static function getItemIcon(param1:int) : String
      {
         var _loc2_:String = _resURL + "item/icon/" + param1 + ".swf";
         return rewrite(ClientConfig.rootURL + VersionManager.getURL(_loc2_));
      }
      ...
      public static function getPetSwf(param1:uint) : String
      {
         ...
         var _loc2_:String = _petBase + param1 + ".swf";
         return rewrite(ClientConfig.rootURL + VersionManager.getURL(_loc2_));
      }
      ...
      {
         param1 = getResRealId(param1);
         var _loc2_:String = _petFightBase + param1 + ".swf";
         return rewrite(ClientConfig.rootURL + VersionManager.getURL(_loc2_));
      }
      
      public static function getDecorationSwf(param1:uint) : String
      {
         var _loc2_:String = _resURL + "pet/decoration/" + param1 + ".swf";
         return rewrite(ClientConfig.rootURL + VersionManager.getURL(_loc2_));
      }
      ...
      {
         param1 = getResRealId(param1);
         var _loc2_:String = _petTrailDoor + param1 + ".swf";
         return rewrite(ClientConfig.rootURL + VersionManager.getURL(_loc2_));
      }
      ...
      {
         param1 = getResRealId(param1);
         var _loc2_:String = _petSoundBase + param1 + ".mp3";
         return rewrite(ClientConfig.rootURL + VersionManager.getURL(_loc2_));
      }
      
      public static function getGameSound(param1:uint) : String
      {
         var _loc2_:String = _gameSoundBase + param1 + ".mp3";
         return rewrite(ClientConfig.rootURL + VersionManager.getURL(_loc2_));
      }
      ...
      {
         param1 = getResRealId(param1);
         var _loc2_:String = _petIconBase + param1 + ".swf";
         return rewrite(ClientConfig.rootURL + VersionManager.getURL(_loc2_));
      }
      ...
      public static function getPetDemo(param1:uint) : String
      {
         ...
         param1 = getResRealId(param1);
         var _loc2_:String = _petDemoBase + param1 + ".swf";
         return rewrite(ClientConfig.rootURL + VersionManager.getURL(_loc2_));
      }
