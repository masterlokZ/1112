package com.taomee.seer2.core.animation.frame
{
   ...
   public class FrameSequenceManager
   {
      ...
      public static function getFrameSequence(param1:String, param2:String = null, param3:Boolean = false) : FrameSequence
      {
         ...
         {
            _loc5_ = _frameSequenceMap.getValue(param1) as FrameSequence;
            _loc5_.referredCount = _loc5_.referredCount + 1;
         }
         else if(param3 == true)
         {
            _loc5_ = new FrameSequence();
            _loc5_.referredCount = _loc5_.referredCount + 1;
            _loc4_ = UIManager.getByteArray(param1);
            _loc5_.setData(_loc4_);
            _frameSequenceMap.add(param1,_loc5_);
         }
         else
         {
            _loc5_ = new FrameSequence();
      ...
      public static function recyleFrameSequence(param1:FrameSequence) : void
      {
         ...
         {
            _loc2_ = _frameSequenceMap.getKey(param1);
            param1.dispose();
      ...
      private static function loadSequenceResource(param1:String, param2:String) : void
      {
         if(param2 == null)
         {
            QueueLoader.load(param1,"binary",onResourLoaded);
         }
         else
         {
