            ...
            if(_loc9_)
            {
               for(_loc6_ in _loc9_)
               {
                  ...
                  if(param2 == null || param2 == _loc5_)
                  {
                     ...
                     if(_loc8_)
                     {
                        _loc7_ = _loc8_.toArray();
                        while(_loc7_.length != 0)
                        {
                           _loc4_ = _loc7_[0];
                           if(param3 == null || param3 == _loc4_)
                           {
                              param1.removeEventListener(_loc5_,_loc4_,false);
                              param1.removeEventListener(_loc5_,_loc4_,true);
                              _loc8_.remove(_loc4_);
                           }
                           _loc7_.pop();
                        }
                        if(_loc8_.length == 0)
                        {
                           delete _loc9_[_loc6_];
                        }
                     }
                  }
               }
