package com.taomee.seer2.core.ui
{
   ...
   public class ImagePanel
   {
      ...
      public static function showImage(param1:Stage) : void
      {
         ...
         _closeBtn.addEventListener("click",onClose);
         initImage();
         initRemote();
         initSound();
         param1.addChild(_mc);
         DisplayUtil.align(_mc,4,new Rectangle(0,0,param1.stageWidth,param1.stageHeight));
      }
      ...
      private static function initSound() : void
      {
         ...
         _soundOnBtn.addEventListener("click",onSoundOn);
         _soundOffBtn.addEventListener("click",onSoundOff);
      }
      ...
      private static function initRemote() : void
      {
         ...
         _remoteOnBtn.addEventListener("click",onRemoteOn);
         _remoteOffBtn.addEventListener("click",onRemoteOff);
      }
      ...
      private static function initImage() : void
      {
         ...
         while(_loc1_ < 3)
         {
            ...
            _btnList[_loc1_].addEventListener("click",onClick);
      ...
      private static function onClick(param1:MouseEvent) : void
      {
         ...
         var _loc2_:int = int(_btnList.indexOf(param1.currentTarget as MovieClip));
         for each(_loc4_ in _btnList)
         {
         ...
         if(Boolean(SceneManager.active) && SceneManager.active.type == 2)
         {
            ImageLevelManager.setFightImageLevel(_loc3_);
         }
         else
         {
            ImageLevelManager.setImageLevel(_loc3_);
         }
      }
