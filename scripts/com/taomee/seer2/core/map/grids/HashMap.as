package com.taomee.seer2.core.map.grids
{
   ...
   public class HashMap
   {
      ...
      public function containsValue(param1:Object) : Boolean
      {
         ...
         var _loc4_:uint = this.size();
         if(_loc4_ > 0)
         {
            _loc3_ = 0;
            while(_loc3_ < _loc4_)
            {
               if(this.props[this._keys[_loc3_]] == param1)
               {
                  _loc2_ = true;
                  break;
               }
      ...
      public function remove(param1:Object) : Object
      {
         ...
         if(this.containsKey(param1))
         {
            ...
            _loc3_ = int(this._keys.indexOf(param1));
            if(_loc3_ > -1)
            {
      ...
      public function putAll(param1:HashMap) : void
      {
         ...
         if(_loc2_ > 0)
         {
            ...
            while(_loc3_ < _loc2_)
            {
               this.put(_loc4_[_loc3_],param1.getValue(_loc4_[_loc3_]));
               _loc3_++;
            }
         }
      }
      ...
      public function values() : Array
      {
         var _loc3_:uint = 0;
         var _loc2_:Array = [];
         var _loc1_:uint = this.size();
         if(_loc1_ > 0)
         {
            _loc3_ = 0;
            while(_loc3_ < _loc1_)
            {
               _loc2_.push(this.props[this._keys[_loc3_]]);
               _loc3_++;
            }
         }
         return _loc2_;
