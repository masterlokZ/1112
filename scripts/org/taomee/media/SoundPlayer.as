package org.taomee.media
{
   ...
   public class SoundPlayer extends EventDispatcher
   {
      ...
      public function load(param1:String, param2:Boolean = false, param3:Boolean = false) : void
      {
         ...
         this._sound.addEventListener("open",this.onLoadOpen);
         this._sound.addEventListener("progress",this.onLoadProgress);
         this._sound.addEventListener("complete",this.onLoadComplete);
         this._sound.addEventListener("ioError",this.onIoError);
      ...
      public function play() : void
      {
         ...
         if(this._soundChannel)
         {
            this._soundChannel.addEventListener("soundComplete",this.onSoundComplete);
      ...
      private function clearSoundChannel() : void
      {
         if(this._soundChannel)
         {
            ...
            this._soundChannel.removeEventListener("soundComplete",this.onSoundComplete);
            this._soundChannel = null;
         }
      }
      ...
      {
         this._sound.removeEventListener("open",this.onLoadOpen);
         this._sound.removeEventListener("ioError",this.onIoError);
      ...
      {
         this._sound.removeEventListener("progress",this.onLoadProgress);
         this._sound.removeEventListener("complete",this.onLoadComplete);
         dispatchEvent(param1);
      }
