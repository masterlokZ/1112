package org.taomee.data
{
   ...
   public class ArrayProvider extends EventDispatcher
   {
      ...
      protected function dispatchPreChangeEvent(param1:String, param2:Array, param3:int = -1, param4:int = -1) : void
      {
         ...
         {
            dispatchEvent(new DataChangeEvent("preDataChange",param1,param2,param3,param4));
         }
      }
      ...
      public function shift() : *
      {
         ...
         dispatchChangeEvent("remove",[_loc1_],0,0);
         return _loc1_;
      }
      
      public function dispatchSelectMulti(param1:IEventDispatcher, param2:Array) : void
      {
         var _loc3_:int = _data.length - 1;
         _data.splice(_loc3_,0,param2);
         param1.dispatchEvent(new DataChangeEvent("dataChange","select",param2,_loc3_,_data.length - 1));
      }
      
      public function remove(param1:*) : *
      {
         var _loc2_:int = int(_data.indexOf(param1));
         if(_loc2_ != -1)
         {
      ...
      public function removeAll() : void
      {
         ...
         _data.length = 0;
         dispatchChangeEvent("removeAll",_loc1_,0,_loc1_.length - 1);
      }
      
      public function pop() : *
      {
         var _loc2_:* = _data.pop();
         var _loc1_:int = int(_data.length);
         dispatchChangeEvent("remove",[_loc2_],_loc1_,_loc1_);
         return _loc2_;
      }
      ...
      public function dispatchSelect(param1:IEventDispatcher, param2:*) : void
      {
         ...
         param1.dispatchEvent(new DataChangeEvent("dataChange","select",[param2],_loc3_,_loc3_));
      }
      ...
      public function removeAt(param1:uint, param2:uint = 1) : Array
      {
         ...
         dispatchChangeEvent("remove",_loc3_.concat(),param1,param1 + _loc3_.length - 1);
         return _loc3_;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc4_:int = int(_data.indexOf(param1));
         if(_loc4_ == -1)
         {
            return;
         }
         _loc3_ = int(_data.indexOf(param2));
         if(_loc3_ == -1)
         {
            return;
         }
         swapIndexAt(_loc4_,_loc3_);
      }
      ...
      public function removeForProperty(param1:String, param2:*) : *
      {
         ...
         var p:String = param1;
         var value:* = param2;
         var b:Boolean = Boolean(_data.some(function(param1:*, param2:int, param3:Array):Boolean
         {
            if(param1[p] == value)
            {
               _item = param1;
      ...
      public function add(param1:*) : void
      {
         ...
         dispatchChangeEvent("add",[param1],_loc2_,_loc2_);
      }
      ...
      {
         var _loc3_:int = int(_data.indexOf(param1));
         if(_loc3_ != -1)
         {
      ...
      public function setItemIndexAt(param1:int, param2:int) : void
      {
         ...
         dispatchChangeEvent("move",_loc3_,param1,param2);
      }
      ...
      public function addMultiAt(param1:Array, param2:uint) : void
      {
         ...
         dispatchChangeEvent("add",param1.concat(),param2,param2 + param1.length - 1);
      }
      ...
      public function upDateItemAt(param1:uint, param2:*) : *
      {
         ...
         dispatchPreChangeEvent("update",[_loc3_],param1,param1);
         _data[param1] = param2;
         dispatchChangeEvent("update",[param2],param1,param1);
         return _loc3_;
      }
      ...
      public function addAt(param1:*, param2:uint) : void
      {
         checkIndex(param2);
         _data.splice(param2,0,param1);
         dispatchChangeEvent("add",[param1],param2,param2);
      }
      ...
      protected function dispatchChangeEvent(param1:String, param2:Array, param3:int = -1, param4:int = -1) : void
      {
         ...
         {
            dispatchEvent(new DataChangeEvent("dataChange",param1,param2,param3,param4));
         }
      }
      ...
      public function swapIndexAt(param1:int, param2:int) : void
      {
         ...
         if(param1 < param2)
         {
            _loc3_ = _data.splice(param2,1);
            _loc4_ = _data.splice(param1,1,_loc3_);
            _data.splice(param2,1,_loc4_);
            dispatchChangeEvent("swap",_loc3_.concat(_loc4_),param1,param2);
         }
         else
         {
            _loc4_ = _data.splice(param1,1);
            _loc3_ = _data.splice(param2,1);
            _data.splice(param1,1,_loc3_);
            dispatchChangeEvent("swap",_loc4_.concat(_loc3_),param2,param1);
         }
      }
   }
}
