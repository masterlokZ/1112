package org.taomee.utils
{
   public class ColorUtil
   {
      ...
      public static function HueToRGB(param1:Number, param2:Number, param3:Number) : Object
      {
         ...
         _loc6_ = param3 / 60;
         _loc4_ = (param3 - _loc6_ * 60) / 60;
         _loc6_ %= 6;
         _loc7_ = param1 + (param2 - param1) * _loc4_;
         _loc5_ = param2 - (param2 - param1) * _loc4_;
         switch(_loc6_)
         {
            case 0:
               return {
      ...
      public static function RGBtoHSV(param1:Number, param2:Number, param3:Number) : Object
      {
         ...
         _loc8_ = Math.min(param1,Math.min(param2,param3));
         if(_loc5_ == 0)
         {
            return {
               "h":0,
         ...
         _loc7_ = _loc5_;
         _loc4_ = (_loc5_ - _loc8_) / _loc5_;
         _loc6_ = RGBToHue(param1,param2,param3);
         return {
            "h":_loc6_,
            "s":_loc4_,
            "v":_loc7_
      ...
      public static function RGBToHue(param1:Number, param2:Number, param3:Number) : uint
      {
         ...
         _loc4_ = center(param1,param2,param3);
         if(param1 == _loc7_)
         {
            if(param3 == _loc5_)
            {
      ...
      public static function RGBtoHSL(param1:Number, param2:Number, param3:Number) : Object
      {
         ...
         var _loc7_:Number = NaN;
         var _loc4_:Number = 0;
         _loc6_ = Math.max(param1,Math.max(param2,param3));
         _loc9_ = Math.min(param1,Math.min(param2,param3));
         _loc8_ = (_loc9_ + _loc6_) * 0.5;
         if(_loc8_ == 0)
         {
            return {
               "h":_loc4_,
         ...
         _loc4_ = RGBToHue(param1,param2,param3);
         return {
            "h":_loc4_,
            "l":_loc8_,
            "s":_loc7_
