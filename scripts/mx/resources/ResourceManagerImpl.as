package mx.resources
{
   ...
   public class ResourceManagerImpl extends EventDispatcher implements IResourceManager
   {
      ...
      public function ResourceManagerImpl()
      {
         ...
         if(!this.inFrame1)
         {
            this.ignoreMissingBundles = Boolean(info) && Boolean(info.hasOwnProperty("isMXMLC"));
         }
         if(info)
         {
      ...
      private function loadResourceBundleProxy(proxy:ResourceBundleProxy) : ResourceBundle
      {
         ...
         resourceBundle.mx_internal::_locale = proxy.locale;
         resourceBundle.mx_internal::_bundleName = proxy.bundleName;
